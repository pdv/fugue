...
var G__28629 = o;
goog.object.set(G__28629,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__28630__delegate = function (args){
...
while (G__28631__i < G__28631__a.length) {G__28631__a[G__28631__i] = arguments[G__28631__i + 0]; ++G__28631__i;}
  args = new cljs.core.IndexedSeq(G__28631__a,0,null);
} 
return G__28630__delegate.call(this,args);};
G__28630.cljs$lang$maxFixedArity = 0;
G__28630.cljs$lang$applyTo = (function (arglist__28632){
var args = cljs.core.seq(arglist__28632);
return G__28630__delegate(args);
});
...
var G__28633 = o;
goog.object.set(G__28633,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__28635__i < G__28635__a.length) {G__28635__a[G__28635__i] = arguments[G__28635__i + 0]; ++G__28635__i;}
  args = new cljs.core.IndexedSeq(G__28635__a,0,null);
} 
...
var G__28637 = props;
var G__28637__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__28637,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28637);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__28637__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__28637__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__28638 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__28638,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__28638;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__28639){
var map__28640 = p__28639;
var map__28640__$1 = (((((!((map__28640 == null))))?(((((map__28640.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28640.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28640):map__28640);
var on_write = cljs.core.get.call(null,map__28640__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__28640,map__28640__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__28640,map__28640__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28642_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__28645 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28645,(0),null);
var id = cljs.core.nth.call(null,vec__28645,(1),null);
var className = cljs.core.nth.call(null,vec__28645,(2),null);
...
var temp__5724__auto___28649 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___28649 == null)){
} else {
var key_28650 = temp__5724__auto___28649;
jsprops.key = key_28650;
}
...
var temp__5724__auto___28651 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___28651 == null)){
} else {
var key_28652 = temp__5724__auto___28651;
jsprops.key = key_28652;
}
...
var temp__5724__auto___28653 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___28653 == null)){
} else {
var key_28654 = temp__5724__auto___28653;
jsprops.key = key_28654;
}
...
var G__28656 = n;
if(cljs.core._EQ_.call(null,"",G__28656)){
return x;
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28657){
...
break;
default:
var G__28664 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__28664;
continue;
...
var ctx = ({});
var vec__28666 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28666,(0),null);
var derefed = cljs.core.nth.call(null,vec__28666,(1),null);
...
var G__28669 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28669) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__28669){
...
//# sourceMappingURL=template.js.map?rel=1600808342026
