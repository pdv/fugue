...
var G__27691 = cljs.core.first.call(null,element_str);
switch (G__27691) {
case "?":
arr.push((1));
...
var G__27693 = cljs.core.next.call(null,items);
items = G__27693;
continue;
} else {
return null;
...
var G__27694 = cljs.core.next.call(null,items);
items = G__27694;
continue;
} else {
return null;
...
var G__27696 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__27696;
continue;
} else {
return true;
...
switch (G__27699) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__27699){
return (function (p1__27697_SHARP_){
return cljs.core.not_EQ_.call(null,p1__27697_SHARP_,(2));
});})(G__27699))
))){
...
return cljs.core.not_EQ_.call(null,p1__27698_SHARP_,(1));
});})(G__27699))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27699)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1600808340840
