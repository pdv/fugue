...
return cljs.spec.alpha.map_spec_impl.call(null,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[null,null,null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__34642){
return cljs.core.map_QMARK_.call(null,G__34642);
}),(function (G__34642){
return cljs.core.contains_QMARK_.call(null,G__34642,new cljs.core.Keyword("webcv.chan","xform","webcv.chan/xform",-2034901163));
})], null),(function (G__34642){
return ((cljs.core.map_QMARK_.call(null,G__34642)) && (cljs.core.contains_QMARK_.call(null,G__34642,new cljs.core.Keyword("webcv.chan","xform","webcv.chan/xform",-2034901163))));
...
return cljs.core.map.call(null,(function (p1__34643_SHARP_){
return cljs.core.assoc.call(null,cljs.core.PersistentArrayMap.EMPTY,name,p1__34643_SHARP_);
}));
});
...
return (function() {
var G__34644 = null;
var G__34644__0 = (function (){
return rf.call(null);
});
var G__34644__1 = (function (result){
return rf.call(null,result);
});
var G__34644__2 = (function (result,input){
...
G__34644 = function(result,input){
switch(arguments.length){
case 0:
return G__34644__0.call(this);
case 1:
return G__34644__1.call(this,result);
case 2:
return G__34644__2.call(this,result,input);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__34644.cljs$core$IFn$_invoke$arity$0 = G__34644__0;
...
cljs.core._add_method.call(null,webcv.chan.make_chan_node,new cljs.core.Keyword("webcv.chan","transducer","webcv.chan/transducer",311721516),(function (ctx,p__34645){
...
var xform = cljs.core.get.call(null,map__34646__$1,new cljs.core.Keyword("webcv.chan","xform","webcv.chan/xform",-2034901163));
var static_params = cljs.core.get.call(null,map__34646__$1,new cljs.core.Keyword("webcv.synthdef","static-params","webcv.synthdef/static-params",-622811484));
...
cljs.core._add_method.call(null,webcv.synthdef.make_edge,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("webcv.chan","chan-node","webcv.chan/chan-node",-367192494),new cljs.core.Keyword("webcv.chan","chan-node","webcv.chan/chan-node",-367192494)], null),(function (_,src,dest,p__34648){
...
var param_name = cljs.core.get.call(null,map__34649__$1,new cljs.core.Keyword("webcv.synthdef","param-name","webcv.synthdef/param-name",-328756077));
...
//# sourceMappingURL=chan.js.map?rel=1601274369269
