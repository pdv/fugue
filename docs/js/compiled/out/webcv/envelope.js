...
return (bias + (scale * new cljs.core.Keyword("webcv.envelope","target","webcv.envelope/target",1892655906).cljs$core$IFn$_invoke$arity$1(p1__34978_SHARP_)));
});})(durations,times))
,stages);
var shapes = cljs.core.map.call(null,((function (durations,times,levels){
return (function (p1__34979_SHARP_){
return cljs.core.get.call(null,p1__34979_SHARP_,new cljs.core.Keyword("webcv.ramp","shape","webcv.ramp/shape",1686218061),new cljs.core.Keyword("webcv.ramp","exponential","webcv.ramp/exponential",-1267929909));
...
var G__34983__1 = (function (result){
return rf.call(null,result);
});
var G__34983__2 = (function (result,p__34980){
...
var env = cljs.core.get.call(null,map__34981__$1,new cljs.core.Keyword("webcv.envelope","env","webcv.envelope/env",142574262));
var gate = cljs.core.get.call(null,map__34981__$1,new cljs.core.Keyword("webcv.envelope","gate","webcv.envelope/gate",251915118));
var scale = cljs.core.get.call(null,map__34981__$1,new cljs.core.Keyword("webcv.envelope","scale","webcv.envelope/scale",-1870655022));
var bias = cljs.core.get.call(null,map__34981__$1,new cljs.core.Keyword("webcv.envelope","bias","webcv.envelope/bias",1851379345));
...
G__34983 = function(result,p__34980){
switch(arguments.length){
case 0:
return G__34983__0.call(this);
case 1:
return G__34983__1.call(this,result);
case 2:
return G__34983__2.call(this,result,p__34980);
}
...
return cljs.core.map.call(null,(function (p__34984){
...
var a = cljs.core.get.call(null,map__34985__$1,new cljs.core.Keyword("webcv.envelope","a","webcv.envelope/a",532823109));
var d = cljs.core.get.call(null,map__34985__$1,new cljs.core.Keyword("webcv.envelope","d","webcv.envelope/d",320839789));
var s = cljs.core.get.call(null,map__34985__$1,new cljs.core.Keyword("webcv.envelope","s","webcv.envelope/s",65762037));
var r = cljs.core.get.call(null,map__34985__$1,new cljs.core.Keyword("webcv.envelope","r","webcv.envelope/r",-996006769));
...
return cljs.core.map.call(null,(function (p__34987){
...
var a = cljs.core.get.call(null,map__34988__$1,new cljs.core.Keyword("webcv.envelope","a","webcv.envelope/a",532823109));
var d = cljs.core.get.call(null,map__34988__$1,new cljs.core.Keyword("webcv.envelope","d","webcv.envelope/d",320839789));
...
cljs.core._add_method.call(null,webcv.chan.make_transducer,new cljs.core.Keyword("webcv.envelope","env-gen","webcv.envelope/env-gen",-1732965233),(function (p__34990,_){
...
var actx = cljs.core.get.call(null,map__34991__$1,new cljs.core.Keyword("webcv.audio","actx","webcv.audio/actx",686780438));
return webcv.envelope.stages_x_ramp.call(null,((function (map__34991,map__34991__$1,actx){
return (function (){
var target_obj_34993 = actx;
var _STAR_runtime_state_STAR__orig_val__34995 = oops.state._STAR_runtime_state_STAR_;
var _STAR_runtime_state_STAR__temp_val__34996 = oops.state.prepare_state.call(null,target_obj_34993,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});
oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR__temp_val__34996;

try{var next_obj_34994 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_34993,(0),"currentTime",true,true,false))?(target_obj_34993["currentTime"]):null);
return next_obj_34994;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR__orig_val__34995;
}});})(map__34991,map__34991__$1,actx))
);
}));
...
//# sourceMappingURL=envelope.js.map?rel=1601274369580
