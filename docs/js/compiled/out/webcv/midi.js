...
return cljs.spec.alpha.map_spec_impl.call(null,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[null,null,null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__29450){
return cljs.core.map_QMARK_.call(null,G__29450);
}),(function (G__29450){
return cljs.core.contains_QMARK_.call(null,G__29450,new cljs.core.Keyword("webcv.midi","input-name","webcv.midi/input-name",80810145));
})], null),(function (G__29450){
return ((cljs.core.map_QMARK_.call(null,G__29450)) && (cljs.core.contains_QMARK_.call(null,G__29450,new cljs.core.Keyword("webcv.midi","input-name","webcv.midi/input-name",80810145))));
...
cljs.core._add_method.call(null,webcv.chan.make_chan_node,new cljs.core.Keyword("webcv.midi","midi-in","webcv.midi/midi-in",1504142596),(function (p__29451,p__29452){
var map__29453 = p__29451;
var map__29453__$1 = (((((!((map__29453 == null))))?(((((map__29453.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29453.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__29453):map__29453);
var ins = cljs.core.get.call(null,map__29453__$1,new cljs.core.Keyword("webcv.midi","ins","webcv.midi/ins",1736405462));
...
var input_name = cljs.core.get.call(null,map__29454__$1,new cljs.core.Keyword("webcv.midi","input-name","webcv.midi/input-name",80810145));
...
var G__29461__1 = (function (result){
return rf.call(null,result);
});
var G__29461__2 = (function (result,midi){
var map__29459 = midi;
...
var note = cljs.core.get.call(null,map__29459__$1,new cljs.core.Keyword("webcv.midi","note","webcv.midi/note",1114457544));
var velocity = cljs.core.get.call(null,map__29459__$1,new cljs.core.Keyword("webcv.midi","velocity","webcv.midi/velocity",-1464249691));
var note_on = (velocity > (0));
var op = ((note_on)?cljs.core.conj:((function (map__29459,map__29459__$1,note,velocity,note_on,v_down){
return (function (p1__29458_SHARP_,p2__29457_SHARP_){
return cljs.core.remove.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([p2__29457_SHARP_]),p1__29458_SHARP_);
});})(map__29459,map__29459__$1,note,velocity,note_on,v_down))
);
...
G__29461 = function(result,midi){
switch(arguments.length){
case 0:
return G__29461__0.call(this);
case 1:
return G__29461__1.call(this,result);
case 2:
return G__29461__2.call(this,result,midi);
}
...
return (function() {
var G__29464 = null;
var G__29464__0 = (function (){
return rf.call(null);
});
var G__29464__1 = (function (result){
return rf.call(null,result);
});
var G__29464__2 = (function (result,midi){
var map__29462 = midi;
...
var type = cljs.core.get.call(null,map__29462__$1,new cljs.core.Keyword("webcv.midi","type","webcv.midi/type",1350996868));
var velocity = cljs.core.get.call(null,map__29462__$1,new cljs.core.Keyword("webcv.midi","velocity","webcv.midi/velocity",-1464249691));
...
G__29464 = function(result,midi){
switch(arguments.length){
case 0:
return G__29464__0.call(this);
case 1:
return G__29464__1.call(this,result);
case 2:
return G__29464__2.call(this,result,midi);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__29464.cljs$core$IFn$_invoke$arity$0 = G__29464__0;
 ...
 */
webcv.midi.midi_x_gate = cljs.core.comp.call(null,webcv.midi.midi_x_velo.call(null,true),cljs.core.map.call(null,(function (p1__29465_SHARP_){
return (p1__29465_SHARP_ / (128));
})));
...
return cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__29466_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword("webcv.midi","note","webcv.midi/note",1114457544).cljs$core$IFn$_invoke$arity$1(p1__29466_SHARP_),new cljs.core.Keyword("webcv.midi","note","webcv.midi/note",1114457544).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("webcv.chan","input","webcv.chan/input",1319946644).cljs$core$IFn$_invoke$arity$1(p1__29466_SHARP_)));
})),cljs.core.map.call(null,(function (p1__29467_SHARP_){
return webcv.midi.map_to_range.call(null,new cljs.core.Keyword("webcv.midi","velocity","webcv.midi/velocity",-1464249691).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("webcv.chan","input","webcv.chan/input",1319946644).cljs$core$IFn$_invoke$arity$1(p1__29467_SHARP_)),(0),(127),new cljs.core.Keyword("webcv.midi","min","webcv.midi/min",687650234).cljs$core$IFn$_invoke$arity$1(p1__29467_SHARP_),new cljs.core.Keyword("webcv.midi","max","webcv.midi/max",892449532).cljs$core$IFn$_invoke$arity$1(p1__29467_SHARP_));
})));
}));
...
var vec__29468 = cljs.core.js__GT_clj.call(null,js_arr);
var status = cljs.core.nth.call(null,vec__29468,(0),null);
var note = cljs.core.nth.call(null,vec__29468,(1),null);
var velocity = cljs.core.nth.call(null,vec__29468,(2),null);
...
webcv.midi.event_x_msg = cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__29471_SHARP_){
return cljs.core._EQ_.call(null,(3),p1__29471_SHARP_.data.length);
})),cljs.core.map.call(null,webcv.midi.event__GT_msg));
/**
 * This is probably wrong
 */
webcv.midi.msg__GT_event = (function webcv$midi$msg__GT_event(p__29472){
...
var type = cljs.core.get.call(null,map__29473__$1,new cljs.core.Keyword("webcv.midi","type","webcv.midi/type",1350996868));
var note = cljs.core.get.call(null,map__29473__$1,new cljs.core.Keyword("webcv.midi","note","webcv.midi/note",1114457544));
var velocity = cljs.core.get.call(null,map__29473__$1,new cljs.core.Keyword("webcv.midi","velocity","webcv.midi/velocity",-1464249691));
...
var c__23570__auto___29492 = cljs.core.async.chan.call(null,(1));
cljs.core.async.impl.dispatch.run.call(null,((function (c__23570__auto___29492,c){
return (function (){
var f__23571__auto__ = (function (){var switch__23475__auto__ = ((function (c__23570__auto___29492,c){
return (function (state_29483){
var state_val_29484 = (state_29483[(1)]);
if((state_val_29484 === (1))){
var state_29483__$1 = state_29483;
var statearr_29485_29493 = state_29483__$1;
(statearr_29485_29493[(2)] = null);

(statearr_29485_29493[(1)] = (2));
...
var state_29483__$1 = state_29483;
return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_29483__$1,(4),c);
} else {
...
var inst_29477 = (state_29483[(2)]);
var inst_29478 = midi_out.send(inst_29477);
var state_29483__$1 = (function (){var statearr_29486 = state_29483;
(statearr_29486[(7)] = inst_29478);

return statearr_29486;
})();
var statearr_29487_29494 = state_29483__$1;
(statearr_29487_29494[(2)] = null);

(statearr_29487_29494[(1)] = (2));
...
});})(c__23570__auto___29492,c))
;
return ((function (switch__23475__auto__,c__23570__auto___29492,c){
return (function() {
...
(statearr_29488[(0)] = webcv$midi$midi_out_chan_$_state_machine__23476__auto__);

(statearr_29488[(1)] = (1));

return statearr_29488;
});
var webcv$midi$midi_out_chan_$_state_machine__23476__auto____1 = (function (state_29483){
while(true){
var ret_value__23477__auto__ = (function (){try{while(true){
var result__23478__auto__ = switch__23475__auto__.call(null,state_29483);
...
var ex__23479__auto__ = e29489;
var statearr_29490_29495 = state_29483;
(statearr_29490_29495[(5)] = ex__23479__auto__);
...
var G__29496 = state_29483;
state_29483 = G__29496;
continue;
} else {
...
webcv$midi$midi_out_chan_$_state_machine__23476__auto__ = function(state_29483){
switch(arguments.length){
case 0:
return webcv$midi$midi_out_chan_$_state_machine__23476__auto____0.call(this);
case 1:
return webcv$midi$midi_out_chan_$_state_machine__23476__auto____1.call(this,state_29483);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
;})(switch__23475__auto__,c__23570__auto___29492,c))
})();
var state__23572__auto__ = (function (){var statearr_29491 = f__23571__auto__.call(null);
(statearr_29491[(6)] = c__23570__auto___29492);
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,(function (p1__29497_SHARP_){
return p1__29497_SHARP_.name;
...
//# sourceMappingURL=midi.js.map?rel=1601259675456
