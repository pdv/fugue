...
return cljs.spec.alpha.map_spec_impl.call(null,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[null,null,null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__34653){
return cljs.core.map_QMARK_.call(null,G__34653);
}),(function (G__34653){
return cljs.core.contains_QMARK_.call(null,G__34653,new cljs.core.Keyword("webcv.midi","input-name","webcv.midi/input-name",80810145));
})], null),(function (G__34653){
return ((cljs.core.map_QMARK_.call(null,G__34653)) && (cljs.core.contains_QMARK_.call(null,G__34653,new cljs.core.Keyword("webcv.midi","input-name","webcv.midi/input-name",80810145))));
...
cljs.core._add_method.call(null,webcv.chan.make_chan_node,new cljs.core.Keyword("webcv.midi","midi-in","webcv.midi/midi-in",1504142596),(function (p__34654,p__34655){
...
var ins = cljs.core.get.call(null,map__34656__$1,new cljs.core.Keyword("webcv.midi","ins","webcv.midi/ins",1736405462));
var map__34657 = p__34655;
...
var input_name = cljs.core.get.call(null,map__34657__$1,new cljs.core.Keyword("webcv.midi","input-name","webcv.midi/input-name",80810145));
...
return (function() {
var G__34664 = null;
var G__34664__0 = (function (){
return rf.call(null);
});
var G__34664__1 = (function (result){
return rf.call(null,result);
});
var G__34664__2 = (function (result,midi){
var map__34662 = midi;
...
var note = cljs.core.get.call(null,map__34662__$1,new cljs.core.Keyword("webcv.midi","note","webcv.midi/note",1114457544));
var velocity = cljs.core.get.call(null,map__34662__$1,new cljs.core.Keyword("webcv.midi","velocity","webcv.midi/velocity",-1464249691));
var note_on = (velocity > (0));
var op = ((note_on)?cljs.core.conj:((function (map__34662,map__34662__$1,note,velocity,note_on,v_down){
return (function (p1__34661_SHARP_,p2__34660_SHARP_){
return cljs.core.remove.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([p2__34660_SHARP_]),p1__34661_SHARP_);
});})(map__34662,map__34662__$1,note,velocity,note_on,v_down))
);
...
G__34664 = function(result,midi){
switch(arguments.length){
case 0:
return G__34664__0.call(this);
case 1:
return G__34664__1.call(this,result);
case 2:
return G__34664__2.call(this,result,midi);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__34664.cljs$core$IFn$_invoke$arity$0 = G__34664__0;
G__34664.cljs$core$IFn$_invoke$arity$1 = G__34664__1;
G__34664.cljs$core$IFn$_invoke$arity$2 = G__34664__2;
return G__34664;
})()
;})(v_down))
});
...
return (function() {
var G__34667 = null;
var G__34667__0 = (function (){
return rf.call(null);
});
var G__34667__1 = (function (result){
return rf.call(null,result);
});
var G__34667__2 = (function (result,midi){
var map__34665 = midi;
...
var type = cljs.core.get.call(null,map__34665__$1,new cljs.core.Keyword("webcv.midi","type","webcv.midi/type",1350996868));
var velocity = cljs.core.get.call(null,map__34665__$1,new cljs.core.Keyword("webcv.midi","velocity","webcv.midi/velocity",-1464249691));
...
G__34667 = function(result,midi){
switch(arguments.length){
case 0:
return G__34667__0.call(this);
case 1:
return G__34667__1.call(this,result);
case 2:
return G__34667__2.call(this,result,midi);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__34667.cljs$core$IFn$_invoke$arity$0 = G__34667__0;
G__34667.cljs$core$IFn$_invoke$arity$1 = G__34667__1;
 ...
 */
webcv.midi.midi_x_gate = cljs.core.comp.call(null,webcv.midi.midi_x_velo.call(null,true),cljs.core.map.call(null,(function (p1__34668_SHARP_){
return (p1__34668_SHARP_ / (128));
})));
...
return cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__34669_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword("webcv.midi","note","webcv.midi/note",1114457544).cljs$core$IFn$_invoke$arity$1(p1__34669_SHARP_),new cljs.core.Keyword("webcv.midi","note","webcv.midi/note",1114457544).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("webcv.chan","input","webcv.chan/input",1319946644).cljs$core$IFn$_invoke$arity$1(p1__34669_SHARP_)));
})),cljs.core.map.call(null,(function (p1__34670_SHARP_){
return webcv.midi.map_to_range.call(null,new cljs.core.Keyword("webcv.midi","velocity","webcv.midi/velocity",-1464249691).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("webcv.chan","input","webcv.chan/input",1319946644).cljs$core$IFn$_invoke$arity$1(p1__34670_SHARP_)),(0),(127),new cljs.core.Keyword("webcv.midi","min","webcv.midi/min",687650234).cljs$core$IFn$_invoke$arity$1(p1__34670_SHARP_),new cljs.core.Keyword("webcv.midi","max","webcv.midi/max",892449532).cljs$core$IFn$_invoke$arity$1(p1__34670_SHARP_));
})));
}));
...
var vec__34671 = cljs.core.js__GT_clj.call(null,js_arr);
var status = cljs.core.nth.call(null,vec__34671,(0),null);
var note = cljs.core.nth.call(null,vec__34671,(1),null);
var velocity = cljs.core.nth.call(null,vec__34671,(2),null);
...
webcv.midi.event_x_msg = cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__34674_SHARP_){
return cljs.core._EQ_.call(null,(3),p1__34674_SHARP_.data.length);
})),cljs.core.map.call(null,webcv.midi.event__GT_msg));
/**
 * This is probably wrong
 */
webcv.midi.msg__GT_event = (function webcv$midi$msg__GT_event(p__34675){
...
var type = cljs.core.get.call(null,map__34676__$1,new cljs.core.Keyword("webcv.midi","type","webcv.midi/type",1350996868));
var note = cljs.core.get.call(null,map__34676__$1,new cljs.core.Keyword("webcv.midi","note","webcv.midi/note",1114457544));
var velocity = cljs.core.get.call(null,map__34676__$1,new cljs.core.Keyword("webcv.midi","velocity","webcv.midi/velocity",-1464249691));
...
var c__32720__auto___34695 = cljs.core.async.chan.call(null,(1));
cljs.core.async.impl.dispatch.run.call(null,((function (c__32720__auto___34695,c){
return (function (){
var f__32721__auto__ = (function (){var switch__32625__auto__ = ((function (c__32720__auto___34695,c){
return (function (state_34686){
var state_val_34687 = (state_34686[(1)]);
if((state_val_34687 === (1))){
var state_34686__$1 = state_34686;
var statearr_34688_34696 = state_34686__$1;
(statearr_34688_34696[(2)] = null);

(statearr_34688_34696[(1)] = (2));
...
var state_34686__$1 = state_34686;
return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_34686__$1,(4),c);
} else {
...
var inst_34681 = midi_out.send(inst_34680);
var state_34686__$1 = (function (){var statearr_34689 = state_34686;
(statearr_34689[(7)] = inst_34681);

return statearr_34689;
})();
var statearr_34690_34697 = state_34686__$1;
(statearr_34690_34697[(2)] = null);

(statearr_34690_34697[(1)] = (2));
...
});})(c__32720__auto___34695,c))
;
return ((function (switch__32625__auto__,c__32720__auto___34695,c){
return (function() {
var webcv$midi$midi_out_chan_$_state_machine__32626__auto__ = null;
var webcv$midi$midi_out_chan_$_state_machine__32626__auto____0 = (function (){
var statearr_34691 = [null,null,null,null,null,null,null,null];
(statearr_34691[(0)] = webcv$midi$midi_out_chan_$_state_machine__32626__auto__);

(statearr_34691[(1)] = (1));

return statearr_34691;
});
var webcv$midi$midi_out_chan_$_state_machine__32626__auto____1 = (function (state_34686){
while(true){
var ret_value__32627__auto__ = (function (){try{while(true){
var result__32628__auto__ = switch__32625__auto__.call(null,state_34686);
...
var ex__32629__auto__ = e34692;
var statearr_34693_34698 = state_34686;
(statearr_34693_34698[(5)] = ex__32629__auto__);
...
var G__34699 = state_34686;
state_34686 = G__34699;
continue;
} else {
...
webcv$midi$midi_out_chan_$_state_machine__32626__auto__ = function(state_34686){
switch(arguments.length){
case 0:
return webcv$midi$midi_out_chan_$_state_machine__32626__auto____0.call(this);
case 1:
return webcv$midi$midi_out_chan_$_state_machine__32626__auto____1.call(this,state_34686);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
webcv$midi$midi_out_chan_$_state_machine__32626__auto__.cljs$core$IFn$_invoke$arity$0 = webcv$midi$midi_out_chan_$_state_machine__32626__auto____0;
webcv$midi$midi_out_chan_$_state_machine__32626__auto__.cljs$core$IFn$_invoke$arity$1 = webcv$midi$midi_out_chan_$_state_machine__32626__auto____1;
return webcv$midi$midi_out_chan_$_state_machine__32626__auto__;
})()
;})(switch__32625__auto__,c__32720__auto___34695,c))
})();
var state__32722__auto__ = (function (){var statearr_34694 = f__32721__auto__.call(null);
(statearr_34694[(6)] = c__32720__auto___34695);
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,(function (p1__34700_SHARP_){
return p1__34700_SHARP_.name;
...
//# sourceMappingURL=midi.js.map?rel=1601274369337
