...
var G__37431 = devtools.prefs.pref.call(null,v);
v = G__37431;
continue;
} else {
return v;
...
}catch (e37434){var _e__36695__auto__ = e37434;
return false;
}})();
...
}catch (e37438){var _e__36695__auto__ = e37438;
return false;
}})();
...
}catch (e37440){var _e__36695__auto__ = e37440;
return false;
}}
}
});
...
var vec__37442 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__37442,(0),null);
var name = cljs.core.nth.call(null,vec__37442,(1),null);
...
return cljs.core.some.call(null,(function (p1__37445_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__37445_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1601256065307
