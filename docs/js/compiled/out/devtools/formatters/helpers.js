...
var G__37436 = devtools.prefs.pref.call(null,v);
v = G__37436;
continue;
} else {
return v;
...
}catch (e37439){var _e__36700__auto__ = e37439;
return false;
}})();
...
}catch (e37443){var _e__36700__auto__ = e37443;
return false;
}})();
...
}catch (e37445){var _e__36700__auto__ = e37445;
return false;
}}
}
});
...
var vec__37447 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__37447,(0),null);
var name = cljs.core.nth.call(null,vec__37447,(1),null);
...
return cljs.core.some.call(null,(function (p1__37450_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__37450_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1601267810126
