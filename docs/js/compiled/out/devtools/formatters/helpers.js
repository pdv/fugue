...
var G__37450 = devtools.prefs.pref.call(null,v);
v = G__37450;
continue;
} else {
return v;
...
}catch (e37453){var _e__36714__auto__ = e37453;
return false;
}})();
...
}catch (e37457){var _e__36714__auto__ = e37457;
return false;
}})();
...
}catch (e37459){var _e__36714__auto__ = e37459;
return false;
}}
}
});
...
var vec__37461 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__37461,(0),null);
var name = cljs.core.nth.call(null,vec__37461,(1),null);
...
return cljs.core.some.call(null,(function (p1__37464_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__37464_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1601311821461
