...
}catch (e38211){var _e = e38211;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___38214 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___38214)){
var seen_errors_38215 = temp__5718__auto___38214;
if(cljs.core.truth_(seen_errors_38215.has(self))){
} else {
seen_errors_38215.add(self);

var temp__5720__auto___38216 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___38216)){
var sense_38217 = temp__5720__auto___38216;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_38217)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1601256066646
