...
var map__38217 = top_item;
var map__38217__$1 = (((((!((map__38217 == null))))?(((((map__38217.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38217.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38217):map__38217);
var file = cljs.core.get.call(null,map__38217__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__38217__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__38217__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e38216){var _e = e38216;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___38219 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___38219)){
var seen_errors_38220 = temp__5718__auto___38219;
if(cljs.core.truth_(seen_errors_38220.has(self))){
} else {
seen_errors_38220.add(self);

var temp__5720__auto___38221 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___38221)){
var sense_38222 = temp__5720__auto___38221;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_38222)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1601261557999
