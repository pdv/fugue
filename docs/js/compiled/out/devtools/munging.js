...
var o37013 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37013["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37014 = temp__5718__auto____$1;
return (o37014["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36375__auto__ = f;
return (o__36375__auto__["toString"]).call(o__36375__auto__);
} else {
return "";
}
}catch (e37015){var _ = e37015;
return "";
}});
...
try{var o__36375__auto___37017 = t;
(o__36375__auto___37017["cljs$lang$ctorPrWriter"]).call(o__36375__auto___37017,t,writer);
}catch (e37016){var __37018 = e37016;
}
...
var char_code = (function (){var o__36375__auto__ = (new String(char$));
return (o__36375__auto__["charCodeAt"]).call(o__36375__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36375__auto__ = String;
return (o__36375__auto__["fromCharCode"]).call(o__36375__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37019 = num_code;
switch (G__37019) {
case (1):
return (185);
...
var o__36375__auto__ = String;
return (o__36375__auto__["fromCharCode"]).call(o__36375__auto__,superscript_code);
});
/**
...
}catch (e37021){var _e__36382__auto__ = e37021;
return false;
}})())){
...
var vec__37022 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__37022,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o37025 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37025["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37026 = temp__5718__auto____$1;
return (o37026["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37029){
var vec__37030 = p__37029;
var ns_detector = cljs.core.nth.call(null,vec__37030,(0),null);
...
var G__37036 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37037 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37036;
remaining_tokens = G__37037;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37027){
var G__37028 = cljs.core.first.call(null,seq37027);
var seq37027__$1 = cljs.core.next.call(null,seq37027);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37028,seq37027__$1);
});
...
var vec__37041 = cljs.core.split_with.call(null,(function (p1__37040_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37040_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37041,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37041,(1),null);
...
var vec__37047 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37047,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37047,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37050 = cljs.core.rest.call(null,remaining_tokens);
var G__37051 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37050;
name_tokens = G__37051;
continue;
} else {
...
var vec__37054 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37054,(0),null);
var arity = cljs.core.nth.call(null,vec__37054,(1),null);
var vec__37057 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37057,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37057,(1),null);
var vec__37060 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37060,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37060,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37060,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37060,(3),null);
...
var vec__37066 = result;
var munged_ns = cljs.core.nth.call(null,vec__37066,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37066,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37066,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37066,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37066,(4),null);
var arity = cljs.core.nth.call(null,vec__37066,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__37070 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__37070,(0),null);
var args = cljs.core.nth.call(null,vec__37070,(1),null);
var vec__37073 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37073,(0),null);
var name = cljs.core.nth.call(null,vec__37073,(1),null);
...
var G__37076 = (arity + (1));
var G__37077 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37078){
var vec__37079 = p__37078;
var arity = cljs.core.nth.call(null,vec__37079,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37079,(1),null);
...
return cljs.core.get.call(null,arities,p1__37082_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__37083_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___37090 = arguments.length;
var i__4731__auto___37091 = (0);
while(true){
if((i__4731__auto___37091 < len__4730__auto___37090)){
args__4736__auto__.push((arguments[i__4731__auto___37091]));

var G__37092 = (i__4731__auto___37091 + (1));
i__4731__auto___37091 = G__37092;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37086){
var vec__37087 = p__37086;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37087,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37084){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__37095__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37095__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37095__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37095__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37096 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37096,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37096,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37096,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37096,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37096,(4),null);
var arity = cljs.core.nth.call(null,vec__37096,(5),null);
...
var o__36375__auto__ = f;
return (o__36375__auto__["getBasis"]).call(o__36375__auto__);
});
/**
...
}catch (e37100){var _e__36382__auto__ = e37100;
...
var G__37101 = (obj[cljs.core.first.call(null,path)]);
var G__37102 = cljs.core.rest.call(null,path);
obj = G__37101;
path = G__37102;
continue;
} else {
...
return (function (accum,p__37103){
var vec__37104 = p__37103;
var bit = cljs.core.nth.call(null,vec__37104,(0),null);
var protocol = cljs.core.nth.call(null,vec__37104,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37107){
var vec__37108 = p__37107;
var ns = cljs.core.nth.call(null,vec__37108,(0),null);
var name = cljs.core.nth.call(null,vec__37108,(1),null);
var selector = cljs.core.nth.call(null,vec__37108,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__37113,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37113,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__37113,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37111_SHARP_){
return (obj[cljs.core.first.call(null,p1__37111_SHARP_)]);
});})(name,sorted_matches,vec__37113,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1600808352108
