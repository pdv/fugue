...
var o37326 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37326["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37327 = temp__5718__auto____$1;
return (o37327["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36688__auto__ = f;
return (o__36688__auto__["toString"]).call(o__36688__auto__);
} else {
return "";
}
}catch (e37328){var _ = e37328;
return "";
}});
...
try{var o__36688__auto___37330 = t;
(o__36688__auto___37330["cljs$lang$ctorPrWriter"]).call(o__36688__auto___37330,t,writer);
}catch (e37329){var __37331 = e37329;
}
...
var char_code = (function (){var o__36688__auto__ = (new String(char$));
return (o__36688__auto__["charCodeAt"]).call(o__36688__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36688__auto__ = String;
return (o__36688__auto__["fromCharCode"]).call(o__36688__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37332 = num_code;
switch (G__37332) {
case (1):
return (185);
...
var o__36688__auto__ = String;
return (o__36688__auto__["fromCharCode"]).call(o__36688__auto__,superscript_code);
});
/**
...
}catch (e37334){var _e__36695__auto__ = e37334;
return false;
}})())){
...
var vec__37335 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__37335,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o37338 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37338["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37339 = temp__5718__auto____$1;
return (o37339["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___37346 = arguments.length;
var i__4731__auto___37347 = (0);
while(true){
if((i__4731__auto___37347 < len__4730__auto___37346)){
args__4736__auto__.push((arguments[i__4731__auto___37347]));

var G__37348 = (i__4731__auto___37347 + (1));
i__4731__auto___37347 = G__37348;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37342){
var vec__37343 = p__37342;
var ns_detector = cljs.core.nth.call(null,vec__37343,(0),null);
...
var G__37349 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37350 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37349;
remaining_tokens = G__37350;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37340){
var G__37341 = cljs.core.first.call(null,seq37340);
var seq37340__$1 = cljs.core.next.call(null,seq37340);
...
var vec__37354 = cljs.core.split_with.call(null,(function (p1__37353_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37353_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37354,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37354,(1),null);
...
var vec__37360 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37360,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37360,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37363 = cljs.core.rest.call(null,remaining_tokens);
var G__37364 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37363;
name_tokens = G__37364;
continue;
} else {
...
var vec__37367 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37367,(0),null);
var arity = cljs.core.nth.call(null,vec__37367,(1),null);
var vec__37370 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37370,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37370,(1),null);
var vec__37373 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37373,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37373,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37373,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37373,(3),null);
...
var vec__37379 = result;
var munged_ns = cljs.core.nth.call(null,vec__37379,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37379,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37379,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37379,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37379,(4),null);
var arity = cljs.core.nth.call(null,vec__37379,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__37383 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__37383,(0),null);
var args = cljs.core.nth.call(null,vec__37383,(1),null);
var vec__37386 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37386,(0),null);
var name = cljs.core.nth.call(null,vec__37386,(1),null);
...
var G__37389 = (arity + (1));
var G__37390 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37391){
var vec__37392 = p__37391;
var arity = cljs.core.nth.call(null,vec__37392,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37392,(1),null);
...
return cljs.core.get.call(null,arities,p1__37395_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__37396_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___37403 = arguments.length;
var i__4731__auto___37404 = (0);
while(true){
if((i__4731__auto___37404 < len__4730__auto___37403)){
args__4736__auto__.push((arguments[i__4731__auto___37404]));

var G__37405 = (i__4731__auto___37404 + (1));
i__4731__auto___37404 = G__37405;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37399){
var vec__37400 = p__37399;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37400,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37397){
var G__37398 = cljs.core.first.call(null,seq37397);
var seq37397__$1 = cljs.core.next.call(null,seq37397);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37398,seq37397__$1);
});
...
var G__37406 = arg;
var G__37406__$1 = (((G__37406 instanceof cljs.core.Keyword))?G__37406.fqn:null);
switch (G__37406__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__37408__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37408__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37408__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37408__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37409 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37409,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37409,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37409,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37409,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37409,(4),null);
var arity = cljs.core.nth.call(null,vec__37409,(5),null);
...
var o__36688__auto__ = f;
return (o__36688__auto__["getBasis"]).call(o__36688__auto__);
});
/**
...
}catch (e37413){var _e__36695__auto__ = e37413;
...
var G__37414 = (obj[cljs.core.first.call(null,path)]);
var G__37415 = cljs.core.rest.call(null,path);
obj = G__37414;
path = G__37415;
continue;
} else {
...
return (function (accum,p__37416){
var vec__37417 = p__37416;
var bit = cljs.core.nth.call(null,vec__37417,(0),null);
var protocol = cljs.core.nth.call(null,vec__37417,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37420){
var vec__37421 = p__37420;
var ns = cljs.core.nth.call(null,vec__37421,(0),null);
var name = cljs.core.nth.call(null,vec__37421,(1),null);
var selector = cljs.core.nth.call(null,vec__37421,(2),null);
...
return (function (p__37425){
var vec__37426 = p__37425;
var munged_name = cljs.core.nth.call(null,vec__37426,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37426,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__37426,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37424_SHARP_){
return (obj[cljs.core.first.call(null,p1__37424_SHARP_)]);
});})(name,sorted_matches,vec__37426,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1601256065195
