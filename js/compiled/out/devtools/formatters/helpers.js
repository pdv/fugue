...
var G__39587 = devtools.prefs.pref.call(null,v);
v = G__39587;
continue;
} else {
return v;
...
}catch (e39590){var _e__38851__auto__ = e39590;
return false;
}})();
...
}catch (e39594){var _e__38851__auto__ = e39594;
return false;
}})();
...
}catch (e39596){var _e__38851__auto__ = e39596;
return false;
}}
}
});
...
var vec__39598 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39598,(0),null);
var name = cljs.core.nth.call(null,vec__39598,(1),null);
...
return cljs.core.some.call(null,(function (p1__39601_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39601_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1610128219515
