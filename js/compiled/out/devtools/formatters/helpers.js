...
var G__39472 = devtools.prefs.pref.call(null,v);
v = G__39472;
continue;
} else {
return v;
...
}catch (e39475){var _e__38736__auto__ = e39475;
return false;
}})();
...
}catch (e39479){var _e__38736__auto__ = e39479;
return false;
}})();
...
}catch (e39481){var _e__38736__auto__ = e39481;
return false;
}}
}
});
...
var vec__39483 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39483,(0),null);
var name = cljs.core.nth.call(null,vec__39483,(1),null);
...
return cljs.core.some.call(null,(function (p1__39486_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39486_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1608403401085
