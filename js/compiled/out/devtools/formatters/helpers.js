...
var G__37467 = devtools.prefs.pref.call(null,v);
v = G__37467;
continue;
} else {
return v;
...
}catch (e37470){var _e__36731__auto__ = e37470;
return false;
}})();
...
}catch (e37474){var _e__36731__auto__ = e37474;
return false;
}})();
...
}catch (e37476){var _e__36731__auto__ = e37476;
return false;
}}
}
});
...
var vec__37478 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__37478,(0),null);
var name = cljs.core.nth.call(null,vec__37478,(1),null);
...
return cljs.core.some.call(null,(function (p1__37481_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__37481_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1601313155506
