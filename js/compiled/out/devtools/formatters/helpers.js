...
var G__39396 = devtools.prefs.pref.call(null,v);
v = G__39396;
continue;
} else {
return v;
...
}catch (e39399){var _e__38660__auto__ = e39399;
return false;
}})();
...
}catch (e39403){var _e__38660__auto__ = e39403;
return false;
}})();
...
}catch (e39405){var _e__38660__auto__ = e39405;
return false;
}}
}
});
...
var vec__39407 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39407,(0),null);
var name = cljs.core.nth.call(null,vec__39407,(1),null);
...
return cljs.core.some.call(null,(function (p1__39410_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39410_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1601408414219
