...
var G__39486 = devtools.prefs.pref.call(null,v);
v = G__39486;
continue;
} else {
return v;
...
}catch (e39489){var _e__38750__auto__ = e39489;
return false;
}})();
...
}catch (e39493){var _e__38750__auto__ = e39493;
return false;
}})();
...
}catch (e39495){var _e__38750__auto__ = e39495;
return false;
}}
}
});
...
var vec__39497 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39497,(0),null);
var name = cljs.core.nth.call(null,vec__39497,(1),null);
...
return cljs.core.some.call(null,(function (p1__39500_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39500_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1610051535788
