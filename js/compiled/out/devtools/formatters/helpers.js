...
var G__39211 = devtools.prefs.pref.call(null,v);
v = G__39211;
continue;
} else {
return v;
...
}catch (e39214){var _e__38475__auto__ = e39214;
return false;
}})();
...
}catch (e39218){var _e__38475__auto__ = e39218;
return false;
}})();
...
}catch (e39220){var _e__38475__auto__ = e39220;
return false;
}}
}
});
...
var vec__39222 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39222,(0),null);
var name = cljs.core.nth.call(null,vec__39222,(1),null);
...
return cljs.core.some.call(null,(function (p1__39225_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39225_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1601347620487
