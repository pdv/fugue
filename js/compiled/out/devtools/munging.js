...
var o19816 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19816["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19817 = temp__5718__auto____$1;
return (o19817["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19178__auto__ = f;
return (o__19178__auto__["toString"]).call(o__19178__auto__);
} else {
return "";
}
}catch (e19818){var _ = e19818;
return "";
}});
...
try{var o__19178__auto___19820 = t;
(o__19178__auto___19820["cljs$lang$ctorPrWriter"]).call(o__19178__auto___19820,t,writer);
}catch (e19819){var __19821 = e19819;
}
...
var char_code = (function (){var o__19178__auto__ = (new String(char$));
return (o__19178__auto__["charCodeAt"]).call(o__19178__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19178__auto__ = String;
return (o__19178__auto__["fromCharCode"]).call(o__19178__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19822 = num_code;
switch (G__19822) {
case (1):
return (185);
...
var o__19178__auto__ = String;
return (o__19178__auto__["fromCharCode"]).call(o__19178__auto__,superscript_code);
});
/**
...
}catch (e19824){var _e__19185__auto__ = e19824;
return false;
}})())){
...
var vec__19825 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19825,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o19828 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19828["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19829 = temp__5718__auto____$1;
return (o19829["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19832){
var vec__19833 = p__19832;
var ns_detector = cljs.core.nth.call(null,vec__19833,(0),null);
...
var G__19839 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19840 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19839;
remaining_tokens = G__19840;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19830){
var G__19831 = cljs.core.first.call(null,seq19830);
var seq19830__$1 = cljs.core.next.call(null,seq19830);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19831,seq19830__$1);
});
...
var vec__19844 = cljs.core.split_with.call(null,(function (p1__19843_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19843_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19844,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19844,(1),null);
...
var vec__19850 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19850,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19850,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19853 = cljs.core.rest.call(null,remaining_tokens);
var G__19854 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19853;
name_tokens = G__19854;
continue;
} else {
...
var vec__19857 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19857,(0),null);
var arity = cljs.core.nth.call(null,vec__19857,(1),null);
var vec__19860 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19860,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19860,(1),null);
var vec__19863 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19863,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19863,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19863,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19863,(3),null);
...
var vec__19869 = result;
var munged_ns = cljs.core.nth.call(null,vec__19869,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19869,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19869,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19869,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19869,(4),null);
var arity = cljs.core.nth.call(null,vec__19869,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__19873 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__19873,(0),null);
var args = cljs.core.nth.call(null,vec__19873,(1),null);
var vec__19876 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19876,(0),null);
var name = cljs.core.nth.call(null,vec__19876,(1),null);
...
var G__19879 = (arity + (1));
var G__19880 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19881){
var vec__19882 = p__19881;
var arity = cljs.core.nth.call(null,vec__19882,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19882,(1),null);
...
return cljs.core.get.call(null,arities,p1__19885_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19886_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___19893 = arguments.length;
var i__4731__auto___19894 = (0);
while(true){
if((i__4731__auto___19894 < len__4730__auto___19893)){
args__4736__auto__.push((arguments[i__4731__auto___19894]));

var G__19895 = (i__4731__auto___19894 + (1));
i__4731__auto___19894 = G__19895;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19889){
var vec__19890 = p__19889;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19890,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19887){
var G__19888 = cljs.core.first.call(null,seq19887);
var seq19887__$1 = cljs.core.next.call(null,seq19887);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19888,seq19887__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19898__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19898__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19898__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19898__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19899 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19899,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19899,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19899,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19899,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19899,(4),null);
var arity = cljs.core.nth.call(null,vec__19899,(5),null);
...
var o__19178__auto__ = f;
return (o__19178__auto__["getBasis"]).call(o__19178__auto__);
});
/**
...
}catch (e19903){var _e__19185__auto__ = e19903;
...
var G__19904 = (obj[cljs.core.first.call(null,path)]);
var G__19905 = cljs.core.rest.call(null,path);
obj = G__19904;
path = G__19905;
continue;
} else {
...
return (function (accum,p__19906){
var vec__19907 = p__19906;
var bit = cljs.core.nth.call(null,vec__19907,(0),null);
var protocol = cljs.core.nth.call(null,vec__19907,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19910){
var vec__19911 = p__19910;
var ns = cljs.core.nth.call(null,vec__19911,(0),null);
var name = cljs.core.nth.call(null,vec__19911,(1),null);
var selector = cljs.core.nth.call(null,vec__19911,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19916,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19916,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19916,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19914_SHARP_){
return (obj[cljs.core.first.call(null,p1__19914_SHARP_)]);
});})(name,sorted_matches,vec__19916,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1611104226135
