...
var o19811 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19811["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19812 = temp__5718__auto____$1;
return (o19812["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19173__auto__ = f;
return (o__19173__auto__["toString"]).call(o__19173__auto__);
} else {
return "";
}
}catch (e19813){var _ = e19813;
return "";
}});
...
try{var o__19173__auto___19815 = t;
(o__19173__auto___19815["cljs$lang$ctorPrWriter"]).call(o__19173__auto___19815,t,writer);
}catch (e19814){var __19816 = e19814;
}
...
var char_code = (function (){var o__19173__auto__ = (new String(char$));
return (o__19173__auto__["charCodeAt"]).call(o__19173__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19173__auto__ = String;
return (o__19173__auto__["fromCharCode"]).call(o__19173__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19817 = num_code;
switch (G__19817) {
case (1):
return (185);
...
var o__19173__auto__ = String;
return (o__19173__auto__["fromCharCode"]).call(o__19173__auto__,superscript_code);
});
/**
...
}catch (e19819){var _e__19180__auto__ = e19819;
return false;
}})())){
...
var vec__19820 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19820,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o19823 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19823["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19824 = temp__5718__auto____$1;
return (o19824["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___19831 = arguments.length;
var i__4731__auto___19832 = (0);
while(true){
if((i__4731__auto___19832 < len__4730__auto___19831)){
args__4736__auto__.push((arguments[i__4731__auto___19832]));

var G__19833 = (i__4731__auto___19832 + (1));
i__4731__auto___19832 = G__19833;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19827){
var vec__19828 = p__19827;
var ns_detector = cljs.core.nth.call(null,vec__19828,(0),null);
...
var G__19834 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19835 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19834;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19825){
var G__19826 = cljs.core.first.call(null,seq19825);
var seq19825__$1 = cljs.core.next.call(null,seq19825);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19826,seq19825__$1);
});
...
var vec__19839 = cljs.core.split_with.call(null,(function (p1__19838_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19838_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19839,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19839,(1),null);
...
var vec__19845 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19845,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19845,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19848 = cljs.core.rest.call(null,remaining_tokens);
var G__19849 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19848;
name_tokens = G__19849;
continue;
} else {
...
var vec__19852 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19852,(0),null);
var arity = cljs.core.nth.call(null,vec__19852,(1),null);
var vec__19855 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19855,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19855,(1),null);
var vec__19858 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19858,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19858,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19858,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19858,(3),null);
...
var vec__19864 = result;
var munged_ns = cljs.core.nth.call(null,vec__19864,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19864,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19864,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19864,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19864,(4),null);
var arity = cljs.core.nth.call(null,vec__19864,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__19868 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__19868,(0),null);
var args = cljs.core.nth.call(null,vec__19868,(1),null);
var vec__19871 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19871,(0),null);
var name = cljs.core.nth.call(null,vec__19871,(1),null);
...
var G__19874 = (arity + (1));
var G__19875 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19876){
var vec__19877 = p__19876;
var arity = cljs.core.nth.call(null,vec__19877,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19877,(1),null);
...
return cljs.core.get.call(null,arities,p1__19880_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19881_SHARP_);
...
var G__19890 = (i__4731__auto___19889 + (1));
i__4731__auto___19889 = G__19890;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19884){
var vec__19885 = p__19884;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19885,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19882){
var G__19883 = cljs.core.first.call(null,seq19882);
var seq19882__$1 = cljs.core.next.call(null,seq19882);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19883,seq19882__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19893__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19893__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19893__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19893__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19894 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19894,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19894,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19894,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19894,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19894,(4),null);
var arity = cljs.core.nth.call(null,vec__19894,(5),null);
...
var o__19173__auto__ = f;
return (o__19173__auto__["getBasis"]).call(o__19173__auto__);
});
/**
...
}catch (e19898){var _e__19180__auto__ = e19898;
...
var G__19899 = (obj[cljs.core.first.call(null,path)]);
var G__19900 = cljs.core.rest.call(null,path);
obj = G__19899;
path = G__19900;
continue;
} else {
...
return (function (accum,p__19901){
var vec__19902 = p__19901;
var bit = cljs.core.nth.call(null,vec__19902,(0),null);
var protocol = cljs.core.nth.call(null,vec__19902,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19905){
var vec__19906 = p__19905;
var ns = cljs.core.nth.call(null,vec__19906,(0),null);
var name = cljs.core.nth.call(null,vec__19906,(1),null);
var selector = cljs.core.nth.call(null,vec__19906,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19911,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19911,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19911,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19909_SHARP_){
return (obj[cljs.core.first.call(null,p1__19909_SHARP_)]);
});})(name,sorted_matches,vec__19911,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1611089351874
