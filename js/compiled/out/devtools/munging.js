...
var o39106 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39106["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39107 = temp__5718__auto____$1;
return (o39107["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38468__auto__ = f;
return (o__38468__auto__["toString"]).call(o__38468__auto__);
} else {
return "";
}
}catch (e39108){var _ = e39108;
return "";
}});
...
try{var o__38468__auto___39110 = t;
(o__38468__auto___39110["cljs$lang$ctorPrWriter"]).call(o__38468__auto___39110,t,writer);
}catch (e39109){var __39111 = e39109;
}
...
var char_code = (function (){var o__38468__auto__ = (new String(char$));
return (o__38468__auto__["charCodeAt"]).call(o__38468__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38468__auto__ = String;
return (o__38468__auto__["fromCharCode"]).call(o__38468__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39112 = num_code;
switch (G__39112) {
case (1):
return (185);
...
var o__38468__auto__ = String;
return (o__38468__auto__["fromCharCode"]).call(o__38468__auto__,superscript_code);
});
/**
...
}catch (e39114){var _e__38475__auto__ = e39114;
return false;
}})())){
...
var vec__39115 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39115,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39118 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39118["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39119 = temp__5718__auto____$1;
return (o39119["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39126 = arguments.length;
var i__4731__auto___39127 = (0);
while(true){
if((i__4731__auto___39127 < len__4730__auto___39126)){
args__4736__auto__.push((arguments[i__4731__auto___39127]));

var G__39128 = (i__4731__auto___39127 + (1));
i__4731__auto___39127 = G__39128;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39122){
var vec__39123 = p__39122;
var ns_detector = cljs.core.nth.call(null,vec__39123,(0),null);
...
var G__39129 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39130 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39129;
remaining_tokens = G__39130;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39120){
...
var vec__39134 = cljs.core.split_with.call(null,(function (p1__39133_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39133_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39134,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39134,(1),null);
...
var vec__39140 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39140,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39140,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39143 = cljs.core.rest.call(null,remaining_tokens);
var G__39144 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39143;
name_tokens = G__39144;
continue;
} else {
...
var vec__39147 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39147,(0),null);
var arity = cljs.core.nth.call(null,vec__39147,(1),null);
var vec__39150 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39150,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39150,(1),null);
var vec__39153 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39153,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39153,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39153,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39153,(3),null);
...
var vec__39159 = result;
var munged_ns = cljs.core.nth.call(null,vec__39159,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39159,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39159,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39159,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39159,(4),null);
var arity = cljs.core.nth.call(null,vec__39159,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39163 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39163,(0),null);
var args = cljs.core.nth.call(null,vec__39163,(1),null);
var vec__39166 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39166,(0),null);
var name = cljs.core.nth.call(null,vec__39166,(1),null);
...
var G__39169 = (arity + (1));
var G__39170 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39171){
var vec__39172 = p__39171;
var arity = cljs.core.nth.call(null,vec__39172,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39172,(1),null);
...
return cljs.core.get.call(null,arities,p1__39175_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39176_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39183 = arguments.length;
var i__4731__auto___39184 = (0);
while(true){
if((i__4731__auto___39184 < len__4730__auto___39183)){
args__4736__auto__.push((arguments[i__4731__auto___39184]));

var G__39185 = (i__4731__auto___39184 + (1));
i__4731__auto___39184 = G__39185;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39179){
var vec__39180 = p__39179;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39180,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39177){
var G__39178 = cljs.core.first.call(null,seq39177);
var seq39177__$1 = cljs.core.next.call(null,seq39177);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39178,seq39177__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39188__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39188__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39188__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39188__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39189 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39189,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39189,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39189,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39189,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39189,(4),null);
var arity = cljs.core.nth.call(null,vec__39189,(5),null);
...
var o__38468__auto__ = f;
return (o__38468__auto__["getBasis"]).call(o__38468__auto__);
});
/**
...
}catch (e39193){var _e__38475__auto__ = e39193;
...
var G__39194 = (obj[cljs.core.first.call(null,path)]);
var G__39195 = cljs.core.rest.call(null,path);
obj = G__39194;
path = G__39195;
continue;
} else {
...
return (function (accum,p__39196){
var vec__39197 = p__39196;
var bit = cljs.core.nth.call(null,vec__39197,(0),null);
var protocol = cljs.core.nth.call(null,vec__39197,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39200){
...
var selector = cljs.core.nth.call(null,vec__39201,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39206,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39206,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39206,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39204_SHARP_){
return (obj[cljs.core.first.call(null,p1__39204_SHARP_)]);
});})(name,sorted_matches,vec__39206,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1601347620411
