...
var o39108 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39108["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39109 = temp__5718__auto____$1;
return (o39109["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38470__auto__ = f;
return (o__38470__auto__["toString"]).call(o__38470__auto__);
} else {
return "";
}
}catch (e39110){var _ = e39110;
return "";
}});
...
try{var o__38470__auto___39112 = t;
(o__38470__auto___39112["cljs$lang$ctorPrWriter"]).call(o__38470__auto___39112,t,writer);
}catch (e39111){var __39113 = e39111;
}
...
var char_code = (function (){var o__38470__auto__ = (new String(char$));
return (o__38470__auto__["charCodeAt"]).call(o__38470__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38470__auto__ = String;
return (o__38470__auto__["fromCharCode"]).call(o__38470__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39114 = num_code;
switch (G__39114) {
case (1):
return (185);
...
var o__38470__auto__ = String;
return (o__38470__auto__["fromCharCode"]).call(o__38470__auto__,superscript_code);
});
/**
...
}catch (e39116){var _e__38477__auto__ = e39116;
return false;
}})())){
...
var vec__39117 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39117,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39120 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39120["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39121 = temp__5718__auto____$1;
return (o39121["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39124){
var vec__39125 = p__39124;
var ns_detector = cljs.core.nth.call(null,vec__39125,(0),null);
...
var G__39131 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39132 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39131;
remaining_tokens = G__39132;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39122){
var G__39123 = cljs.core.first.call(null,seq39122);
var seq39122__$1 = cljs.core.next.call(null,seq39122);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39123,seq39122__$1);
});
...
var vec__39136 = cljs.core.split_with.call(null,(function (p1__39135_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39135_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39136,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39136,(1),null);
...
var vec__39142 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39142,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39142,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39145 = cljs.core.rest.call(null,remaining_tokens);
var G__39146 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39145;
name_tokens = G__39146;
continue;
} else {
...
var vec__39149 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39149,(0),null);
var arity = cljs.core.nth.call(null,vec__39149,(1),null);
var vec__39152 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39152,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39152,(1),null);
var vec__39155 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39155,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39155,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39155,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39155,(3),null);
...
var vec__39161 = result;
var munged_ns = cljs.core.nth.call(null,vec__39161,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39161,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39161,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39161,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39161,(4),null);
var arity = cljs.core.nth.call(null,vec__39161,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39165 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39165,(0),null);
var args = cljs.core.nth.call(null,vec__39165,(1),null);
var vec__39168 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39168,(0),null);
var name = cljs.core.nth.call(null,vec__39168,(1),null);
...
var G__39171 = (arity + (1));
var G__39172 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39173){
var vec__39174 = p__39173;
var arity = cljs.core.nth.call(null,vec__39174,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39174,(1),null);
...
return cljs.core.get.call(null,arities,p1__39177_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39178_SHARP_);
...
args__4736__auto__.push((arguments[i__4731__auto___39186]));
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39181){
var vec__39182 = p__39181;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39182,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39179){
var G__39180 = cljs.core.first.call(null,seq39179);
var seq39179__$1 = cljs.core.next.call(null,seq39179);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39180,seq39179__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39190__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39190__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39190__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39190__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39191 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39191,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39191,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39191,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39191,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39191,(4),null);
var arity = cljs.core.nth.call(null,vec__39191,(5),null);
...
var o__38470__auto__ = f;
return (o__38470__auto__["getBasis"]).call(o__38470__auto__);
});
/**
...
}catch (e39195){var _e__38477__auto__ = e39195;
...
var G__39196 = (obj[cljs.core.first.call(null,path)]);
var G__39197 = cljs.core.rest.call(null,path);
obj = G__39196;
path = G__39197;
continue;
} else {
...
return (function (accum,p__39198){
var vec__39199 = p__39198;
var bit = cljs.core.nth.call(null,vec__39199,(0),null);
var protocol = cljs.core.nth.call(null,vec__39199,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39202){
var vec__39203 = p__39202;
var ns = cljs.core.nth.call(null,vec__39203,(0),null);
var name = cljs.core.nth.call(null,vec__39203,(1),null);
var selector = cljs.core.nth.call(null,vec__39203,(2),null);
...
return (function (p__39207){
var vec__39208 = p__39207;
var munged_name = cljs.core.nth.call(null,vec__39208,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39208,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39208,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39206_SHARP_){
return (obj[cljs.core.first.call(null,p1__39206_SHARP_)]);
});})(name,sorted_matches,vec__39208,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1601344977025
