...
var o39597 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39597["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39598 = temp__5718__auto____$1;
return (o39598["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38959__auto__ = f;
return (o__38959__auto__["toString"]).call(o__38959__auto__);
} else {
return "";
}
...
try{var o__38959__auto___39601 = t;
(o__38959__auto___39601["cljs$lang$ctorPrWriter"]).call(o__38959__auto___39601,t,writer);
}catch (e39600){var __39602 = e39600;
}
...
var char_code = (function (){var o__38959__auto__ = (new String(char$));
return (o__38959__auto__["charCodeAt"]).call(o__38959__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38959__auto__ = String;
return (o__38959__auto__["fromCharCode"]).call(o__38959__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39603 = num_code;
switch (G__39603) {
case (1):
return (185);
...
var o__38959__auto__ = String;
return (o__38959__auto__["fromCharCode"]).call(o__38959__auto__,superscript_code);
});
/**
...
}catch (e39605){var _e__38966__auto__ = e39605;
return false;
}})())){
...
var vec__39606 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39606,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39609 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39609["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39610 = temp__5718__auto____$1;
return (o39610["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39613){
var vec__39614 = p__39613;
var ns_detector = cljs.core.nth.call(null,vec__39614,(0),null);
...
var G__39620 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39621 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39620;
remaining_tokens = G__39621;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39611){
...
var vec__39625 = cljs.core.split_with.call(null,(function (p1__39624_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39624_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39625,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39625,(1),null);
...
var vec__39631 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39631,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39631,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39634 = cljs.core.rest.call(null,remaining_tokens);
var G__39635 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39634;
name_tokens = G__39635;
continue;
} else {
...
var vec__39638 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39638,(0),null);
var arity = cljs.core.nth.call(null,vec__39638,(1),null);
var vec__39641 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39641,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39641,(1),null);
var vec__39644 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39644,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39644,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39644,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39644,(3),null);
...
var vec__39650 = result;
var munged_ns = cljs.core.nth.call(null,vec__39650,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39650,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39650,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39650,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39650,(4),null);
var arity = cljs.core.nth.call(null,vec__39650,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39654 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39654,(0),null);
var args = cljs.core.nth.call(null,vec__39654,(1),null);
var vec__39657 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39657,(0),null);
var name = cljs.core.nth.call(null,vec__39657,(1),null);
...
var G__39660 = (arity + (1));
var G__39661 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39662){
var vec__39663 = p__39662;
var arity = cljs.core.nth.call(null,vec__39663,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39663,(1),null);
...
return (function (p1__39666_SHARP_){
return cljs.core.get.call(null,arities,p1__39666_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39667_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39670){
var vec__39671 = p__39670;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39671,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39668){
var G__39669 = cljs.core.first.call(null,seq39668);
var seq39668__$1 = cljs.core.next.call(null,seq39668);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39669,seq39668__$1);
});
...
var map__39679 = options;
var map__39679__$1 = (((((!((map__39679 == null))))?(((((map__39679.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39679.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39679):map__39679);
var include_ns_QMARK_ = cljs.core.get.call(null,map__39679__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39679__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39679__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39679__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39680 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39680,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39680,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39680,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39680,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39680,(4),null);
var arity = cljs.core.nth.call(null,vec__39680,(5),null);
...
var o__38959__auto__ = f;
return (o__38959__auto__["getBasis"]).call(o__38959__auto__);
});
/**
...
}catch (e39684){var _e__38966__auto__ = e39684;
...
var G__39685 = (obj[cljs.core.first.call(null,path)]);
var G__39686 = cljs.core.rest.call(null,path);
obj = G__39685;
path = G__39686;
continue;
} else {
...
return (function (accum,p__39687){
var vec__39688 = p__39687;
var bit = cljs.core.nth.call(null,vec__39688,(0),null);
var protocol = cljs.core.nth.call(null,vec__39688,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39691){
var vec__39692 = p__39691;
var ns = cljs.core.nth.call(null,vec__39692,(0),null);
var name = cljs.core.nth.call(null,vec__39692,(1),null);
var selector = cljs.core.nth.call(null,vec__39692,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39697,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39697,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39697,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39695_SHARP_){
return (obj[cljs.core.first.call(null,p1__39695_SHARP_)]);
});})(name,sorted_matches,vec__39697,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610304482109
