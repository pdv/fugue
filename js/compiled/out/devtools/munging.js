...
var o37354 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37354["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37355 = temp__5718__auto____$1;
return (o37355["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36716__auto__ = f;
return (o__36716__auto__["toString"]).call(o__36716__auto__);
} else {
return "";
}
}catch (e37356){var _ = e37356;
return "";
}});
...
try{var o__36716__auto___37358 = t;
(o__36716__auto___37358["cljs$lang$ctorPrWriter"]).call(o__36716__auto___37358,t,writer);
}catch (e37357){var __37359 = e37357;
}
...
var char_code = (function (){var o__36716__auto__ = (new String(char$));
return (o__36716__auto__["charCodeAt"]).call(o__36716__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36716__auto__ = String;
return (o__36716__auto__["fromCharCode"]).call(o__36716__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37360 = num_code;
switch (G__37360) {
case (1):
return (185);
...
var o__36716__auto__ = String;
return (o__36716__auto__["fromCharCode"]).call(o__36716__auto__,superscript_code);
});
/**
...
}catch (e37362){var _e__36723__auto__ = e37362;
return false;
}})())){
...
var vec__37363 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__37363,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o37366 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37366["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37367 = temp__5718__auto____$1;
return (o37367["nameToPath"]);
} else {
return null;
}
} else {
...
args__4736__auto__.push((arguments[i__4731__auto___37375]));
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37370){
var vec__37371 = p__37370;
var ns_detector = cljs.core.nth.call(null,vec__37371,(0),null);
...
var G__37377 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37378 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37377;
remaining_tokens = G__37378;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37368){
var G__37369 = cljs.core.first.call(null,seq37368);
var seq37368__$1 = cljs.core.next.call(null,seq37368);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37369,seq37368__$1);
});
...
var vec__37382 = cljs.core.split_with.call(null,(function (p1__37381_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37381_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37382,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37382,(1),null);
...
var vec__37388 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37388,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37388,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37391 = cljs.core.rest.call(null,remaining_tokens);
var G__37392 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37391;
name_tokens = G__37392;
continue;
} else {
...
var vec__37395 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37395,(0),null);
var arity = cljs.core.nth.call(null,vec__37395,(1),null);
var vec__37398 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37398,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37398,(1),null);
var vec__37401 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37401,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37401,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37401,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37401,(3),null);
...
var vec__37407 = result;
var munged_ns = cljs.core.nth.call(null,vec__37407,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37407,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37407,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37407,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37407,(4),null);
var arity = cljs.core.nth.call(null,vec__37407,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__37411 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__37411,(0),null);
var args = cljs.core.nth.call(null,vec__37411,(1),null);
var vec__37414 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37414,(0),null);
var name = cljs.core.nth.call(null,vec__37414,(1),null);
...
var G__37417 = (arity + (1));
var G__37418 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37419){
var vec__37420 = p__37419;
var arity = cljs.core.nth.call(null,vec__37420,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37420,(1),null);
...
return cljs.core.get.call(null,arities,p1__37423_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__37424_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___37431 = arguments.length;
var i__4731__auto___37432 = (0);
while(true){
if((i__4731__auto___37432 < len__4730__auto___37431)){
args__4736__auto__.push((arguments[i__4731__auto___37432]));

var G__37433 = (i__4731__auto___37432 + (1));
i__4731__auto___37432 = G__37433;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37427){
var vec__37428 = p__37427;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37428,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37425){
var G__37426 = cljs.core.first.call(null,seq37425);
var seq37425__$1 = cljs.core.next.call(null,seq37425);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37426,seq37425__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__37436__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37436__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37436__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37436__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37437 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37437,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37437,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37437,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37437,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37437,(4),null);
var arity = cljs.core.nth.call(null,vec__37437,(5),null);
...
var o__36716__auto__ = f;
return (o__36716__auto__["getBasis"]).call(o__36716__auto__);
});
/**
...
}catch (e37441){var _e__36723__auto__ = e37441;
...
var G__37442 = (obj[cljs.core.first.call(null,path)]);
var G__37443 = cljs.core.rest.call(null,path);
obj = G__37442;
path = G__37443;
continue;
} else {
...
return (function (accum,p__37444){
var vec__37445 = p__37444;
var bit = cljs.core.nth.call(null,vec__37445,(0),null);
var protocol = cljs.core.nth.call(null,vec__37445,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37448){
var vec__37449 = p__37448;
var ns = cljs.core.nth.call(null,vec__37449,(0),null);
var name = cljs.core.nth.call(null,vec__37449,(1),null);
var selector = cljs.core.nth.call(null,vec__37449,(2),null);
...
return (function (p__37453){
var vec__37454 = p__37453;
var munged_name = cljs.core.nth.call(null,vec__37454,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37454,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__37454,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37452_SHARP_){
return (obj[cljs.core.first.call(null,p1__37452_SHARP_)]);
});})(name,sorted_matches,vec__37454,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1601328145658
