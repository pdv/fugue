...
var o39381 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39381["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39382 = temp__5718__auto____$1;
return (o39382["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38743__auto__ = f;
return (o__38743__auto__["toString"]).call(o__38743__auto__);
} else {
return "";
}
}catch (e39383){var _ = e39383;
return "";
}});
...
try{var o__38743__auto___39385 = t;
(o__38743__auto___39385["cljs$lang$ctorPrWriter"]).call(o__38743__auto___39385,t,writer);
}catch (e39384){var __39386 = e39384;
}
...
var char_code = (function (){var o__38743__auto__ = (new String(char$));
return (o__38743__auto__["charCodeAt"]).call(o__38743__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38743__auto__ = String;
return (o__38743__auto__["fromCharCode"]).call(o__38743__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39387 = num_code;
switch (G__39387) {
case (1):
return (185);
...
var o__38743__auto__ = String;
return (o__38743__auto__["fromCharCode"]).call(o__38743__auto__,superscript_code);
});
/**
...
}catch (e39389){var _e__38750__auto__ = e39389;
return false;
}})())){
...
var vec__39390 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39390,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39393 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39393["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39394 = temp__5718__auto____$1;
return (o39394["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39401 = arguments.length;
var i__4731__auto___39402 = (0);
while(true){
if((i__4731__auto___39402 < len__4730__auto___39401)){
args__4736__auto__.push((arguments[i__4731__auto___39402]));

var G__39403 = (i__4731__auto___39402 + (1));
i__4731__auto___39402 = G__39403;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39397){
var vec__39398 = p__39397;
var ns_detector = cljs.core.nth.call(null,vec__39398,(0),null);
...
var G__39404 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39405 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39404;
remaining_tokens = G__39405;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39395){
var G__39396 = cljs.core.first.call(null,seq39395);
var seq39395__$1 = cljs.core.next.call(null,seq39395);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39396,seq39395__$1);
});
...
var vec__39409 = cljs.core.split_with.call(null,(function (p1__39408_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39408_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39409,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39409,(1),null);
...
var vec__39415 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39415,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39415,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39418 = cljs.core.rest.call(null,remaining_tokens);
var G__39419 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39418;
name_tokens = G__39419;
continue;
} else {
...
var vec__39422 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39422,(0),null);
var arity = cljs.core.nth.call(null,vec__39422,(1),null);
var vec__39425 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39425,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39425,(1),null);
var vec__39428 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39428,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39428,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39428,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39428,(3),null);
...
var vec__39434 = result;
var munged_ns = cljs.core.nth.call(null,vec__39434,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39434,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39434,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39434,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39434,(4),null);
var arity = cljs.core.nth.call(null,vec__39434,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39438 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39438,(0),null);
var args = cljs.core.nth.call(null,vec__39438,(1),null);
var vec__39441 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__39444 = (arity + (1));
var G__39445 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39446){
var vec__39447 = p__39446;
var arity = cljs.core.nth.call(null,vec__39447,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39447,(1),null);
...
return cljs.core.get.call(null,arities,p1__39450_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39451_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39454){
var vec__39455 = p__39454;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39455,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39452){
var G__39453 = cljs.core.first.call(null,seq39452);
var seq39452__$1 = cljs.core.next.call(null,seq39452);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39453,seq39452__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39463__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39463__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39463__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39463__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39464 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39464,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39464,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39464,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39464,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39464,(4),null);
var arity = cljs.core.nth.call(null,vec__39464,(5),null);
...
var o__38743__auto__ = f;
return (o__38743__auto__["getBasis"]).call(o__38743__auto__);
});
/**
...
}catch (e39468){var _e__38750__auto__ = e39468;
...
var G__39469 = (obj[cljs.core.first.call(null,path)]);
var G__39470 = cljs.core.rest.call(null,path);
obj = G__39469;
path = G__39470;
continue;
} else {
...
return (function (accum,p__39471){
var vec__39472 = p__39471;
var bit = cljs.core.nth.call(null,vec__39472,(0),null);
var protocol = cljs.core.nth.call(null,vec__39472,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39475){
var vec__39476 = p__39475;
var ns = cljs.core.nth.call(null,vec__39476,(0),null);
var name = cljs.core.nth.call(null,vec__39476,(1),null);
var selector = cljs.core.nth.call(null,vec__39476,(2),null);
...
var matches__$1 = cljs.core.nth.call(null,vec__39481,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39481,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39479_SHARP_){
return (obj[cljs.core.first.call(null,p1__39479_SHARP_)]);
});})(name,sorted_matches,vec__39481,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610051535709
