...
var o39511 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39511["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39512 = temp__5718__auto____$1;
return (o39512["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38873__auto__ = f;
return (o__38873__auto__["toString"]).call(o__38873__auto__);
} else {
return "";
}
}catch (e39513){var _ = e39513;
return "";
}});
...
try{var o__38873__auto___39515 = t;
(o__38873__auto___39515["cljs$lang$ctorPrWriter"]).call(o__38873__auto___39515,t,writer);
}catch (e39514){var __39516 = e39514;
}
...
var char_code = (function (){var o__38873__auto__ = (new String(char$));
return (o__38873__auto__["charCodeAt"]).call(o__38873__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38873__auto__ = String;
return (o__38873__auto__["fromCharCode"]).call(o__38873__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39517 = num_code;
switch (G__39517) {
case (1):
return (185);
...
var o__38873__auto__ = String;
return (o__38873__auto__["fromCharCode"]).call(o__38873__auto__,superscript_code);
});
/**
...
}catch (e39519){var _e__38880__auto__ = e39519;
return false;
}})())){
...
var vec__39520 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39520,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39523 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39523["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39524 = temp__5718__auto____$1;
return (o39524["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39527){
var vec__39528 = p__39527;
var ns_detector = cljs.core.nth.call(null,vec__39528,(0),null);
...
var G__39534 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39535 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39534;
remaining_tokens = G__39535;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39525){
var G__39526 = cljs.core.first.call(null,seq39525);
var seq39525__$1 = cljs.core.next.call(null,seq39525);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39526,seq39525__$1);
});
...
var vec__39539 = cljs.core.split_with.call(null,(function (p1__39538_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39538_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39539,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39539,(1),null);
...
var vec__39545 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39545,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39545,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39548 = cljs.core.rest.call(null,remaining_tokens);
var G__39549 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39548;
name_tokens = G__39549;
continue;
} else {
...
var vec__39552 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39552,(0),null);
var arity = cljs.core.nth.call(null,vec__39552,(1),null);
var vec__39555 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39555,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39555,(1),null);
var vec__39558 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39558,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39558,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39558,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39558,(3),null);
...
var vec__39564 = result;
var munged_ns = cljs.core.nth.call(null,vec__39564,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39564,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39564,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39564,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39564,(4),null);
var arity = cljs.core.nth.call(null,vec__39564,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39568 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39568,(0),null);
var args = cljs.core.nth.call(null,vec__39568,(1),null);
var vec__39571 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39571,(0),null);
var name = cljs.core.nth.call(null,vec__39571,(1),null);
...
var G__39574 = (arity + (1));
var G__39575 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39576){
var vec__39577 = p__39576;
var arity = cljs.core.nth.call(null,vec__39577,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39577,(1),null);
...
return cljs.core.get.call(null,arities,p1__39580_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39581_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39584){
var vec__39585 = p__39584;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39585,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39582){
var G__39583 = cljs.core.first.call(null,seq39582);
var seq39582__$1 = cljs.core.next.call(null,seq39582);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39583,seq39582__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39593__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39593__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39593__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39593__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39594 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39594,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39594,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39594,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39594,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39594,(4),null);
...
var o__38873__auto__ = f;
return (o__38873__auto__["getBasis"]).call(o__38873__auto__);
});
/**
...
}catch (e39598){var _e__38880__auto__ = e39598;
...
var G__39599 = (obj[cljs.core.first.call(null,path)]);
var G__39600 = cljs.core.rest.call(null,path);
obj = G__39599;
path = G__39600;
continue;
} else {
...
return (function (accum,p__39601){
var vec__39602 = p__39601;
var bit = cljs.core.nth.call(null,vec__39602,(0),null);
var protocol = cljs.core.nth.call(null,vec__39602,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39605){
var vec__39606 = p__39605;
var ns = cljs.core.nth.call(null,vec__39606,(0),null);
var name = cljs.core.nth.call(null,vec__39606,(1),null);
var selector = cljs.core.nth.call(null,vec__39606,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39611,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39611,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39611,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39609_SHARP_){
return (obj[cljs.core.first.call(null,p1__39609_SHARP_)]);
});})(name,sorted_matches,vec__39611,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610134124887
