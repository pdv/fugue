...
var o19794 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19794["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19795 = temp__5718__auto____$1;
return (o19795["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19156__auto__ = f;
return (o__19156__auto__["toString"]).call(o__19156__auto__);
} else {
return "";
}
}catch (e19796){var _ = e19796;
return "";
}});
...
try{var o__19156__auto___19798 = t;
(o__19156__auto___19798["cljs$lang$ctorPrWriter"]).call(o__19156__auto___19798,t,writer);
}catch (e19797){var __19799 = e19797;
}
...
var char_code = (function (){var o__19156__auto__ = (new String(char$));
return (o__19156__auto__["charCodeAt"]).call(o__19156__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19156__auto__ = String;
return (o__19156__auto__["fromCharCode"]).call(o__19156__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19800 = num_code;
switch (G__19800) {
case (1):
return (185);
...
var o__19156__auto__ = String;
return (o__19156__auto__["fromCharCode"]).call(o__19156__auto__,superscript_code);
});
/**
...
}catch (e19802){var _e__19163__auto__ = e19802;
return false;
}})())){
...
var vec__19803 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19803,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o19806 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19806["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19807 = temp__5718__auto____$1;
return (o19807["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19810){
var vec__19811 = p__19810;
var ns_detector = cljs.core.nth.call(null,vec__19811,(0),null);
...
var G__19817 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19818 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19817;
remaining_tokens = G__19818;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19808){
var G__19809 = cljs.core.first.call(null,seq19808);
var seq19808__$1 = cljs.core.next.call(null,seq19808);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19809,seq19808__$1);
});
...
var vec__19822 = cljs.core.split_with.call(null,(function (p1__19821_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19821_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19822,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19822,(1),null);
...
var vec__19828 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19828,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19828,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19831 = cljs.core.rest.call(null,remaining_tokens);
var G__19832 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19831;
name_tokens = G__19832;
continue;
} else {
...
var vec__19835 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19835,(0),null);
var arity = cljs.core.nth.call(null,vec__19835,(1),null);
var vec__19838 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19838,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19838,(1),null);
var vec__19841 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19841,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19841,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19841,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19841,(3),null);
...
var vec__19847 = result;
var munged_ns = cljs.core.nth.call(null,vec__19847,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19847,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19847,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19847,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19847,(4),null);
var arity = cljs.core.nth.call(null,vec__19847,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__19851 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__19851,(0),null);
var args = cljs.core.nth.call(null,vec__19851,(1),null);
var vec__19854 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19854,(0),null);
var name = cljs.core.nth.call(null,vec__19854,(1),null);
...
var G__19857 = (arity + (1));
var G__19858 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19859){
var vec__19860 = p__19859;
var arity = cljs.core.nth.call(null,vec__19860,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19860,(1),null);
...
return cljs.core.get.call(null,arities,p1__19863_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19864_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___19871 = arguments.length;
var i__4731__auto___19872 = (0);
while(true){
if((i__4731__auto___19872 < len__4730__auto___19871)){
args__4736__auto__.push((arguments[i__4731__auto___19872]));

var G__19873 = (i__4731__auto___19872 + (1));
i__4731__auto___19872 = G__19873;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19867){
var vec__19868 = p__19867;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19868,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19865){
var G__19866 = cljs.core.first.call(null,seq19865);
var seq19865__$1 = cljs.core.next.call(null,seq19865);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19866,seq19865__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19876__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19876__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19876__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19876__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19877 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19877,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19877,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19877,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19877,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19877,(4),null);
var arity = cljs.core.nth.call(null,vec__19877,(5),null);
...
var o__19156__auto__ = f;
return (o__19156__auto__["getBasis"]).call(o__19156__auto__);
});
/**
...
}catch (e19881){var _e__19163__auto__ = e19881;
...
var G__19882 = (obj[cljs.core.first.call(null,path)]);
var G__19883 = cljs.core.rest.call(null,path);
obj = G__19882;
path = G__19883;
continue;
} else {
...
return (function (accum,p__19884){
var vec__19885 = p__19884;
var bit = cljs.core.nth.call(null,vec__19885,(0),null);
var protocol = cljs.core.nth.call(null,vec__19885,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19888){
var vec__19889 = p__19888;
var ns = cljs.core.nth.call(null,vec__19889,(0),null);
var name = cljs.core.nth.call(null,vec__19889,(1),null);
var selector = cljs.core.nth.call(null,vec__19889,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19894,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19894,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19894,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19892_SHARP_){
return (obj[cljs.core.first.call(null,p1__19892_SHARP_)]);
});})(name,sorted_matches,vec__19894,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1611084585842
