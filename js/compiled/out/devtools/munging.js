...
var o19753 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19753["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19754 = temp__5718__auto____$1;
return (o19754["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19115__auto__ = f;
return (o__19115__auto__["toString"]).call(o__19115__auto__);
} else {
return "";
}
}catch (e19755){var _ = e19755;
return "";
}});
...
try{var o__19115__auto___19757 = t;
(o__19115__auto___19757["cljs$lang$ctorPrWriter"]).call(o__19115__auto___19757,t,writer);
}catch (e19756){var __19758 = e19756;
}
...
var char_code = (function (){var o__19115__auto__ = (new String(char$));
return (o__19115__auto__["charCodeAt"]).call(o__19115__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19115__auto__ = String;
return (o__19115__auto__["fromCharCode"]).call(o__19115__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19759 = num_code;
switch (G__19759) {
case (1):
return (185);
...
var o__19115__auto__ = String;
return (o__19115__auto__["fromCharCode"]).call(o__19115__auto__,superscript_code);
});
/**
...
}catch (e19761){var _e__19122__auto__ = e19761;
return false;
}})())){
...
var vec__19762 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19762,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o19765 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19765["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19766 = temp__5718__auto____$1;
return (o19766["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19769){
var vec__19770 = p__19769;
var ns_detector = cljs.core.nth.call(null,vec__19770,(0),null);
...
var G__19776 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19777 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19776;
remaining_tokens = G__19777;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19767){
var G__19768 = cljs.core.first.call(null,seq19767);
var seq19767__$1 = cljs.core.next.call(null,seq19767);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19768,seq19767__$1);
});
...
var vec__19781 = cljs.core.split_with.call(null,(function (p1__19780_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19780_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19781,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19781,(1),null);
...
var vec__19787 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19787,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19787,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19790 = cljs.core.rest.call(null,remaining_tokens);
var G__19791 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19790;
name_tokens = G__19791;
continue;
} else {
...
var vec__19794 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19794,(0),null);
var arity = cljs.core.nth.call(null,vec__19794,(1),null);
var vec__19797 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19797,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19797,(1),null);
var vec__19800 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19800,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19800,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19800,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19800,(3),null);
...
var vec__19806 = result;
var munged_ns = cljs.core.nth.call(null,vec__19806,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19806,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19806,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19806,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19806,(4),null);
var arity = cljs.core.nth.call(null,vec__19806,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__19810 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__19810,(0),null);
var args = cljs.core.nth.call(null,vec__19810,(1),null);
var vec__19813 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19813,(0),null);
var name = cljs.core.nth.call(null,vec__19813,(1),null);
...
var G__19816 = (arity + (1));
var G__19817 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19818){
var vec__19819 = p__19818;
var arity = cljs.core.nth.call(null,vec__19819,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19819,(1),null);
...
return cljs.core.get.call(null,arities,p1__19822_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19823_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19826){
var vec__19827 = p__19826;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19827,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19824){
var G__19825 = cljs.core.first.call(null,seq19824);
var seq19824__$1 = cljs.core.next.call(null,seq19824);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19825,seq19824__$1);
});
...
var map__19835 = options;
var map__19835__$1 = (((((!((map__19835 == null))))?(((((map__19835.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19835.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19835):map__19835);
var include_ns_QMARK_ = cljs.core.get.call(null,map__19835__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19835__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19835__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19835__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19836 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19836,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19836,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19836,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19836,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19836,(4),null);
var arity = cljs.core.nth.call(null,vec__19836,(5),null);
...
var o__19115__auto__ = f;
return (o__19115__auto__["getBasis"]).call(o__19115__auto__);
});
/**
...
}catch (e19840){var _e__19122__auto__ = e19840;
...
var G__19841 = (obj[cljs.core.first.call(null,path)]);
var G__19842 = cljs.core.rest.call(null,path);
obj = G__19841;
path = G__19842;
continue;
} else {
...
return (function (accum,p__19843){
var vec__19844 = p__19843;
var bit = cljs.core.nth.call(null,vec__19844,(0),null);
var protocol = cljs.core.nth.call(null,vec__19844,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19847){
var vec__19848 = p__19847;
var ns = cljs.core.nth.call(null,vec__19848,(0),null);
var name = cljs.core.nth.call(null,vec__19848,(1),null);
var selector = cljs.core.nth.call(null,vec__19848,(2),null);
...
return (function (p__19852){
var vec__19853 = p__19852;
var munged_name = cljs.core.nth.call(null,vec__19853,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19853,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19853,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19851_SHARP_){
return (obj[cljs.core.first.call(null,p1__19851_SHARP_)]);
});})(name,sorted_matches,vec__19853,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610745459748
