...
var o39459 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39459["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39460 = temp__5718__auto____$1;
return (o39460["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38821__auto__ = f;
return (o__38821__auto__["toString"]).call(o__38821__auto__);
} else {
return "";
}
}catch (e39461){var _ = e39461;
return "";
}});
...
try{var o__38821__auto___39463 = t;
(o__38821__auto___39463["cljs$lang$ctorPrWriter"]).call(o__38821__auto___39463,t,writer);
}catch (e39462){var __39464 = e39462;
}
...
var char_code = (function (){var o__38821__auto__ = (new String(char$));
return (o__38821__auto__["charCodeAt"]).call(o__38821__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38821__auto__ = String;
return (o__38821__auto__["fromCharCode"]).call(o__38821__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39465 = num_code;
switch (G__39465) {
case (1):
return (185);
...
var o__38821__auto__ = String;
return (o__38821__auto__["fromCharCode"]).call(o__38821__auto__,superscript_code);
});
/**
...
}catch (e39467){var _e__38828__auto__ = e39467;
return false;
}})())){
...
var vec__39468 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39468,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39471 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39471["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39472 = temp__5718__auto____$1;
return (o39472["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39479 = arguments.length;
var i__4731__auto___39480 = (0);
while(true){
if((i__4731__auto___39480 < len__4730__auto___39479)){
args__4736__auto__.push((arguments[i__4731__auto___39480]));

var G__39481 = (i__4731__auto___39480 + (1));
i__4731__auto___39480 = G__39481;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39475){
var vec__39476 = p__39475;
var ns_detector = cljs.core.nth.call(null,vec__39476,(0),null);
...
var G__39482 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39483 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39482;
remaining_tokens = G__39483;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39473){
var G__39474 = cljs.core.first.call(null,seq39473);
var seq39473__$1 = cljs.core.next.call(null,seq39473);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39474,seq39473__$1);
});
...
var vec__39487 = cljs.core.split_with.call(null,(function (p1__39486_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39486_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39487,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39487,(1),null);
...
var vec__39493 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39493,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39493,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39496 = cljs.core.rest.call(null,remaining_tokens);
var G__39497 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39496;
name_tokens = G__39497;
continue;
} else {
...
var vec__39500 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39500,(0),null);
var arity = cljs.core.nth.call(null,vec__39500,(1),null);
var vec__39503 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39503,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39503,(1),null);
var vec__39506 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39506,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39506,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39506,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39506,(3),null);
...
var vec__39512 = result;
var munged_ns = cljs.core.nth.call(null,vec__39512,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39512,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39512,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39512,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39512,(4),null);
var arity = cljs.core.nth.call(null,vec__39512,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39516 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39516,(0),null);
var args = cljs.core.nth.call(null,vec__39516,(1),null);
var vec__39519 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39519,(0),null);
var name = cljs.core.nth.call(null,vec__39519,(1),null);
...
var G__39522 = (arity + (1));
var G__39523 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39524){
var vec__39525 = p__39524;
var arity = cljs.core.nth.call(null,vec__39525,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39525,(1),null);
...
return cljs.core.get.call(null,arities,p1__39528_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__39529_SHARP_){
return cljs.core.drop.call(null,(2),p1__39529_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39536 = arguments.length;
var i__4731__auto___39537 = (0);
while(true){
if((i__4731__auto___39537 < len__4730__auto___39536)){
args__4736__auto__.push((arguments[i__4731__auto___39537]));

var G__39538 = (i__4731__auto___39537 + (1));
i__4731__auto___39537 = G__39538;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39532){
var vec__39533 = p__39532;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39533,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39530){
var G__39531 = cljs.core.first.call(null,seq39530);
var seq39530__$1 = cljs.core.next.call(null,seq39530);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39531,seq39530__$1);
});
...
var G__39539 = arg;
var G__39539__$1 = (((G__39539 instanceof cljs.core.Keyword))?G__39539.fqn:null);
switch (G__39539__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39541__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39541__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39541__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39541__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39542 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39542,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39542,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39542,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39542,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39542,(4),null);
var arity = cljs.core.nth.call(null,vec__39542,(5),null);
...
var o__38821__auto__ = f;
return (o__38821__auto__["getBasis"]).call(o__38821__auto__);
});
/**
...
}catch (e39546){var _e__38828__auto__ = e39546;
...
var G__39547 = (obj[cljs.core.first.call(null,path)]);
var G__39548 = cljs.core.rest.call(null,path);
obj = G__39547;
path = G__39548;
continue;
} else {
...
return (function (accum,p__39549){
var vec__39550 = p__39549;
var bit = cljs.core.nth.call(null,vec__39550,(0),null);
var protocol = cljs.core.nth.call(null,vec__39550,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39553){
var vec__39554 = p__39553;
var ns = cljs.core.nth.call(null,vec__39554,(0),null);
var name = cljs.core.nth.call(null,vec__39554,(1),null);
var selector = cljs.core.nth.call(null,vec__39554,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39559,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39559,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39559,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39557_SHARP_){
return (obj[cljs.core.first.call(null,p1__39557_SHARP_)]);
});})(name,sorted_matches,vec__39559,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610066038725
