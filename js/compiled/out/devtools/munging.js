...
var o19774 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19774["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19775 = temp__5718__auto____$1;
return (o19775["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19136__auto__ = f;
return (o__19136__auto__["toString"]).call(o__19136__auto__);
} else {
return "";
}
}catch (e19776){var _ = e19776;
return "";
}});
...
try{var o__19136__auto___19778 = t;
(o__19136__auto___19778["cljs$lang$ctorPrWriter"]).call(o__19136__auto___19778,t,writer);
}catch (e19777){var __19779 = e19777;
}
...
var char_code = (function (){var o__19136__auto__ = (new String(char$));
return (o__19136__auto__["charCodeAt"]).call(o__19136__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19136__auto__ = String;
return (o__19136__auto__["fromCharCode"]).call(o__19136__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19780 = num_code;
switch (G__19780) {
case (1):
return (185);
...
var o__19136__auto__ = String;
return (o__19136__auto__["fromCharCode"]).call(o__19136__auto__,superscript_code);
});
/**
...
}catch (e19782){var _e__19143__auto__ = e19782;
return false;
}})())){
...
var vec__19783 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19783,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o19786 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19786["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19787 = temp__5718__auto____$1;
return (o19787["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19790){
var vec__19791 = p__19790;
var ns_detector = cljs.core.nth.call(null,vec__19791,(0),null);
...
var G__19797 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19798 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19797;
remaining_tokens = G__19798;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19788){
var G__19789 = cljs.core.first.call(null,seq19788);
var seq19788__$1 = cljs.core.next.call(null,seq19788);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19789,seq19788__$1);
});
...
var vec__19802 = cljs.core.split_with.call(null,(function (p1__19801_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19801_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19802,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19802,(1),null);
...
var vec__19808 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19808,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19808,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19811 = cljs.core.rest.call(null,remaining_tokens);
var G__19812 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19811;
name_tokens = G__19812;
continue;
} else {
...
var vec__19815 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19815,(0),null);
var arity = cljs.core.nth.call(null,vec__19815,(1),null);
var vec__19818 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19818,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19818,(1),null);
var vec__19821 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19821,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19821,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19821,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19821,(3),null);
...
var vec__19827 = result;
var munged_ns = cljs.core.nth.call(null,vec__19827,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19827,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19827,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19827,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19827,(4),null);
var arity = cljs.core.nth.call(null,vec__19827,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__19831 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__19831,(0),null);
var args = cljs.core.nth.call(null,vec__19831,(1),null);
var vec__19834 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19834,(0),null);
var name = cljs.core.nth.call(null,vec__19834,(1),null);
...
var G__19837 = (arity + (1));
var G__19838 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19839){
var vec__19840 = p__19839;
var arity = cljs.core.nth.call(null,vec__19840,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19840,(1),null);
...
return cljs.core.get.call(null,arities,p1__19843_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19844_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___19851 = arguments.length;
var i__4731__auto___19852 = (0);
while(true){
if((i__4731__auto___19852 < len__4730__auto___19851)){
args__4736__auto__.push((arguments[i__4731__auto___19852]));

var G__19853 = (i__4731__auto___19852 + (1));
i__4731__auto___19852 = G__19853;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19847){
var vec__19848 = p__19847;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19848,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19845){
var G__19846 = cljs.core.first.call(null,seq19845);
var seq19845__$1 = cljs.core.next.call(null,seq19845);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19846,seq19845__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19856__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19856__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19856__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19856__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19857 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19857,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19857,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19857,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19857,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19857,(4),null);
var arity = cljs.core.nth.call(null,vec__19857,(5),null);
...
var o__19136__auto__ = f;
return (o__19136__auto__["getBasis"]).call(o__19136__auto__);
});
/**
...
}catch (e19861){var _e__19143__auto__ = e19861;
...
var G__19862 = (obj[cljs.core.first.call(null,path)]);
var G__19863 = cljs.core.rest.call(null,path);
obj = G__19862;
path = G__19863;
continue;
} else {
...
return (function (accum,p__19864){
var vec__19865 = p__19864;
var bit = cljs.core.nth.call(null,vec__19865,(0),null);
var protocol = cljs.core.nth.call(null,vec__19865,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19868){
var vec__19869 = p__19868;
var ns = cljs.core.nth.call(null,vec__19869,(0),null);
var name = cljs.core.nth.call(null,vec__19869,(1),null);
var selector = cljs.core.nth.call(null,vec__19869,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19874,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19874,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19874,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19872_SHARP_){
return (obj[cljs.core.first.call(null,p1__19872_SHARP_)]);
});})(name,sorted_matches,vec__19874,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1611069725461
