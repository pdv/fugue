...
var o39447 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39447["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39448 = temp__5718__auto____$1;
return (o39448["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38809__auto__ = f;
return (o__38809__auto__["toString"]).call(o__38809__auto__);
} else {
return "";
}
}catch (e39449){var _ = e39449;
return "";
}});
...
try{var o__38809__auto___39451 = t;
(o__38809__auto___39451["cljs$lang$ctorPrWriter"]).call(o__38809__auto___39451,t,writer);
}catch (e39450){var __39452 = e39450;
}
...
var char_code = (function (){var o__38809__auto__ = (new String(char$));
return (o__38809__auto__["charCodeAt"]).call(o__38809__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38809__auto__ = String;
return (o__38809__auto__["fromCharCode"]).call(o__38809__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39453 = num_code;
switch (G__39453) {
case (1):
return (185);
...
var o__38809__auto__ = String;
return (o__38809__auto__["fromCharCode"]).call(o__38809__auto__,superscript_code);
});
/**
...
}catch (e39455){var _e__38816__auto__ = e39455;
return false;
}})())){
...
var vec__39456 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39456,(0),null);
...
var temp__5718__auto____$1 = (o39459["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39460 = temp__5718__auto____$1;
return (o39460["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39467 = arguments.length;
var i__4731__auto___39468 = (0);
while(true){
if((i__4731__auto___39468 < len__4730__auto___39467)){
args__4736__auto__.push((arguments[i__4731__auto___39468]));

var G__39469 = (i__4731__auto___39468 + (1));
i__4731__auto___39468 = G__39469;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39463){
var vec__39464 = p__39463;
var ns_detector = cljs.core.nth.call(null,vec__39464,(0),null);
...
var G__39470 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39471 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39470;
remaining_tokens = G__39471;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39461){
var G__39462 = cljs.core.first.call(null,seq39461);
var seq39461__$1 = cljs.core.next.call(null,seq39461);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39462,seq39461__$1);
});
...
var vec__39475 = cljs.core.split_with.call(null,(function (p1__39474_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39474_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39475,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39475,(1),null);
...
var vec__39481 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39481,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39481,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39484 = cljs.core.rest.call(null,remaining_tokens);
var G__39485 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39484;
name_tokens = G__39485;
continue;
} else {
...
var vec__39488 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39488,(0),null);
var arity = cljs.core.nth.call(null,vec__39488,(1),null);
var vec__39491 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39491,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39491,(1),null);
var vec__39494 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39494,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39494,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39494,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39494,(3),null);
...
var vec__39500 = result;
var munged_ns = cljs.core.nth.call(null,vec__39500,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39500,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39500,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39500,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39500,(4),null);
var arity = cljs.core.nth.call(null,vec__39500,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39504 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39504,(0),null);
var args = cljs.core.nth.call(null,vec__39504,(1),null);
var vec__39507 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39507,(0),null);
var name = cljs.core.nth.call(null,vec__39507,(1),null);
...
var G__39510 = (arity + (1));
var G__39511 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39512){
var vec__39513 = p__39512;
var arity = cljs.core.nth.call(null,vec__39513,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39513,(1),null);
...
return cljs.core.get.call(null,arities,p1__39516_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39517_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39524 = arguments.length;
var i__4731__auto___39525 = (0);
while(true){
if((i__4731__auto___39525 < len__4730__auto___39524)){
args__4736__auto__.push((arguments[i__4731__auto___39525]));

var G__39526 = (i__4731__auto___39525 + (1));
i__4731__auto___39525 = G__39526;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39520){
var vec__39521 = p__39520;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39521,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39518){
var G__39519 = cljs.core.first.call(null,seq39518);
var seq39518__$1 = cljs.core.next.call(null,seq39518);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39519,seq39518__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39529__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39529__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39529__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39529__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39530 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39530,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39530,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39530,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39530,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39530,(4),null);
var arity = cljs.core.nth.call(null,vec__39530,(5),null);
...
var o__38809__auto__ = f;
return (o__38809__auto__["getBasis"]).call(o__38809__auto__);
});
/**
...
}catch (e39534){var _e__38816__auto__ = e39534;
...
var G__39535 = (obj[cljs.core.first.call(null,path)]);
var G__39536 = cljs.core.rest.call(null,path);
obj = G__39535;
path = G__39536;
continue;
} else {
...
return (function (accum,p__39537){
var vec__39538 = p__39537;
var bit = cljs.core.nth.call(null,vec__39538,(0),null);
var protocol = cljs.core.nth.call(null,vec__39538,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39541){
var vec__39542 = p__39541;
var ns = cljs.core.nth.call(null,vec__39542,(0),null);
var name = cljs.core.nth.call(null,vec__39542,(1),null);
var selector = cljs.core.nth.call(null,vec__39542,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39547,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39547,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39547,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39545_SHARP_){
return (obj[cljs.core.first.call(null,p1__39545_SHARP_)]);
});})(name,sorted_matches,vec__39547,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610058844315
