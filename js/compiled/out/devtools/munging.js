...
var o39583 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39583["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39584 = temp__5718__auto____$1;
return (o39584["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38945__auto__ = f;
return (o__38945__auto__["toString"]).call(o__38945__auto__);
} else {
return "";
}
}catch (e39585){var _ = e39585;
return "";
}});
...
try{var o__38945__auto___39587 = t;
(o__38945__auto___39587["cljs$lang$ctorPrWriter"]).call(o__38945__auto___39587,t,writer);
...
var char_code = (function (){var o__38945__auto__ = (new String(char$));
return (o__38945__auto__["charCodeAt"]).call(o__38945__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38945__auto__ = String;
return (o__38945__auto__["fromCharCode"]).call(o__38945__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39589 = num_code;
switch (G__39589) {
case (1):
return (185);
...
var o__38945__auto__ = String;
return (o__38945__auto__["fromCharCode"]).call(o__38945__auto__,superscript_code);
});
/**
...
}catch (e39591){var _e__38952__auto__ = e39591;
return false;
}})())){
...
var vec__39592 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39592,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39595 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39595["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39596 = temp__5718__auto____$1;
return (o39596["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39599){
var vec__39600 = p__39599;
var ns_detector = cljs.core.nth.call(null,vec__39600,(0),null);
...
var G__39606 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39607 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39606;
remaining_tokens = G__39607;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39597){
...
var vec__39611 = cljs.core.split_with.call(null,(function (p1__39610_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39610_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39611,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39611,(1),null);
...
var vec__39617 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39617,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39617,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39620 = cljs.core.rest.call(null,remaining_tokens);
var G__39621 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39620;
name_tokens = G__39621;
continue;
} else {
...
var vec__39624 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39624,(0),null);
var arity = cljs.core.nth.call(null,vec__39624,(1),null);
var vec__39627 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39627,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39627,(1),null);
var vec__39630 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39630,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39630,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39630,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39630,(3),null);
...
var vec__39636 = result;
var munged_ns = cljs.core.nth.call(null,vec__39636,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39636,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39636,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39636,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39636,(4),null);
var arity = cljs.core.nth.call(null,vec__39636,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39640 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39640,(0),null);
var args = cljs.core.nth.call(null,vec__39640,(1),null);
var vec__39643 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39643,(0),null);
var name = cljs.core.nth.call(null,vec__39643,(1),null);
...
var G__39646 = (arity + (1));
var G__39647 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39648){
var vec__39649 = p__39648;
var arity = cljs.core.nth.call(null,vec__39649,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39649,(1),null);
...
return cljs.core.get.call(null,arities,p1__39652_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39653_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39660 = arguments.length;
var i__4731__auto___39661 = (0);
while(true){
if((i__4731__auto___39661 < len__4730__auto___39660)){
args__4736__auto__.push((arguments[i__4731__auto___39661]));

var G__39662 = (i__4731__auto___39661 + (1));
i__4731__auto___39661 = G__39662;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39656){
var vec__39657 = p__39656;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39657,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39654){
var G__39655 = cljs.core.first.call(null,seq39654);
var seq39654__$1 = cljs.core.next.call(null,seq39654);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39655,seq39654__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39665__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39665__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39665__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39665__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39666 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39666,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39666,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39666,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39666,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39666,(4),null);
var arity = cljs.core.nth.call(null,vec__39666,(5),null);
...
var o__38945__auto__ = f;
return (o__38945__auto__["getBasis"]).call(o__38945__auto__);
});
/**
...
}catch (e39670){var _e__38952__auto__ = e39670;
...
var G__39671 = (obj[cljs.core.first.call(null,path)]);
var G__39672 = cljs.core.rest.call(null,path);
obj = G__39671;
path = G__39672;
continue;
} else {
...
return (function (accum,p__39673){
var vec__39674 = p__39673;
var bit = cljs.core.nth.call(null,vec__39674,(0),null);
var protocol = cljs.core.nth.call(null,vec__39674,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39677){
var vec__39678 = p__39677;
var ns = cljs.core.nth.call(null,vec__39678,(0),null);
var name = cljs.core.nth.call(null,vec__39678,(1),null);
var selector = cljs.core.nth.call(null,vec__39678,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39683,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39683,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39683,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39681_SHARP_){
return (obj[cljs.core.first.call(null,p1__39681_SHARP_)]);
});})(name,sorted_matches,vec__39683,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610319301699
