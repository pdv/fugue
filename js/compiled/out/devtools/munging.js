...
var o39382 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39382["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39383 = temp__5718__auto____$1;
return (o39383["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38744__auto__ = f;
return (o__38744__auto__["toString"]).call(o__38744__auto__);
} else {
return "";
}
}catch (e39384){var _ = e39384;
return "";
}});
...
try{var o__38744__auto___39386 = t;
(o__38744__auto___39386["cljs$lang$ctorPrWriter"]).call(o__38744__auto___39386,t,writer);
}catch (e39385){var __39387 = e39385;
}
...
var char_code = (function (){var o__38744__auto__ = (new String(char$));
return (o__38744__auto__["charCodeAt"]).call(o__38744__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38744__auto__ = String;
return (o__38744__auto__["fromCharCode"]).call(o__38744__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39388 = num_code;
switch (G__39388) {
case (1):
return (185);
...
var o__38744__auto__ = String;
return (o__38744__auto__["fromCharCode"]).call(o__38744__auto__,superscript_code);
});
/**
...
}catch (e39390){var _e__38751__auto__ = e39390;
return false;
}})())){
...
var vec__39391 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39391,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39394 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39394["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39395 = temp__5718__auto____$1;
return (o39395["nameToPath"]);
} else {
return null;
}
} else {
...
var G__39404 = (i__4731__auto___39403 + (1));
i__4731__auto___39403 = G__39404;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39398){
var vec__39399 = p__39398;
var ns_detector = cljs.core.nth.call(null,vec__39399,(0),null);
...
var G__39405 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39406 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39405;
remaining_tokens = G__39406;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39396){
var G__39397 = cljs.core.first.call(null,seq39396);
var seq39396__$1 = cljs.core.next.call(null,seq39396);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39397,seq39396__$1);
});
...
var vec__39410 = cljs.core.split_with.call(null,(function (p1__39409_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39409_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39410,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39410,(1),null);
...
var vec__39416 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39416,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39416,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39419 = cljs.core.rest.call(null,remaining_tokens);
var G__39420 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39419;
name_tokens = G__39420;
continue;
} else {
...
var vec__39423 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39423,(0),null);
var arity = cljs.core.nth.call(null,vec__39423,(1),null);
var vec__39426 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39426,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39426,(1),null);
var vec__39429 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39429,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39429,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39429,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39429,(3),null);
...
var vec__39435 = result;
var munged_ns = cljs.core.nth.call(null,vec__39435,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39435,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39435,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39435,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39435,(4),null);
var arity = cljs.core.nth.call(null,vec__39435,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39439 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39439,(0),null);
var args = cljs.core.nth.call(null,vec__39439,(1),null);
var vec__39442 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39442,(0),null);
var name = cljs.core.nth.call(null,vec__39442,(1),null);
...
var G__39445 = (arity + (1));
var G__39446 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39447){
var vec__39448 = p__39447;
var arity = cljs.core.nth.call(null,vec__39448,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39448,(1),null);
...
return cljs.core.get.call(null,arities,p1__39451_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39452_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39455){
var vec__39456 = p__39455;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39456,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39453){
var G__39454 = cljs.core.first.call(null,seq39453);
var seq39453__$1 = cljs.core.next.call(null,seq39453);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39454,seq39453__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39464__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39464__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39464__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39464__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39465 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39465,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39465,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39465,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39465,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39465,(4),null);
var arity = cljs.core.nth.call(null,vec__39465,(5),null);
...
var o__38744__auto__ = f;
return (o__38744__auto__["getBasis"]).call(o__38744__auto__);
});
/**
...
}catch (e39469){var _e__38751__auto__ = e39469;
...
var G__39470 = (obj[cljs.core.first.call(null,path)]);
var G__39471 = cljs.core.rest.call(null,path);
obj = G__39470;
path = G__39471;
continue;
} else {
...
return (function (accum,p__39472){
var vec__39473 = p__39472;
var bit = cljs.core.nth.call(null,vec__39473,(0),null);
var protocol = cljs.core.nth.call(null,vec__39473,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39476){
var vec__39477 = p__39476;
var ns = cljs.core.nth.call(null,vec__39477,(0),null);
var name = cljs.core.nth.call(null,vec__39477,(1),null);
var selector = cljs.core.nth.call(null,vec__39477,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39482,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39482,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39482,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39480_SHARP_){
return (obj[cljs.core.first.call(null,p1__39480_SHARP_)]);
});})(name,sorted_matches,vec__39482,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610051752639
