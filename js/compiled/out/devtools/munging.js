...
var o39234 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39234["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39235 = temp__5718__auto____$1;
return (o39235["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38596__auto__ = f;
return (o__38596__auto__["toString"]).call(o__38596__auto__);
} else {
return "";
}
}catch (e39236){var _ = e39236;
return "";
}});
...
try{var o__38596__auto___39238 = t;
(o__38596__auto___39238["cljs$lang$ctorPrWriter"]).call(o__38596__auto___39238,t,writer);
}catch (e39237){var __39239 = e39237;
}
...
var char_code = (function (){var o__38596__auto__ = (new String(char$));
return (o__38596__auto__["charCodeAt"]).call(o__38596__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38596__auto__ = String;
return (o__38596__auto__["fromCharCode"]).call(o__38596__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39240 = num_code;
switch (G__39240) {
case (1):
return (185);
...
var o__38596__auto__ = String;
return (o__38596__auto__["fromCharCode"]).call(o__38596__auto__,superscript_code);
});
/**
...
}catch (e39242){var _e__38603__auto__ = e39242;
return false;
}})())){
...
var vec__39243 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39243,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39246 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39246["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39247 = temp__5718__auto____$1;
return (o39247["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39254 = arguments.length;
var i__4731__auto___39255 = (0);
while(true){
if((i__4731__auto___39255 < len__4730__auto___39254)){
args__4736__auto__.push((arguments[i__4731__auto___39255]));

var G__39256 = (i__4731__auto___39255 + (1));
i__4731__auto___39255 = G__39256;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39250){
var vec__39251 = p__39250;
var ns_detector = cljs.core.nth.call(null,vec__39251,(0),null);
...
var G__39257 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39258 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39257;
remaining_tokens = G__39258;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39248){
var G__39249 = cljs.core.first.call(null,seq39248);
var seq39248__$1 = cljs.core.next.call(null,seq39248);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39249,seq39248__$1);
});
...
var vec__39262 = cljs.core.split_with.call(null,(function (p1__39261_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39261_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39262,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39262,(1),null);
...
var vec__39268 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39268,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39268,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39271 = cljs.core.rest.call(null,remaining_tokens);
var G__39272 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39271;
name_tokens = G__39272;
continue;
} else {
...
var vec__39275 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39275,(0),null);
var arity = cljs.core.nth.call(null,vec__39275,(1),null);
var vec__39278 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39278,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39278,(1),null);
var vec__39281 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39281,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39281,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39281,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39281,(3),null);
...
var vec__39287 = result;
var munged_ns = cljs.core.nth.call(null,vec__39287,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39287,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39287,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39287,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39287,(4),null);
var arity = cljs.core.nth.call(null,vec__39287,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39291 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39291,(0),null);
var args = cljs.core.nth.call(null,vec__39291,(1),null);
var vec__39294 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39294,(0),null);
var name = cljs.core.nth.call(null,vec__39294,(1),null);
...
var G__39297 = (arity + (1));
var G__39298 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39299){
var vec__39300 = p__39299;
var arity = cljs.core.nth.call(null,vec__39300,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39300,(1),null);
...
return cljs.core.get.call(null,arities,p1__39303_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39304_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39311 = arguments.length;
var i__4731__auto___39312 = (0);
while(true){
if((i__4731__auto___39312 < len__4730__auto___39311)){
args__4736__auto__.push((arguments[i__4731__auto___39312]));

var G__39313 = (i__4731__auto___39312 + (1));
i__4731__auto___39312 = G__39313;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39307){
var vec__39308 = p__39307;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39308,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39305){
var G__39306 = cljs.core.first.call(null,seq39305);
var seq39305__$1 = cljs.core.next.call(null,seq39305);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39306,seq39305__$1);
});
...
var map__39316 = options;
var map__39316__$1 = (((((!((map__39316 == null))))?(((((map__39316.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39316.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39316):map__39316);
var include_ns_QMARK_ = cljs.core.get.call(null,map__39316__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39316__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39316__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39316__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39317 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39317,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39317,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39317,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39317,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39317,(4),null);
var arity = cljs.core.nth.call(null,vec__39317,(5),null);
...
var o__38596__auto__ = f;
return (o__38596__auto__["getBasis"]).call(o__38596__auto__);
});
/**
...
}catch (e39321){var _e__38603__auto__ = e39321;
...
var G__39322 = (obj[cljs.core.first.call(null,path)]);
var G__39323 = cljs.core.rest.call(null,path);
obj = G__39322;
path = G__39323;
continue;
} else {
...
return (function (accum,p__39324){
var vec__39325 = p__39324;
var bit = cljs.core.nth.call(null,vec__39325,(0),null);
var protocol = cljs.core.nth.call(null,vec__39325,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39328){
var vec__39329 = p__39328;
var ns = cljs.core.nth.call(null,vec__39329,(0),null);
var name = cljs.core.nth.call(null,vec__39329,(1),null);
var selector = cljs.core.nth.call(null,vec__39329,(2),null);
...
return (function (p__39333){
var vec__39334 = p__39333;
var munged_name = cljs.core.nth.call(null,vec__39334,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39334,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39334,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39332_SHARP_){
return (obj[cljs.core.first.call(null,p1__39332_SHARP_)]);
});})(name,sorted_matches,vec__39334,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1601399211582
