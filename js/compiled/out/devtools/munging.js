...
var o39576 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39576["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39577 = temp__5718__auto____$1;
return (o39577["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38938__auto__ = f;
return (o__38938__auto__["toString"]).call(o__38938__auto__);
} else {
return "";
}
}catch (e39578){var _ = e39578;
return "";
}});
...
try{var o__38938__auto___39580 = t;
(o__38938__auto___39580["cljs$lang$ctorPrWriter"]).call(o__38938__auto___39580,t,writer);
}catch (e39579){var __39581 = e39579;
}
...
var char_code = (function (){var o__38938__auto__ = (new String(char$));
return (o__38938__auto__["charCodeAt"]).call(o__38938__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38938__auto__ = String;
return (o__38938__auto__["fromCharCode"]).call(o__38938__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39582 = num_code;
switch (G__39582) {
case (1):
return (185);
...
var o__38938__auto__ = String;
return (o__38938__auto__["fromCharCode"]).call(o__38938__auto__,superscript_code);
});
/**
...
}catch (e39584){var _e__38945__auto__ = e39584;
return false;
}})())){
...
var vec__39585 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39585,(0),null);
...
var temp__5718__auto____$1 = (o39588["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39589 = temp__5718__auto____$1;
return (o39589["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39592){
var vec__39593 = p__39592;
var ns_detector = cljs.core.nth.call(null,vec__39593,(0),null);
...
var G__39599 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39600 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39599;
remaining_tokens = G__39600;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39590){
var G__39591 = cljs.core.first.call(null,seq39590);
var seq39590__$1 = cljs.core.next.call(null,seq39590);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39591,seq39590__$1);
});
...
var vec__39604 = cljs.core.split_with.call(null,(function (p1__39603_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39603_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39604,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39604,(1),null);
...
var vec__39610 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39610,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39610,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39613 = cljs.core.rest.call(null,remaining_tokens);
var G__39614 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39613;
name_tokens = G__39614;
continue;
} else {
...
var vec__39617 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39617,(0),null);
var arity = cljs.core.nth.call(null,vec__39617,(1),null);
var vec__39620 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39620,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39620,(1),null);
var vec__39623 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39623,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39623,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39623,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39623,(3),null);
...
var vec__39629 = result;
var munged_ns = cljs.core.nth.call(null,vec__39629,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39629,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39629,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39629,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39629,(4),null);
var arity = cljs.core.nth.call(null,vec__39629,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39633 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39633,(0),null);
var args = cljs.core.nth.call(null,vec__39633,(1),null);
var vec__39636 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__39639 = (arity + (1));
var G__39640 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39641){
var vec__39642 = p__39641;
var arity = cljs.core.nth.call(null,vec__39642,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39642,(1),null);
...
return cljs.core.get.call(null,arities,p1__39645_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39646_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39653 = arguments.length;
var i__4731__auto___39654 = (0);
while(true){
if((i__4731__auto___39654 < len__4730__auto___39653)){
args__4736__auto__.push((arguments[i__4731__auto___39654]));

var G__39655 = (i__4731__auto___39654 + (1));
i__4731__auto___39654 = G__39655;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39649){
var vec__39650 = p__39649;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39650,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39647){
var G__39648 = cljs.core.first.call(null,seq39647);
var seq39647__$1 = cljs.core.next.call(null,seq39647);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39648,seq39647__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39658__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39658__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39658__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39658__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39659 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39659,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39659,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39659,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39659,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39659,(4),null);
var arity = cljs.core.nth.call(null,vec__39659,(5),null);
...
var o__38938__auto__ = f;
return (o__38938__auto__["getBasis"]).call(o__38938__auto__);
});
/**
...
}catch (e39663){var _e__38945__auto__ = e39663;
...
var G__39664 = (obj[cljs.core.first.call(null,path)]);
var G__39665 = cljs.core.rest.call(null,path);
obj = G__39664;
path = G__39665;
continue;
} else {
...
return (function (accum,p__39666){
var vec__39667 = p__39666;
var bit = cljs.core.nth.call(null,vec__39667,(0),null);
var protocol = cljs.core.nth.call(null,vec__39667,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39670){
var vec__39671 = p__39670;
var ns = cljs.core.nth.call(null,vec__39671,(0),null);
var name = cljs.core.nth.call(null,vec__39671,(1),null);
var selector = cljs.core.nth.call(null,vec__39671,(2),null);
...
var matches__$1 = cljs.core.nth.call(null,vec__39676,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39676,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39674_SHARP_){
return (obj[cljs.core.first.call(null,p1__39674_SHARP_)]);
});})(name,sorted_matches,vec__39676,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610330683375
