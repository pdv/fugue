...
var o19798 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19798["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19799 = temp__5718__auto____$1;
return (o19799["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19160__auto__ = f;
return (o__19160__auto__["toString"]).call(o__19160__auto__);
} else {
return "";
}
}catch (e19800){var _ = e19800;
return "";
}});
...
try{var o__19160__auto___19802 = t;
(o__19160__auto___19802["cljs$lang$ctorPrWriter"]).call(o__19160__auto___19802,t,writer);
}catch (e19801){var __19803 = e19801;
}
...
var char_code = (function (){var o__19160__auto__ = (new String(char$));
return (o__19160__auto__["charCodeAt"]).call(o__19160__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19160__auto__ = String;
return (o__19160__auto__["fromCharCode"]).call(o__19160__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19804 = num_code;
switch (G__19804) {
case (1):
return (185);
...
var o__19160__auto__ = String;
return (o__19160__auto__["fromCharCode"]).call(o__19160__auto__,superscript_code);
});
/**
...
}catch (e19806){var _e__19167__auto__ = e19806;
return false;
}})())){
...
var vec__19807 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19807,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o19810 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19810["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19811 = temp__5718__auto____$1;
return (o19811["nameToPath"]);
} else {
return null;
}
} else {
...
args__4736__auto__.push((arguments[i__4731__auto___19819]));
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19814){
var vec__19815 = p__19814;
var ns_detector = cljs.core.nth.call(null,vec__19815,(0),null);
...
var G__19821 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19822 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19821;
remaining_tokens = G__19822;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19812){
var G__19813 = cljs.core.first.call(null,seq19812);
var seq19812__$1 = cljs.core.next.call(null,seq19812);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19813,seq19812__$1);
});
...
var vec__19826 = cljs.core.split_with.call(null,(function (p1__19825_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19825_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19826,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19826,(1),null);
...
var vec__19832 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19832,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19832,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19835 = cljs.core.rest.call(null,remaining_tokens);
var G__19836 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19835;
name_tokens = G__19836;
continue;
} else {
...
var vec__19839 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19839,(0),null);
var arity = cljs.core.nth.call(null,vec__19839,(1),null);
var vec__19842 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19842,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19842,(1),null);
var vec__19845 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19845,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19845,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19845,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19845,(3),null);
...
var vec__19851 = result;
var munged_ns = cljs.core.nth.call(null,vec__19851,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19851,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19851,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19851,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19851,(4),null);
var arity = cljs.core.nth.call(null,vec__19851,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__19855 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__19855,(0),null);
var args = cljs.core.nth.call(null,vec__19855,(1),null);
var vec__19858 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19858,(0),null);
var name = cljs.core.nth.call(null,vec__19858,(1),null);
...
var G__19861 = (arity + (1));
var G__19862 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19863){
var vec__19864 = p__19863;
var arity = cljs.core.nth.call(null,vec__19864,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19864,(1),null);
...
return cljs.core.get.call(null,arities,p1__19867_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19868_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19871){
var vec__19872 = p__19871;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19872,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19869){
var G__19870 = cljs.core.first.call(null,seq19869);
var seq19869__$1 = cljs.core.next.call(null,seq19869);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19870,seq19869__$1);
});
...
var G__19878 = arg;
var G__19878__$1 = (((G__19878 instanceof cljs.core.Keyword))?G__19878.fqn:null);
switch (G__19878__$1) {
...
var map__19880 = options;
var map__19880__$1 = (((((!((map__19880 == null))))?(((((map__19880.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19880.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19880):map__19880);
var include_ns_QMARK_ = cljs.core.get.call(null,map__19880__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19880__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19880__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19880__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19881 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19881,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19881,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19881,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19881,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19881,(4),null);
var arity = cljs.core.nth.call(null,vec__19881,(5),null);
...
var o__19160__auto__ = f;
return (o__19160__auto__["getBasis"]).call(o__19160__auto__);
});
/**
...
}catch (e19885){var _e__19167__auto__ = e19885;
...
var G__19886 = (obj[cljs.core.first.call(null,path)]);
var G__19887 = cljs.core.rest.call(null,path);
obj = G__19886;
path = G__19887;
continue;
} else {
...
return (function (accum,p__19888){
var vec__19889 = p__19888;
var bit = cljs.core.nth.call(null,vec__19889,(0),null);
var protocol = cljs.core.nth.call(null,vec__19889,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19892){
var vec__19893 = p__19892;
var ns = cljs.core.nth.call(null,vec__19893,(0),null);
var name = cljs.core.nth.call(null,vec__19893,(1),null);
var selector = cljs.core.nth.call(null,vec__19893,(2),null);
...
return (function (p__19897){
var vec__19898 = p__19897;
var munged_name = cljs.core.nth.call(null,vec__19898,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19898,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19898,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19896_SHARP_){
return (obj[cljs.core.first.call(null,p1__19896_SHARP_)]);
});})(name,sorted_matches,vec__19898,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1611075311486
