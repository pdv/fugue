...
var o39515 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39515["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39516 = temp__5718__auto____$1;
return (o39516["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38877__auto__ = f;
return (o__38877__auto__["toString"]).call(o__38877__auto__);
} else {
return "";
}
}catch (e39517){var _ = e39517;
return "";
}});
...
try{var o__38877__auto___39519 = t;
(o__38877__auto___39519["cljs$lang$ctorPrWriter"]).call(o__38877__auto___39519,t,writer);
}catch (e39518){var __39520 = e39518;
}
...
var char_code = (function (){var o__38877__auto__ = (new String(char$));
return (o__38877__auto__["charCodeAt"]).call(o__38877__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38877__auto__ = String;
return (o__38877__auto__["fromCharCode"]).call(o__38877__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39521 = num_code;
switch (G__39521) {
case (1):
return (185);
...
var o__38877__auto__ = String;
return (o__38877__auto__["fromCharCode"]).call(o__38877__auto__,superscript_code);
});
/**
...
}catch (e39523){var _e__38884__auto__ = e39523;
return false;
}})())){
...
var vec__39524 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39524,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39527 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39527["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39528 = temp__5718__auto____$1;
return (o39528["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39531){
var vec__39532 = p__39531;
var ns_detector = cljs.core.nth.call(null,vec__39532,(0),null);
...
var G__39538 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39539 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39538;
remaining_tokens = G__39539;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39529){
var G__39530 = cljs.core.first.call(null,seq39529);
var seq39529__$1 = cljs.core.next.call(null,seq39529);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39530,seq39529__$1);
});
...
var vec__39543 = cljs.core.split_with.call(null,(function (p1__39542_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39542_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39543,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39543,(1),null);
...
var vec__39549 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39549,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39549,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39552 = cljs.core.rest.call(null,remaining_tokens);
var G__39553 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39552;
name_tokens = G__39553;
continue;
} else {
...
var vec__39556 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39556,(0),null);
var arity = cljs.core.nth.call(null,vec__39556,(1),null);
var vec__39559 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39559,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39559,(1),null);
var vec__39562 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39562,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39562,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39562,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39562,(3),null);
...
var vec__39568 = result;
var munged_ns = cljs.core.nth.call(null,vec__39568,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39568,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39568,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39568,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39568,(4),null);
var arity = cljs.core.nth.call(null,vec__39568,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39572 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39572,(0),null);
var args = cljs.core.nth.call(null,vec__39572,(1),null);
var vec__39575 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39575,(0),null);
var name = cljs.core.nth.call(null,vec__39575,(1),null);
...
var G__39578 = (arity + (1));
var G__39579 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39580){
var vec__39581 = p__39580;
var arity = cljs.core.nth.call(null,vec__39581,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39581,(1),null);
...
return cljs.core.get.call(null,arities,p1__39584_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39585_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39592 = arguments.length;
var i__4731__auto___39593 = (0);
while(true){
if((i__4731__auto___39593 < len__4730__auto___39592)){
args__4736__auto__.push((arguments[i__4731__auto___39593]));

var G__39594 = (i__4731__auto___39593 + (1));
i__4731__auto___39593 = G__39594;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39588){
var vec__39589 = p__39588;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39589,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39586){
var G__39587 = cljs.core.first.call(null,seq39586);
var seq39586__$1 = cljs.core.next.call(null,seq39586);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39587,seq39586__$1);
});
...
var map__39597 = options;
var map__39597__$1 = (((((!((map__39597 == null))))?(((((map__39597.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39597.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39597):map__39597);
var include_ns_QMARK_ = cljs.core.get.call(null,map__39597__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39597__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39597__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39597__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39598 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39598,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39598,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39598,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39598,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39598,(4),null);
var arity = cljs.core.nth.call(null,vec__39598,(5),null);
...
var o__38877__auto__ = f;
return (o__38877__auto__["getBasis"]).call(o__38877__auto__);
});
/**
...
}catch (e39602){var _e__38884__auto__ = e39602;
...
var G__39603 = (obj[cljs.core.first.call(null,path)]);
var G__39604 = cljs.core.rest.call(null,path);
obj = G__39603;
path = G__39604;
continue;
} else {
...
return (function (accum,p__39605){
var vec__39606 = p__39605;
var bit = cljs.core.nth.call(null,vec__39606,(0),null);
var protocol = cljs.core.nth.call(null,vec__39606,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39609){
var vec__39610 = p__39609;
var ns = cljs.core.nth.call(null,vec__39610,(0),null);
var name = cljs.core.nth.call(null,vec__39610,(1),null);
var selector = cljs.core.nth.call(null,vec__39610,(2),null);
...
return (function (p__39614){
var vec__39615 = p__39614;
var munged_name = cljs.core.nth.call(null,vec__39615,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39615,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39615,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39613_SHARP_){
return (obj[cljs.core.first.call(null,p1__39613_SHARP_)]);
});})(name,sorted_matches,vec__39615,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610145030439
