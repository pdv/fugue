...
var o39367 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39367["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39368 = temp__5718__auto____$1;
return (o39368["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38729__auto__ = f;
return (o__38729__auto__["toString"]).call(o__38729__auto__);
} else {
return "";
}
}catch (e39369){var _ = e39369;
return "";
}});
...
try{var o__38729__auto___39371 = t;
(o__38729__auto___39371["cljs$lang$ctorPrWriter"]).call(o__38729__auto___39371,t,writer);
}catch (e39370){var __39372 = e39370;
}
...
var char_code = (function (){var o__38729__auto__ = (new String(char$));
return (o__38729__auto__["charCodeAt"]).call(o__38729__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38729__auto__ = String;
return (o__38729__auto__["fromCharCode"]).call(o__38729__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39373 = num_code;
switch (G__39373) {
case (1):
return (185);
...
var o__38729__auto__ = String;
return (o__38729__auto__["fromCharCode"]).call(o__38729__auto__,superscript_code);
});
/**
...
}catch (e39375){var _e__38736__auto__ = e39375;
return false;
}})())){
...
var vec__39376 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39376,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39379 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39379["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39380 = temp__5718__auto____$1;
return (o39380["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39387 = arguments.length;
var i__4731__auto___39388 = (0);
while(true){
if((i__4731__auto___39388 < len__4730__auto___39387)){
args__4736__auto__.push((arguments[i__4731__auto___39388]));

var G__39389 = (i__4731__auto___39388 + (1));
i__4731__auto___39388 = G__39389;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39383){
var vec__39384 = p__39383;
var ns_detector = cljs.core.nth.call(null,vec__39384,(0),null);
...
var G__39390 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39391 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39390;
remaining_tokens = G__39391;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39381){
var G__39382 = cljs.core.first.call(null,seq39381);
var seq39381__$1 = cljs.core.next.call(null,seq39381);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39382,seq39381__$1);
});
...
var vec__39395 = cljs.core.split_with.call(null,(function (p1__39394_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39394_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39395,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39395,(1),null);
...
var vec__39401 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39401,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39401,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39404 = cljs.core.rest.call(null,remaining_tokens);
var G__39405 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39404;
name_tokens = G__39405;
continue;
} else {
...
var vec__39408 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39408,(0),null);
var arity = cljs.core.nth.call(null,vec__39408,(1),null);
var vec__39411 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39411,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39411,(1),null);
var vec__39414 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39414,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39414,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39414,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39414,(3),null);
...
var vec__39420 = result;
var munged_ns = cljs.core.nth.call(null,vec__39420,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39420,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39420,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39420,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39420,(4),null);
var arity = cljs.core.nth.call(null,vec__39420,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39424 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39424,(0),null);
var args = cljs.core.nth.call(null,vec__39424,(1),null);
var vec__39427 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39427,(0),null);
var name = cljs.core.nth.call(null,vec__39427,(1),null);
...
var G__39430 = (arity + (1));
var G__39431 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39432){
var vec__39433 = p__39432;
var arity = cljs.core.nth.call(null,vec__39433,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39433,(1),null);
...
return cljs.core.get.call(null,arities,p1__39436_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39437_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39440){
var vec__39441 = p__39440;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39441,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39438){
var G__39439 = cljs.core.first.call(null,seq39438);
var seq39438__$1 = cljs.core.next.call(null,seq39438);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39439,seq39438__$1);
});
...
var map__39449 = options;
var map__39449__$1 = (((((!((map__39449 == null))))?(((((map__39449.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39449.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39449):map__39449);
var include_ns_QMARK_ = cljs.core.get.call(null,map__39449__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39449__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39449__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39449__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39450 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39450,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39450,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39450,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39450,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39450,(4),null);
var arity = cljs.core.nth.call(null,vec__39450,(5),null);
...
var o__38729__auto__ = f;
return (o__38729__auto__["getBasis"]).call(o__38729__auto__);
});
/**
...
}catch (e39454){var _e__38736__auto__ = e39454;
...
var G__39455 = (obj[cljs.core.first.call(null,path)]);
var G__39456 = cljs.core.rest.call(null,path);
obj = G__39455;
path = G__39456;
continue;
} else {
...
return (function (accum,p__39457){
var vec__39458 = p__39457;
var bit = cljs.core.nth.call(null,vec__39458,(0),null);
var protocol = cljs.core.nth.call(null,vec__39458,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39461){
var vec__39462 = p__39461;
var ns = cljs.core.nth.call(null,vec__39462,(0),null);
var name = cljs.core.nth.call(null,vec__39462,(1),null);
var selector = cljs.core.nth.call(null,vec__39462,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39467,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39467,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39467,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39465_SHARP_){
return (obj[cljs.core.first.call(null,p1__39465_SHARP_)]);
});})(name,sorted_matches,vec__39467,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1608403400987
