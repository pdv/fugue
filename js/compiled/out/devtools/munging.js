...
var o19760 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19760["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19761 = temp__5718__auto____$1;
return (o19761["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19122__auto__ = f;
return (o__19122__auto__["toString"]).call(o__19122__auto__);
} else {
return "";
}
}catch (e19762){var _ = e19762;
return "";
}});
...
try{var o__19122__auto___19764 = t;
(o__19122__auto___19764["cljs$lang$ctorPrWriter"]).call(o__19122__auto___19764,t,writer);
}catch (e19763){var __19765 = e19763;
}
...
var char_code = (function (){var o__19122__auto__ = (new String(char$));
return (o__19122__auto__["charCodeAt"]).call(o__19122__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19122__auto__ = String;
return (o__19122__auto__["fromCharCode"]).call(o__19122__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19766 = num_code;
switch (G__19766) {
case (1):
return (185);
...
var o__19122__auto__ = String;
return (o__19122__auto__["fromCharCode"]).call(o__19122__auto__,superscript_code);
});
/**
...
}catch (e19768){var _e__19129__auto__ = e19768;
return false;
}})())){
...
var vec__19769 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19769,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o19772 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19772["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19773 = temp__5718__auto____$1;
return (o19773["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___19780 = arguments.length;
var i__4731__auto___19781 = (0);
while(true){
if((i__4731__auto___19781 < len__4730__auto___19780)){
args__4736__auto__.push((arguments[i__4731__auto___19781]));

var G__19782 = (i__4731__auto___19781 + (1));
i__4731__auto___19781 = G__19782;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19776){
var vec__19777 = p__19776;
var ns_detector = cljs.core.nth.call(null,vec__19777,(0),null);
...
var G__19783 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19784 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19783;
remaining_tokens = G__19784;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19774){
var G__19775 = cljs.core.first.call(null,seq19774);
var seq19774__$1 = cljs.core.next.call(null,seq19774);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19775,seq19774__$1);
});
...
var vec__19788 = cljs.core.split_with.call(null,(function (p1__19787_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19787_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19788,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19788,(1),null);
...
var vec__19794 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19794,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19794,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19797 = cljs.core.rest.call(null,remaining_tokens);
var G__19798 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19797;
name_tokens = G__19798;
continue;
} else {
...
var vec__19801 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19801,(0),null);
var arity = cljs.core.nth.call(null,vec__19801,(1),null);
var vec__19804 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19804,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19804,(1),null);
var vec__19807 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19807,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19807,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19807,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19807,(3),null);
...
var vec__19813 = result;
var munged_ns = cljs.core.nth.call(null,vec__19813,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19813,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19813,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19813,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19813,(4),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__19817 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__19817,(0),null);
var args = cljs.core.nth.call(null,vec__19817,(1),null);
var vec__19820 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19820,(0),null);
var name = cljs.core.nth.call(null,vec__19820,(1),null);
...
var G__19823 = (arity + (1));
var G__19824 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19825){
var vec__19826 = p__19825;
var arity = cljs.core.nth.call(null,vec__19826,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19826,(1),null);
...
return cljs.core.get.call(null,arities,p1__19829_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19830_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___19837 = arguments.length;
var i__4731__auto___19838 = (0);
while(true){
if((i__4731__auto___19838 < len__4730__auto___19837)){
args__4736__auto__.push((arguments[i__4731__auto___19838]));

var G__19839 = (i__4731__auto___19838 + (1));
i__4731__auto___19838 = G__19839;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19833){
var vec__19834 = p__19833;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19834,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19831){
var G__19832 = cljs.core.first.call(null,seq19831);
var seq19831__$1 = cljs.core.next.call(null,seq19831);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19832,seq19831__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19842__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19842__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19842__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19842__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19843 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19843,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19843,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19843,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19843,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19843,(4),null);
var arity = cljs.core.nth.call(null,vec__19843,(5),null);
...
var o__19122__auto__ = f;
return (o__19122__auto__["getBasis"]).call(o__19122__auto__);
});
/**
...
}catch (e19847){var _e__19129__auto__ = e19847;
...
var G__19848 = (obj[cljs.core.first.call(null,path)]);
var G__19849 = cljs.core.rest.call(null,path);
obj = G__19848;
path = G__19849;
continue;
} else {
...
return (function (accum,p__19850){
var vec__19851 = p__19850;
var bit = cljs.core.nth.call(null,vec__19851,(0),null);
var protocol = cljs.core.nth.call(null,vec__19851,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19854){
var vec__19855 = p__19854;
var ns = cljs.core.nth.call(null,vec__19855,(0),null);
var name = cljs.core.nth.call(null,vec__19855,(1),null);
var selector = cljs.core.nth.call(null,vec__19855,(2),null);
...
return (function (p__19859){
var vec__19860 = p__19859;
var munged_name = cljs.core.nth.call(null,vec__19860,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19860,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19860,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19858_SHARP_){
return (obj[cljs.core.first.call(null,p1__19858_SHARP_)]);
});})(name,sorted_matches,vec__19860,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610837656565
