...
var o39473 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39473["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39474 = temp__5718__auto____$1;
return (o39474["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38835__auto__ = f;
return (o__38835__auto__["toString"]).call(o__38835__auto__);
} else {
return "";
}
...
try{var o__38835__auto___39477 = t;
(o__38835__auto___39477["cljs$lang$ctorPrWriter"]).call(o__38835__auto___39477,t,writer);
}catch (e39476){var __39478 = e39476;
}
...
var char_code = (function (){var o__38835__auto__ = (new String(char$));
return (o__38835__auto__["charCodeAt"]).call(o__38835__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38835__auto__ = String;
return (o__38835__auto__["fromCharCode"]).call(o__38835__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39479 = num_code;
switch (G__39479) {
case (1):
return (185);
...
var o__38835__auto__ = String;
return (o__38835__auto__["fromCharCode"]).call(o__38835__auto__,superscript_code);
});
/**
...
}catch (e39481){var _e__38842__auto__ = e39481;
return false;
}})())){
...
var vec__39482 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39482,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39485 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39485["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39486 = temp__5718__auto____$1;
return (o39486["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39493 = arguments.length;
var i__4731__auto___39494 = (0);
while(true){
if((i__4731__auto___39494 < len__4730__auto___39493)){
args__4736__auto__.push((arguments[i__4731__auto___39494]));

var G__39495 = (i__4731__auto___39494 + (1));
i__4731__auto___39494 = G__39495;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39489){
var vec__39490 = p__39489;
var ns_detector = cljs.core.nth.call(null,vec__39490,(0),null);
...
var G__39496 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39497 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39496;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39487){
var G__39488 = cljs.core.first.call(null,seq39487);
var seq39487__$1 = cljs.core.next.call(null,seq39487);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39488,seq39487__$1);
});
...
var vec__39501 = cljs.core.split_with.call(null,(function (p1__39500_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39500_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39501,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39501,(1),null);
...
var vec__39507 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39507,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39507,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39510 = cljs.core.rest.call(null,remaining_tokens);
var G__39511 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39510;
name_tokens = G__39511;
continue;
} else {
...
var vec__39514 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39514,(0),null);
var arity = cljs.core.nth.call(null,vec__39514,(1),null);
var vec__39517 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39517,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39517,(1),null);
var vec__39520 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39520,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39520,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39520,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39520,(3),null);
...
var vec__39526 = result;
var munged_ns = cljs.core.nth.call(null,vec__39526,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39526,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39526,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39526,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39526,(4),null);
var arity = cljs.core.nth.call(null,vec__39526,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39530 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39530,(0),null);
var args = cljs.core.nth.call(null,vec__39530,(1),null);
var vec__39533 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39533,(0),null);
var name = cljs.core.nth.call(null,vec__39533,(1),null);
...
var G__39536 = (arity + (1));
var G__39537 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39538){
var vec__39539 = p__39538;
var arity = cljs.core.nth.call(null,vec__39539,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39539,(1),null);
...
return cljs.core.get.call(null,arities,p1__39542_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39543_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39550 = arguments.length;
var i__4731__auto___39551 = (0);
while(true){
if((i__4731__auto___39551 < len__4730__auto___39550)){
args__4736__auto__.push((arguments[i__4731__auto___39551]));

var G__39552 = (i__4731__auto___39551 + (1));
i__4731__auto___39551 = G__39552;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39546){
var vec__39547 = p__39546;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39547,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39544){
var G__39545 = cljs.core.first.call(null,seq39544);
var seq39544__$1 = cljs.core.next.call(null,seq39544);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39545,seq39544__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39555__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39555__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39555__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39555__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39556 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39556,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39556,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39556,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39556,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39556,(4),null);
var arity = cljs.core.nth.call(null,vec__39556,(5),null);
...
var o__38835__auto__ = f;
return (o__38835__auto__["getBasis"]).call(o__38835__auto__);
});
/**
...
}catch (e39560){var _e__38842__auto__ = e39560;
...
var G__39561 = (obj[cljs.core.first.call(null,path)]);
var G__39562 = cljs.core.rest.call(null,path);
obj = G__39561;
path = G__39562;
continue;
} else {
...
return (function (accum,p__39563){
var vec__39564 = p__39563;
var bit = cljs.core.nth.call(null,vec__39564,(0),null);
var protocol = cljs.core.nth.call(null,vec__39564,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39567){
var vec__39568 = p__39567;
var ns = cljs.core.nth.call(null,vec__39568,(0),null);
var name = cljs.core.nth.call(null,vec__39568,(1),null);
var selector = cljs.core.nth.call(null,vec__39568,(2),null);
...
return (function (p__39572){
var vec__39573 = p__39572;
var munged_name = cljs.core.nth.call(null,vec__39573,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39573,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39573,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39571_SHARP_){
return (obj[cljs.core.first.call(null,p1__39571_SHARP_)]);
});})(name,sorted_matches,vec__39573,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610120094230
