...
var o39548 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39548["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39549 = temp__5718__auto____$1;
return (o39549["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38910__auto__ = f;
return (o__38910__auto__["toString"]).call(o__38910__auto__);
} else {
return "";
}
}catch (e39550){var _ = e39550;
return "";
}});
...
try{var o__38910__auto___39552 = t;
(o__38910__auto___39552["cljs$lang$ctorPrWriter"]).call(o__38910__auto___39552,t,writer);
}catch (e39551){var __39553 = e39551;
}
...
var char_code = (function (){var o__38910__auto__ = (new String(char$));
return (o__38910__auto__["charCodeAt"]).call(o__38910__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38910__auto__ = String;
return (o__38910__auto__["fromCharCode"]).call(o__38910__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39554 = num_code;
switch (G__39554) {
case (1):
return (185);
...
var o__38910__auto__ = String;
return (o__38910__auto__["fromCharCode"]).call(o__38910__auto__,superscript_code);
});
/**
...
}catch (e39556){var _e__38917__auto__ = e39556;
return false;
}})())){
...
var vec__39557 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39557,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39560 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39560["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39561 = temp__5718__auto____$1;
return (o39561["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39568 = arguments.length;
var i__4731__auto___39569 = (0);
while(true){
if((i__4731__auto___39569 < len__4730__auto___39568)){
args__4736__auto__.push((arguments[i__4731__auto___39569]));

var G__39570 = (i__4731__auto___39569 + (1));
i__4731__auto___39569 = G__39570;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39564){
var vec__39565 = p__39564;
var ns_detector = cljs.core.nth.call(null,vec__39565,(0),null);
...
var G__39571 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39572 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39571;
remaining_tokens = G__39572;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39562){
var G__39563 = cljs.core.first.call(null,seq39562);
var seq39562__$1 = cljs.core.next.call(null,seq39562);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39563,seq39562__$1);
});
...
var vec__39576 = cljs.core.split_with.call(null,(function (p1__39575_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39575_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39576,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39576,(1),null);
...
var vec__39582 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39582,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39582,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39585 = cljs.core.rest.call(null,remaining_tokens);
var G__39586 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39585;
name_tokens = G__39586;
continue;
} else {
...
var vec__39589 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39589,(0),null);
var arity = cljs.core.nth.call(null,vec__39589,(1),null);
var vec__39592 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39592,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39592,(1),null);
var vec__39595 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39595,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39595,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39595,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39595,(3),null);
...
var vec__39601 = result;
var munged_ns = cljs.core.nth.call(null,vec__39601,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39601,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39601,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39601,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39601,(4),null);
var arity = cljs.core.nth.call(null,vec__39601,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39605 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39605,(0),null);
var args = cljs.core.nth.call(null,vec__39605,(1),null);
var vec__39608 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39608,(0),null);
var name = cljs.core.nth.call(null,vec__39608,(1),null);
...
var G__39611 = (arity + (1));
var G__39612 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39613){
var vec__39614 = p__39613;
var arity = cljs.core.nth.call(null,vec__39614,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39614,(1),null);
...
return cljs.core.get.call(null,arities,p1__39617_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39618_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39625 = arguments.length;
var i__4731__auto___39626 = (0);
while(true){
if((i__4731__auto___39626 < len__4730__auto___39625)){
args__4736__auto__.push((arguments[i__4731__auto___39626]));

var G__39627 = (i__4731__auto___39626 + (1));
i__4731__auto___39626 = G__39627;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39621){
var vec__39622 = p__39621;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39622,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39619){
var G__39620 = cljs.core.first.call(null,seq39619);
var seq39619__$1 = cljs.core.next.call(null,seq39619);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39620,seq39619__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39630__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39630__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39630__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39630__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39631 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39631,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39631,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39631,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39631,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39631,(4),null);
var arity = cljs.core.nth.call(null,vec__39631,(5),null);
...
var o__38910__auto__ = f;
return (o__38910__auto__["getBasis"]).call(o__38910__auto__);
});
/**
...
}catch (e39635){var _e__38917__auto__ = e39635;
...
var G__39636 = (obj[cljs.core.first.call(null,path)]);
var G__39637 = cljs.core.rest.call(null,path);
obj = G__39636;
path = G__39637;
continue;
} else {
...
return (function (accum,p__39638){
var vec__39639 = p__39638;
var bit = cljs.core.nth.call(null,vec__39639,(0),null);
var protocol = cljs.core.nth.call(null,vec__39639,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39642){
...
var selector = cljs.core.nth.call(null,vec__39643,(2),null);
...
return (function (p__39647){
var vec__39648 = p__39647;
var munged_name = cljs.core.nth.call(null,vec__39648,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39648,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39648,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39646_SHARP_){
return (obj[cljs.core.first.call(null,p1__39646_SHARP_)]);
});})(name,sorted_matches,vec__39648,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610339741475
