...
var temp__5718__auto____$1 = (o39543["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39544 = temp__5718__auto____$1;
return (o39544["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38905__auto__ = f;
return (o__38905__auto__["toString"]).call(o__38905__auto__);
} else {
return "";
}
...
try{var o__38905__auto___39547 = t;
(o__38905__auto___39547["cljs$lang$ctorPrWriter"]).call(o__38905__auto___39547,t,writer);
}catch (e39546){var __39548 = e39546;
}
...
var char_code = (function (){var o__38905__auto__ = (new String(char$));
return (o__38905__auto__["charCodeAt"]).call(o__38905__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38905__auto__ = String;
return (o__38905__auto__["fromCharCode"]).call(o__38905__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39549 = num_code;
switch (G__39549) {
case (1):
return (185);
...
var o__38905__auto__ = String;
return (o__38905__auto__["fromCharCode"]).call(o__38905__auto__,superscript_code);
});
/**
...
}catch (e39551){var _e__38912__auto__ = e39551;
return false;
}})())){
...
var vec__39552 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39552,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39555 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39555["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39556 = temp__5718__auto____$1;
return (o39556["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39559){
var vec__39560 = p__39559;
var ns_detector = cljs.core.nth.call(null,vec__39560,(0),null);
...
var G__39566 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39567 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39566;
remaining_tokens = G__39567;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39557){
var G__39558 = cljs.core.first.call(null,seq39557);
var seq39557__$1 = cljs.core.next.call(null,seq39557);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39558,seq39557__$1);
});
...
var vec__39571 = cljs.core.split_with.call(null,(function (p1__39570_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39570_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39571,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39571,(1),null);
...
var vec__39577 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39577,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39577,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39580 = cljs.core.rest.call(null,remaining_tokens);
var G__39581 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39580;
name_tokens = G__39581;
continue;
} else {
...
var vec__39584 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39584,(0),null);
var arity = cljs.core.nth.call(null,vec__39584,(1),null);
var vec__39587 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39587,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39587,(1),null);
var vec__39590 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39590,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39590,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39590,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39590,(3),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39600 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39600,(0),null);
var args = cljs.core.nth.call(null,vec__39600,(1),null);
var vec__39603 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__39606 = (arity + (1));
var G__39607 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39608){
var vec__39609 = p__39608;
var arity = cljs.core.nth.call(null,vec__39609,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39609,(1),null);
...
return cljs.core.get.call(null,arities,p1__39612_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39613_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39620 = arguments.length;
var i__4731__auto___39621 = (0);
while(true){
if((i__4731__auto___39621 < len__4730__auto___39620)){
args__4736__auto__.push((arguments[i__4731__auto___39621]));

var G__39622 = (i__4731__auto___39621 + (1));
i__4731__auto___39621 = G__39622;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39616){
var vec__39617 = p__39616;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39617,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39614){
var G__39615 = cljs.core.first.call(null,seq39614);
var seq39614__$1 = cljs.core.next.call(null,seq39614);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39615,seq39614__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39625__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39625__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39625__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39625__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39626 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39626,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39626,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39626,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39626,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39626,(4),null);
var arity = cljs.core.nth.call(null,vec__39626,(5),null);
...
var o__38905__auto__ = f;
return (o__38905__auto__["getBasis"]).call(o__38905__auto__);
});
/**
...
}catch (e39630){var _e__38912__auto__ = e39630;
...
var G__39631 = (obj[cljs.core.first.call(null,path)]);
var G__39632 = cljs.core.rest.call(null,path);
obj = G__39631;
path = G__39632;
continue;
} else {
...
return (function (accum,p__39633){
var vec__39634 = p__39633;
var bit = cljs.core.nth.call(null,vec__39634,(0),null);
var protocol = cljs.core.nth.call(null,vec__39634,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39637){
var vec__39638 = p__39637;
var ns = cljs.core.nth.call(null,vec__39638,(0),null);
var name = cljs.core.nth.call(null,vec__39638,(1),null);
var selector = cljs.core.nth.call(null,vec__39638,(2),null);
...
return (function (p__39642){
var vec__39643 = p__39642;
var munged_name = cljs.core.nth.call(null,vec__39643,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39643,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39643,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39641_SHARP_){
return (obj[cljs.core.first.call(null,p1__39641_SHARP_)]);
});})(name,sorted_matches,vec__39643,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610481575515
