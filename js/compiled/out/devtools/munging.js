...
var o39581 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39581["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39582 = temp__5718__auto____$1;
return (o39582["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38943__auto__ = f;
return (o__38943__auto__["toString"]).call(o__38943__auto__);
} else {
return "";
}
}catch (e39583){var _ = e39583;
return "";
}});
...
try{var o__38943__auto___39585 = t;
(o__38943__auto___39585["cljs$lang$ctorPrWriter"]).call(o__38943__auto___39585,t,writer);
}catch (e39584){var __39586 = e39584;
}
...
var char_code = (function (){var o__38943__auto__ = (new String(char$));
return (o__38943__auto__["charCodeAt"]).call(o__38943__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38943__auto__ = String;
return (o__38943__auto__["fromCharCode"]).call(o__38943__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39587 = num_code;
switch (G__39587) {
case (1):
return (185);
...
var o__38943__auto__ = String;
return (o__38943__auto__["fromCharCode"]).call(o__38943__auto__,superscript_code);
});
/**
...
}catch (e39589){var _e__38950__auto__ = e39589;
return false;
}})())){
...
var vec__39590 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39590,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39593 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39593["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39594 = temp__5718__auto____$1;
return (o39594["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39601 = arguments.length;
var i__4731__auto___39602 = (0);
while(true){
if((i__4731__auto___39602 < len__4730__auto___39601)){
args__4736__auto__.push((arguments[i__4731__auto___39602]));

var G__39603 = (i__4731__auto___39602 + (1));
i__4731__auto___39602 = G__39603;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39597){
var vec__39598 = p__39597;
var ns_detector = cljs.core.nth.call(null,vec__39598,(0),null);
...
var G__39604 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39605 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39604;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39595){
var G__39596 = cljs.core.first.call(null,seq39595);
var seq39595__$1 = cljs.core.next.call(null,seq39595);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39596,seq39595__$1);
});
...
var vec__39609 = cljs.core.split_with.call(null,(function (p1__39608_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39608_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39609,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39609,(1),null);
...
var vec__39615 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39615,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39615,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39618 = cljs.core.rest.call(null,remaining_tokens);
var G__39619 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39618;
name_tokens = G__39619;
continue;
} else {
...
var vec__39622 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39622,(0),null);
var arity = cljs.core.nth.call(null,vec__39622,(1),null);
var vec__39625 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39625,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39625,(1),null);
var vec__39628 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39628,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39628,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39628,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39628,(3),null);
...
var vec__39634 = result;
var munged_ns = cljs.core.nth.call(null,vec__39634,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39634,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39634,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39634,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39634,(4),null);
var arity = cljs.core.nth.call(null,vec__39634,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39638 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39638,(0),null);
var args = cljs.core.nth.call(null,vec__39638,(1),null);
var vec__39641 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39641,(0),null);
var name = cljs.core.nth.call(null,vec__39641,(1),null);
...
var G__39644 = (arity + (1));
var G__39645 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39646){
var vec__39647 = p__39646;
var arity = cljs.core.nth.call(null,vec__39647,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39647,(1),null);
...
return cljs.core.get.call(null,arities,p1__39650_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39651_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39654){
var vec__39655 = p__39654;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39655,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39652){
var G__39653 = cljs.core.first.call(null,seq39652);
var seq39652__$1 = cljs.core.next.call(null,seq39652);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39653,seq39652__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39663__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39663__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39663__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39663__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39664 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39664,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39664,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39664,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39664,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39664,(4),null);
var arity = cljs.core.nth.call(null,vec__39664,(5),null);
...
var o__38943__auto__ = f;
return (o__38943__auto__["getBasis"]).call(o__38943__auto__);
});
/**
...
}catch (e39668){var _e__38950__auto__ = e39668;
...
var G__39669 = (obj[cljs.core.first.call(null,path)]);
var G__39670 = cljs.core.rest.call(null,path);
obj = G__39669;
path = G__39670;
continue;
} else {
...
return (function (accum,p__39671){
var vec__39672 = p__39671;
var bit = cljs.core.nth.call(null,vec__39672,(0),null);
var protocol = cljs.core.nth.call(null,vec__39672,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39675){
var vec__39676 = p__39675;
var ns = cljs.core.nth.call(null,vec__39676,(0),null);
var name = cljs.core.nth.call(null,vec__39676,(1),null);
var selector = cljs.core.nth.call(null,vec__39676,(2),null);
...
return (obj[cljs.core.first.call(null,p1__39679_SHARP_)]);
...
//# sourceMappingURL=munging.js.map?rel=1610329054614
