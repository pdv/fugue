...
var o39541 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39541["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39542 = temp__5718__auto____$1;
return (o39542["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38903__auto__ = f;
return (o__38903__auto__["toString"]).call(o__38903__auto__);
} else {
return "";
}
}catch (e39543){var _ = e39543;
return "";
}});
...
try{var o__38903__auto___39545 = t;
(o__38903__auto___39545["cljs$lang$ctorPrWriter"]).call(o__38903__auto___39545,t,writer);
}catch (e39544){var __39546 = e39544;
}
...
var char_code = (function (){var o__38903__auto__ = (new String(char$));
return (o__38903__auto__["charCodeAt"]).call(o__38903__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38903__auto__ = String;
return (o__38903__auto__["fromCharCode"]).call(o__38903__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39547 = num_code;
switch (G__39547) {
case (1):
return (185);
...
var o__38903__auto__ = String;
return (o__38903__auto__["fromCharCode"]).call(o__38903__auto__,superscript_code);
});
/**
...
}catch (e39549){var _e__38910__auto__ = e39549;
return false;
}})())){
...
var vec__39550 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39550,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39553 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39553["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39554 = temp__5718__auto____$1;
return (o39554["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39557){
var vec__39558 = p__39557;
var ns_detector = cljs.core.nth.call(null,vec__39558,(0),null);
...
var G__39564 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39565 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39564;
remaining_tokens = G__39565;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39555){
...
var vec__39569 = cljs.core.split_with.call(null,(function (p1__39568_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39568_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39569,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39569,(1),null);
...
var vec__39575 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39575,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39575,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39578 = cljs.core.rest.call(null,remaining_tokens);
var G__39579 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39578;
name_tokens = G__39579;
continue;
} else {
...
var vec__39582 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39582,(0),null);
var arity = cljs.core.nth.call(null,vec__39582,(1),null);
var vec__39585 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39585,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39585,(1),null);
var vec__39588 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39588,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39588,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39588,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39588,(3),null);
...
var vec__39594 = result;
var munged_ns = cljs.core.nth.call(null,vec__39594,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39594,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39594,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39594,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39594,(4),null);
var arity = cljs.core.nth.call(null,vec__39594,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39598 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39598,(0),null);
var args = cljs.core.nth.call(null,vec__39598,(1),null);
var vec__39601 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39601,(0),null);
var name = cljs.core.nth.call(null,vec__39601,(1),null);
...
var G__39604 = (arity + (1));
var G__39605 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39606){
var vec__39607 = p__39606;
var arity = cljs.core.nth.call(null,vec__39607,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39607,(1),null);
...
return cljs.core.get.call(null,arities,p1__39610_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39611_SHARP_);
...
var i__4731__auto___39619 = (0);
while(true){
if((i__4731__auto___39619 < len__4730__auto___39618)){
args__4736__auto__.push((arguments[i__4731__auto___39619]));

var G__39620 = (i__4731__auto___39619 + (1));
i__4731__auto___39619 = G__39620;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39614){
var vec__39615 = p__39614;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39615,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39612){
var G__39613 = cljs.core.first.call(null,seq39612);
var seq39612__$1 = cljs.core.next.call(null,seq39612);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39613,seq39612__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39623__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39623__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39623__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39623__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39624 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39624,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39624,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39624,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39624,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39624,(4),null);
var arity = cljs.core.nth.call(null,vec__39624,(5),null);
...
var o__38903__auto__ = f;
return (o__38903__auto__["getBasis"]).call(o__38903__auto__);
});
/**
...
}catch (e39628){var _e__38910__auto__ = e39628;
...
var G__39629 = (obj[cljs.core.first.call(null,path)]);
var G__39630 = cljs.core.rest.call(null,path);
obj = G__39629;
path = G__39630;
continue;
} else {
...
return (function (accum,p__39631){
var vec__39632 = p__39631;
var bit = cljs.core.nth.call(null,vec__39632,(0),null);
var protocol = cljs.core.nth.call(null,vec__39632,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39635){
var vec__39636 = p__39635;
var ns = cljs.core.nth.call(null,vec__39636,(0),null);
var name = cljs.core.nth.call(null,vec__39636,(1),null);
var selector = cljs.core.nth.call(null,vec__39636,(2),null);
...
return (function (p__39640){
var vec__39641 = p__39640;
var munged_name = cljs.core.nth.call(null,vec__39641,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39641,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39641,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39639_SHARP_){
return (obj[cljs.core.first.call(null,p1__39639_SHARP_)]);
});})(name,sorted_matches,vec__39641,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610422551555
