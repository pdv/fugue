...
var o39602 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39602["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39603 = temp__5718__auto____$1;
return (o39603["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38964__auto__ = f;
return (o__38964__auto__["toString"]).call(o__38964__auto__);
} else {
return "";
}
}catch (e39604){var _ = e39604;
return "";
}});
...
try{var o__38964__auto___39606 = t;
(o__38964__auto___39606["cljs$lang$ctorPrWriter"]).call(o__38964__auto___39606,t,writer);
}catch (e39605){var __39607 = e39605;
}
...
var char_code = (function (){var o__38964__auto__ = (new String(char$));
return (o__38964__auto__["charCodeAt"]).call(o__38964__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38964__auto__ = String;
return (o__38964__auto__["fromCharCode"]).call(o__38964__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39608 = num_code;
switch (G__39608) {
case (1):
return (185);
...
var o__38964__auto__ = String;
return (o__38964__auto__["fromCharCode"]).call(o__38964__auto__,superscript_code);
});
/**
...
}catch (e39610){var _e__38971__auto__ = e39610;
return false;
}})())){
...
var vec__39611 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39611,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39614 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39614["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39615 = temp__5718__auto____$1;
return (o39615["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39622 = arguments.length;
var i__4731__auto___39623 = (0);
while(true){
if((i__4731__auto___39623 < len__4730__auto___39622)){
args__4736__auto__.push((arguments[i__4731__auto___39623]));

var G__39624 = (i__4731__auto___39623 + (1));
i__4731__auto___39623 = G__39624;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39618){
var vec__39619 = p__39618;
var ns_detector = cljs.core.nth.call(null,vec__39619,(0),null);
...
var G__39625 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39626 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39625;
remaining_tokens = G__39626;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39616){
var G__39617 = cljs.core.first.call(null,seq39616);
var seq39616__$1 = cljs.core.next.call(null,seq39616);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39617,seq39616__$1);
});
...
var vec__39630 = cljs.core.split_with.call(null,(function (p1__39629_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39629_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39630,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39630,(1),null);
...
var vec__39636 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39636,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39636,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39639 = cljs.core.rest.call(null,remaining_tokens);
var G__39640 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39639;
name_tokens = G__39640;
continue;
} else {
...
var vec__39643 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39643,(0),null);
var arity = cljs.core.nth.call(null,vec__39643,(1),null);
var vec__39646 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39646,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39646,(1),null);
var vec__39649 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39649,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39649,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39649,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39649,(3),null);
...
var vec__39655 = result;
var munged_ns = cljs.core.nth.call(null,vec__39655,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39655,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39655,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39655,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39655,(4),null);
var arity = cljs.core.nth.call(null,vec__39655,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39659 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39659,(0),null);
var args = cljs.core.nth.call(null,vec__39659,(1),null);
var vec__39662 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39662,(0),null);
var name = cljs.core.nth.call(null,vec__39662,(1),null);
...
var G__39665 = (arity + (1));
var G__39666 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39667){
var vec__39668 = p__39667;
var arity = cljs.core.nth.call(null,vec__39668,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39668,(1),null);
...
return cljs.core.get.call(null,arities,p1__39671_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__39672_SHARP_){
return cljs.core.drop.call(null,(2),p1__39672_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39675){
var vec__39676 = p__39675;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39676,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39673){
var G__39674 = cljs.core.first.call(null,seq39673);
var seq39673__$1 = cljs.core.next.call(null,seq39673);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39674,seq39673__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39684__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39684__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39684__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39684__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39685 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39685,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39685,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39685,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39685,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39685,(4),null);
var arity = cljs.core.nth.call(null,vec__39685,(5),null);
...
var o__38964__auto__ = f;
return (o__38964__auto__["getBasis"]).call(o__38964__auto__);
});
/**
...
}catch (e39689){var _e__38971__auto__ = e39689;
...
var G__39690 = (obj[cljs.core.first.call(null,path)]);
var G__39691 = cljs.core.rest.call(null,path);
obj = G__39690;
path = G__39691;
continue;
} else {
...
return (function (accum,p__39692){
var vec__39693 = p__39692;
var bit = cljs.core.nth.call(null,vec__39693,(0),null);
var protocol = cljs.core.nth.call(null,vec__39693,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39696){
var vec__39697 = p__39696;
var ns = cljs.core.nth.call(null,vec__39697,(0),null);
var name = cljs.core.nth.call(null,vec__39697,(1),null);
var selector = cljs.core.nth.call(null,vec__39697,(2),null);
...
return (function (p__39701){
var vec__39702 = p__39701;
var munged_name = cljs.core.nth.call(null,vec__39702,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39702,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39702,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39700_SHARP_){
return (obj[cljs.core.first.call(null,p1__39700_SHARP_)]);
});})(name,sorted_matches,vec__39702,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610309318557
