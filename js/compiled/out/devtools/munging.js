...
var o39478 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39478["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39479 = temp__5718__auto____$1;
return (o39479["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38840__auto__ = f;
return (o__38840__auto__["toString"]).call(o__38840__auto__);
} else {
return "";
}
}catch (e39480){var _ = e39480;
return "";
}});
...
try{var o__38840__auto___39482 = t;
(o__38840__auto___39482["cljs$lang$ctorPrWriter"]).call(o__38840__auto___39482,t,writer);
}catch (e39481){var __39483 = e39481;
}
...
var char_code = (function (){var o__38840__auto__ = (new String(char$));
return (o__38840__auto__["charCodeAt"]).call(o__38840__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38840__auto__ = String;
return (o__38840__auto__["fromCharCode"]).call(o__38840__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39484 = num_code;
switch (G__39484) {
case (1):
return (185);
...
var o__38840__auto__ = String;
return (o__38840__auto__["fromCharCode"]).call(o__38840__auto__,superscript_code);
});
/**
...
}catch (e39486){var _e__38847__auto__ = e39486;
return false;
}})())){
...
var vec__39487 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39487,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39490 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39490["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39491 = temp__5718__auto____$1;
return (o39491["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39498 = arguments.length;
var i__4731__auto___39499 = (0);
while(true){
if((i__4731__auto___39499 < len__4730__auto___39498)){
args__4736__auto__.push((arguments[i__4731__auto___39499]));

var G__39500 = (i__4731__auto___39499 + (1));
i__4731__auto___39499 = G__39500;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39494){
var vec__39495 = p__39494;
var ns_detector = cljs.core.nth.call(null,vec__39495,(0),null);
...
var G__39501 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39502 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39501;
remaining_tokens = G__39502;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39492){
var G__39493 = cljs.core.first.call(null,seq39492);
var seq39492__$1 = cljs.core.next.call(null,seq39492);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39493,seq39492__$1);
});
...
var vec__39506 = cljs.core.split_with.call(null,(function (p1__39505_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39505_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39506,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39506,(1),null);
...
var vec__39512 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39512,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39512,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39515 = cljs.core.rest.call(null,remaining_tokens);
var G__39516 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39515;
name_tokens = G__39516;
continue;
} else {
...
var vec__39519 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39519,(0),null);
var arity = cljs.core.nth.call(null,vec__39519,(1),null);
var vec__39522 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39522,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39522,(1),null);
var vec__39525 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39525,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39525,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39525,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39525,(3),null);
...
var vec__39531 = result;
var munged_ns = cljs.core.nth.call(null,vec__39531,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39531,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39531,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39531,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39531,(4),null);
var arity = cljs.core.nth.call(null,vec__39531,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39535 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39535,(0),null);
var args = cljs.core.nth.call(null,vec__39535,(1),null);
var vec__39538 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39538,(0),null);
var name = cljs.core.nth.call(null,vec__39538,(1),null);
...
var G__39541 = (arity + (1));
var G__39542 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39543){
var vec__39544 = p__39543;
var arity = cljs.core.nth.call(null,vec__39544,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39544,(1),null);
...
return cljs.core.get.call(null,arities,p1__39547_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39548_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39551){
var vec__39552 = p__39551;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39552,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39549){
var G__39550 = cljs.core.first.call(null,seq39549);
var seq39549__$1 = cljs.core.next.call(null,seq39549);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39550,seq39549__$1);
});
...
var G__39558 = arg;
var G__39558__$1 = (((G__39558 instanceof cljs.core.Keyword))?G__39558.fqn:null);
switch (G__39558__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39560__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39560__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39560__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39560__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39561 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39561,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39561,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39561,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39561,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39561,(4),null);
var arity = cljs.core.nth.call(null,vec__39561,(5),null);
...
var o__38840__auto__ = f;
return (o__38840__auto__["getBasis"]).call(o__38840__auto__);
});
/**
...
}catch (e39565){var _e__38847__auto__ = e39565;
...
var G__39566 = (obj[cljs.core.first.call(null,path)]);
var G__39567 = cljs.core.rest.call(null,path);
obj = G__39566;
path = G__39567;
continue;
} else {
...
return (function (accum,p__39568){
var vec__39569 = p__39568;
var bit = cljs.core.nth.call(null,vec__39569,(0),null);
var protocol = cljs.core.nth.call(null,vec__39569,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39572){
var vec__39573 = p__39572;
var ns = cljs.core.nth.call(null,vec__39573,(0),null);
var name = cljs.core.nth.call(null,vec__39573,(1),null);
var selector = cljs.core.nth.call(null,vec__39573,(2),null);
...
return (function (p__39577){
var vec__39578 = p__39577;
var munged_name = cljs.core.nth.call(null,vec__39578,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39578,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39578,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39576_SHARP_){
return (obj[cljs.core.first.call(null,p1__39576_SHARP_)]);
});})(name,sorted_matches,vec__39578,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610123909127
