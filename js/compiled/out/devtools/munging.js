...
var o39529 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39529["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39530 = temp__5718__auto____$1;
return (o39530["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38891__auto__ = f;
return (o__38891__auto__["toString"]).call(o__38891__auto__);
} else {
return "";
}
}catch (e39531){var _ = e39531;
return "";
}});
...
try{var o__38891__auto___39533 = t;
(o__38891__auto___39533["cljs$lang$ctorPrWriter"]).call(o__38891__auto___39533,t,writer);
}catch (e39532){var __39534 = e39532;
}
...
var char_code = (function (){var o__38891__auto__ = (new String(char$));
return (o__38891__auto__["charCodeAt"]).call(o__38891__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38891__auto__ = String;
return (o__38891__auto__["fromCharCode"]).call(o__38891__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39535 = num_code;
switch (G__39535) {
case (1):
return (185);
...
var o__38891__auto__ = String;
return (o__38891__auto__["fromCharCode"]).call(o__38891__auto__,superscript_code);
});
/**
...
}catch (e39537){var _e__38898__auto__ = e39537;
return false;
}})())){
...
var vec__39538 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39538,(0),null);
...
var temp__5718__auto____$1 = (o39541["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39542 = temp__5718__auto____$1;
return (o39542["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39545){
var vec__39546 = p__39545;
var ns_detector = cljs.core.nth.call(null,vec__39546,(0),null);
...
var G__39552 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39553 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39552;
remaining_tokens = G__39553;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39543){
var G__39544 = cljs.core.first.call(null,seq39543);
var seq39543__$1 = cljs.core.next.call(null,seq39543);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39544,seq39543__$1);
});
...
var vec__39557 = cljs.core.split_with.call(null,(function (p1__39556_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39556_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39557,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39557,(1),null);
...
var vec__39563 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39563,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39563,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39566 = cljs.core.rest.call(null,remaining_tokens);
var G__39567 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39566;
name_tokens = G__39567;
continue;
} else {
...
var vec__39570 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39570,(0),null);
var arity = cljs.core.nth.call(null,vec__39570,(1),null);
var vec__39573 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39573,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39573,(1),null);
var vec__39576 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39576,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39576,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39576,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39576,(3),null);
...
var vec__39582 = result;
var munged_ns = cljs.core.nth.call(null,vec__39582,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39582,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39582,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39582,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39582,(4),null);
var arity = cljs.core.nth.call(null,vec__39582,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39586 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39586,(0),null);
var args = cljs.core.nth.call(null,vec__39586,(1),null);
var vec__39589 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39589,(0),null);
var name = cljs.core.nth.call(null,vec__39589,(1),null);
...
var G__39592 = (arity + (1));
var G__39593 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39594){
var vec__39595 = p__39594;
var arity = cljs.core.nth.call(null,vec__39595,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39595,(1),null);
...
return (function (p1__39598_SHARP_){
return cljs.core.get.call(null,arities,p1__39598_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39599_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39602){
var vec__39603 = p__39602;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39603,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39600){
var G__39601 = cljs.core.first.call(null,seq39600);
var seq39600__$1 = cljs.core.next.call(null,seq39600);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39601,seq39600__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39611__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39611__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39611__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39611__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39612 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39612,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39612,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39612,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39612,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39612,(4),null);
var arity = cljs.core.nth.call(null,vec__39612,(5),null);
...
var o__38891__auto__ = f;
return (o__38891__auto__["getBasis"]).call(o__38891__auto__);
});
/**
...
}catch (e39616){var _e__38898__auto__ = e39616;
...
var G__39617 = (obj[cljs.core.first.call(null,path)]);
var G__39618 = cljs.core.rest.call(null,path);
obj = G__39617;
path = G__39618;
continue;
} else {
...
return (function (accum,p__39619){
var vec__39620 = p__39619;
var bit = cljs.core.nth.call(null,vec__39620,(0),null);
var protocol = cljs.core.nth.call(null,vec__39620,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39623){
var vec__39624 = p__39623;
var ns = cljs.core.nth.call(null,vec__39624,(0),null);
var name = cljs.core.nth.call(null,vec__39624,(1),null);
var selector = cljs.core.nth.call(null,vec__39624,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__39629,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39629,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39629,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39627_SHARP_){
return (obj[cljs.core.first.call(null,p1__39627_SHARP_)]);
});})(name,sorted_matches,vec__39629,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610221084451
