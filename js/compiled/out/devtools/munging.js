...
var o39094 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39094["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39095 = temp__5718__auto____$1;
return (o39095["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38456__auto__ = f;
return (o__38456__auto__["toString"]).call(o__38456__auto__);
} else {
return "";
}
}catch (e39096){var _ = e39096;
return "";
}});
...
try{var o__38456__auto___39098 = t;
(o__38456__auto___39098["cljs$lang$ctorPrWriter"]).call(o__38456__auto___39098,t,writer);
}catch (e39097){var __39099 = e39097;
}
...
var char_code = (function (){var o__38456__auto__ = (new String(char$));
return (o__38456__auto__["charCodeAt"]).call(o__38456__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38456__auto__ = String;
return (o__38456__auto__["fromCharCode"]).call(o__38456__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39100 = num_code;
switch (G__39100) {
case (1):
return (185);
...
var o__38456__auto__ = String;
return (o__38456__auto__["fromCharCode"]).call(o__38456__auto__,superscript_code);
});
/**
...
}catch (e39102){var _e__38463__auto__ = e39102;
return false;
}})())){
...
var vec__39103 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39103,(0),null);
...
var temp__5718__auto____$1 = (o39106["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39107 = temp__5718__auto____$1;
return (o39107["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39114 = arguments.length;
var i__4731__auto___39115 = (0);
while(true){
if((i__4731__auto___39115 < len__4730__auto___39114)){
args__4736__auto__.push((arguments[i__4731__auto___39115]));

var G__39116 = (i__4731__auto___39115 + (1));
i__4731__auto___39115 = G__39116;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39110){
var vec__39111 = p__39110;
var ns_detector = cljs.core.nth.call(null,vec__39111,(0),null);
...
var G__39117 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39118 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39117;
remaining_tokens = G__39118;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39108){
...
var vec__39122 = cljs.core.split_with.call(null,(function (p1__39121_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39121_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39122,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39122,(1),null);
...
var vec__39128 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39128,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39128,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39131 = cljs.core.rest.call(null,remaining_tokens);
var G__39132 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39131;
name_tokens = G__39132;
continue;
} else {
...
var vec__39135 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39135,(0),null);
var arity = cljs.core.nth.call(null,vec__39135,(1),null);
var vec__39138 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39138,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39138,(1),null);
var vec__39141 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39141,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39141,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39141,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39141,(3),null);
...
var vec__39147 = result;
var munged_ns = cljs.core.nth.call(null,vec__39147,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39147,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39147,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39147,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39147,(4),null);
var arity = cljs.core.nth.call(null,vec__39147,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39151 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39151,(0),null);
var args = cljs.core.nth.call(null,vec__39151,(1),null);
var vec__39154 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39154,(0),null);
var name = cljs.core.nth.call(null,vec__39154,(1),null);
...
var G__39157 = (arity + (1));
var G__39158 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39159){
var vec__39160 = p__39159;
var arity = cljs.core.nth.call(null,vec__39160,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39160,(1),null);
...
return cljs.core.get.call(null,arities,p1__39163_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__39164_SHARP_){
return cljs.core.drop.call(null,(2),p1__39164_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39167){
var vec__39168 = p__39167;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39168,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39165){
var G__39166 = cljs.core.first.call(null,seq39165);
var seq39165__$1 = cljs.core.next.call(null,seq39165);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39166,seq39165__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39176__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39176__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39176__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39176__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39177 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39177,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39177,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39177,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39177,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39177,(4),null);
var arity = cljs.core.nth.call(null,vec__39177,(5),null);
...
var o__38456__auto__ = f;
return (o__38456__auto__["getBasis"]).call(o__38456__auto__);
});
/**
...
}catch (e39181){var _e__38463__auto__ = e39181;
...
var G__39182 = (obj[cljs.core.first.call(null,path)]);
var G__39183 = cljs.core.rest.call(null,path);
obj = G__39182;
path = G__39183;
continue;
} else {
...
return (function (accum,p__39184){
var vec__39185 = p__39184;
var bit = cljs.core.nth.call(null,vec__39185,(0),null);
var protocol = cljs.core.nth.call(null,vec__39185,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39188){
var vec__39189 = p__39188;
var ns = cljs.core.nth.call(null,vec__39189,(0),null);
var name = cljs.core.nth.call(null,vec__39189,(1),null);
var selector = cljs.core.nth.call(null,vec__39189,(2),null);
...
return (function (p__39193){
var vec__39194 = p__39193;
var munged_name = cljs.core.nth.call(null,vec__39194,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39194,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39194,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39192_SHARP_){
return (obj[cljs.core.first.call(null,p1__39192_SHARP_)]);
});})(name,sorted_matches,vec__39194,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1601341175146
