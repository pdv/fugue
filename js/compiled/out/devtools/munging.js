...
var o39453 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39453["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39454 = temp__5718__auto____$1;
return (o39454["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38815__auto__ = f;
return (o__38815__auto__["toString"]).call(o__38815__auto__);
} else {
return "";
}
}catch (e39455){var _ = e39455;
return "";
}});
...
try{var o__38815__auto___39457 = t;
(o__38815__auto___39457["cljs$lang$ctorPrWriter"]).call(o__38815__auto___39457,t,writer);
}catch (e39456){var __39458 = e39456;
}
...
var char_code = (function (){var o__38815__auto__ = (new String(char$));
return (o__38815__auto__["charCodeAt"]).call(o__38815__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38815__auto__ = String;
return (o__38815__auto__["fromCharCode"]).call(o__38815__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39459 = num_code;
switch (G__39459) {
case (1):
return (185);
...
var o__38815__auto__ = String;
return (o__38815__auto__["fromCharCode"]).call(o__38815__auto__,superscript_code);
});
/**
...
}catch (e39461){var _e__38822__auto__ = e39461;
return false;
}})())){
...
var vec__39462 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39462,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39465 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39465["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39466 = temp__5718__auto____$1;
return (o39466["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___39473 = arguments.length;
var i__4731__auto___39474 = (0);
while(true){
if((i__4731__auto___39474 < len__4730__auto___39473)){
args__4736__auto__.push((arguments[i__4731__auto___39474]));

var G__39475 = (i__4731__auto___39474 + (1));
i__4731__auto___39474 = G__39475;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39469){
var vec__39470 = p__39469;
var ns_detector = cljs.core.nth.call(null,vec__39470,(0),null);
...
var G__39476 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39477 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39476;
remaining_tokens = G__39477;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39467){
var G__39468 = cljs.core.first.call(null,seq39467);
var seq39467__$1 = cljs.core.next.call(null,seq39467);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39468,seq39467__$1);
});
...
var vec__39481 = cljs.core.split_with.call(null,(function (p1__39480_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39480_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39481,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39481,(1),null);
...
var vec__39487 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39487,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39487,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39490 = cljs.core.rest.call(null,remaining_tokens);
var G__39491 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39490;
name_tokens = G__39491;
continue;
} else {
...
var vec__39494 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39494,(0),null);
var arity = cljs.core.nth.call(null,vec__39494,(1),null);
var vec__39497 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39497,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39497,(1),null);
var vec__39500 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39500,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39500,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39500,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39500,(3),null);
...
var vec__39506 = result;
var munged_ns = cljs.core.nth.call(null,vec__39506,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39506,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39506,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39506,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39506,(4),null);
var arity = cljs.core.nth.call(null,vec__39506,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39510 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39510,(0),null);
var args = cljs.core.nth.call(null,vec__39510,(1),null);
var vec__39513 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39513,(0),null);
var name = cljs.core.nth.call(null,vec__39513,(1),null);
...
var G__39516 = (arity + (1));
var G__39517 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39518){
var vec__39519 = p__39518;
var arity = cljs.core.nth.call(null,vec__39519,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39519,(1),null);
...
return (function (p1__39522_SHARP_){
return cljs.core.get.call(null,arities,p1__39522_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39523_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___39530 = arguments.length;
var i__4731__auto___39531 = (0);
while(true){
if((i__4731__auto___39531 < len__4730__auto___39530)){
args__4736__auto__.push((arguments[i__4731__auto___39531]));

var G__39532 = (i__4731__auto___39531 + (1));
i__4731__auto___39531 = G__39532;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39526){
var vec__39527 = p__39526;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39527,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39524){
var G__39525 = cljs.core.first.call(null,seq39524);
var seq39524__$1 = cljs.core.next.call(null,seq39524);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39525,seq39524__$1);
});
...
var G__39533 = arg;
var G__39533__$1 = (((G__39533 instanceof cljs.core.Keyword))?G__39533.fqn:null);
switch (G__39533__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39535__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39535__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39535__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39535__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39536 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39536,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39536,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39536,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39536,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39536,(4),null);
var arity = cljs.core.nth.call(null,vec__39536,(5),null);
...
var o__38815__auto__ = f;
return (o__38815__auto__["getBasis"]).call(o__38815__auto__);
});
/**
...
}catch (e39540){var _e__38822__auto__ = e39540;
...
var G__39541 = (obj[cljs.core.first.call(null,path)]);
var G__39542 = cljs.core.rest.call(null,path);
obj = G__39541;
path = G__39542;
continue;
} else {
...
return (function (accum,p__39543){
var vec__39544 = p__39543;
var bit = cljs.core.nth.call(null,vec__39544,(0),null);
var protocol = cljs.core.nth.call(null,vec__39544,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39547){
var vec__39548 = p__39547;
var ns = cljs.core.nth.call(null,vec__39548,(0),null);
var name = cljs.core.nth.call(null,vec__39548,(1),null);
var selector = cljs.core.nth.call(null,vec__39548,(2),null);
...
return (function (p__39552){
var vec__39553 = p__39552;
var munged_name = cljs.core.nth.call(null,vec__39553,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39553,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39553,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39551_SHARP_){
return (obj[cljs.core.first.call(null,p1__39551_SHARP_)]);
});})(name,sorted_matches,vec__39553,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610065052006
