...
var o19759 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19759["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19760 = temp__5718__auto____$1;
return (o19760["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19121__auto__ = f;
return (o__19121__auto__["toString"]).call(o__19121__auto__);
} else {
return "";
}
}catch (e19761){var _ = e19761;
return "";
}});
...
try{var o__19121__auto___19763 = t;
(o__19121__auto___19763["cljs$lang$ctorPrWriter"]).call(o__19121__auto___19763,t,writer);
}catch (e19762){var __19764 = e19762;
}
...
var char_code = (function (){var o__19121__auto__ = (new String(char$));
return (o__19121__auto__["charCodeAt"]).call(o__19121__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19121__auto__ = String;
return (o__19121__auto__["fromCharCode"]).call(o__19121__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__19765 = num_code;
switch (G__19765) {
case (1):
return (185);
...
var o__19121__auto__ = String;
return (o__19121__auto__["fromCharCode"]).call(o__19121__auto__,superscript_code);
});
/**
...
}catch (e19767){var _e__19128__auto__ = e19767;
return false;
}})())){
...
var vec__19768 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__19768,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o19771 = temp__5718__auto__;
var temp__5718__auto____$1 = (o19771["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o19772 = temp__5718__auto____$1;
return (o19772["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___19779 = arguments.length;
var i__4731__auto___19780 = (0);
while(true){
if((i__4731__auto___19780 < len__4730__auto___19779)){
args__4736__auto__.push((arguments[i__4731__auto___19780]));

var G__19781 = (i__4731__auto___19780 + (1));
i__4731__auto___19780 = G__19781;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__19775){
var vec__19776 = p__19775;
var ns_detector = cljs.core.nth.call(null,vec__19776,(0),null);
...
var G__19782 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__19783 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__19782;
remaining_tokens = G__19783;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq19773){
...
var vec__19787 = cljs.core.split_with.call(null,(function (p1__19786_SHARP_){
return cljs.core.not_EQ_.call(null,p1__19786_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__19787,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__19787,(1),null);
...
var vec__19793 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__19793,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__19793,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__19796 = cljs.core.rest.call(null,remaining_tokens);
var G__19797 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__19796;
...
var vec__19800 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__19800,(0),null);
var arity = cljs.core.nth.call(null,vec__19800,(1),null);
var vec__19803 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__19803,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__19803,(1),null);
var vec__19806 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__19806,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__19806,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__19806,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__19806,(3),null);
...
var vec__19812 = result;
var munged_ns = cljs.core.nth.call(null,vec__19812,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__19812,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__19812,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__19812,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__19812,(4),null);
var arity = cljs.core.nth.call(null,vec__19812,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__19816 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__19816,(0),null);
var args = cljs.core.nth.call(null,vec__19816,(1),null);
var vec__19819 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__19819,(0),null);
var name = cljs.core.nth.call(null,vec__19819,(1),null);
...
var G__19822 = (arity + (1));
var G__19823 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__19824){
var vec__19825 = p__19824;
var arity = cljs.core.nth.call(null,vec__19825,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__19825,(1),null);
...
return cljs.core.get.call(null,arities,p1__19828_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__19829_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__19832){
var vec__19833 = p__19832;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__19833,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq19830){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__19841__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__19841__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__19841__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__19841__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__19842 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__19842,(0),null);
var fn_name = cljs.core.nth.call(null,vec__19842,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__19842,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__19842,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__19842,(4),null);
var arity = cljs.core.nth.call(null,vec__19842,(5),null);
...
var o__19121__auto__ = f;
return (o__19121__auto__["getBasis"]).call(o__19121__auto__);
});
/**
...
}catch (e19846){var _e__19128__auto__ = e19846;
...
var G__19847 = (obj[cljs.core.first.call(null,path)]);
var G__19848 = cljs.core.rest.call(null,path);
obj = G__19847;
path = G__19848;
continue;
} else {
...
return (function (accum,p__19849){
var vec__19850 = p__19849;
var bit = cljs.core.nth.call(null,vec__19850,(0),null);
var protocol = cljs.core.nth.call(null,vec__19850,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__19853){
...
var selector = cljs.core.nth.call(null,vec__19854,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__19859,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__19859,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__19859,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__19857_SHARP_){
return (obj[cljs.core.first.call(null,p1__19857_SHARP_)]);
});})(name,sorted_matches,vec__19859,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610894173080
