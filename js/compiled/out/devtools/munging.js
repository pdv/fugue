...
var o39531 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39531["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39532 = temp__5718__auto____$1;
return (o39532["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38893__auto__ = f;
return (o__38893__auto__["toString"]).call(o__38893__auto__);
} else {
return "";
}
}catch (e39533){var _ = e39533;
return "";
}});
...
try{var o__38893__auto___39535 = t;
(o__38893__auto___39535["cljs$lang$ctorPrWriter"]).call(o__38893__auto___39535,t,writer);
...
var char_code = (function (){var o__38893__auto__ = (new String(char$));
return (o__38893__auto__["charCodeAt"]).call(o__38893__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38893__auto__ = String;
return (o__38893__auto__["fromCharCode"]).call(o__38893__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39537 = num_code;
switch (G__39537) {
case (1):
return (185);
...
var o__38893__auto__ = String;
return (o__38893__auto__["fromCharCode"]).call(o__38893__auto__,superscript_code);
});
/**
...
}catch (e39539){var _e__38900__auto__ = e39539;
return false;
}})())){
...
var vec__39540 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39540,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o39543 = temp__5718__auto__;
var temp__5718__auto____$1 = (o39543["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o39544 = temp__5718__auto____$1;
return (o39544["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39547){
var vec__39548 = p__39547;
var ns_detector = cljs.core.nth.call(null,vec__39548,(0),null);
...
var G__39554 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39555 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39554;
remaining_tokens = G__39555;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39545){
var G__39546 = cljs.core.first.call(null,seq39545);
var seq39545__$1 = cljs.core.next.call(null,seq39545);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39546,seq39545__$1);
});
...
var vec__39559 = cljs.core.split_with.call(null,(function (p1__39558_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39558_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39559,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39559,(1),null);
...
var vec__39565 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39565,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39565,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39568 = cljs.core.rest.call(null,remaining_tokens);
var G__39569 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39568;
name_tokens = G__39569;
continue;
} else {
...
var vec__39572 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39572,(0),null);
var arity = cljs.core.nth.call(null,vec__39572,(1),null);
var vec__39575 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39575,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39575,(1),null);
var vec__39578 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39578,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39578,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39578,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39578,(3),null);
...
var vec__39584 = result;
var munged_ns = cljs.core.nth.call(null,vec__39584,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39584,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39584,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39584,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39584,(4),null);
var arity = cljs.core.nth.call(null,vec__39584,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__39588 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__39588,(0),null);
var args = cljs.core.nth.call(null,vec__39588,(1),null);
var vec__39591 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__39594 = (arity + (1));
var G__39595 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39596){
var vec__39597 = p__39596;
var arity = cljs.core.nth.call(null,vec__39597,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39597,(1),null);
...
return cljs.core.get.call(null,arities,p1__39600_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__39601_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39604){
var vec__39605 = p__39604;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39605,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39602){
var G__39603 = cljs.core.first.call(null,seq39602);
var seq39602__$1 = cljs.core.next.call(null,seq39602);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39603,seq39602__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39613__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39613__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39613__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39613__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39614 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39614,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39614,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39614,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39614,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39614,(4),null);
var arity = cljs.core.nth.call(null,vec__39614,(5),null);
...
var o__38893__auto__ = f;
return (o__38893__auto__["getBasis"]).call(o__38893__auto__);
});
/**
...
}catch (e39618){var _e__38900__auto__ = e39618;
...
var G__39619 = (obj[cljs.core.first.call(null,path)]);
var G__39620 = cljs.core.rest.call(null,path);
obj = G__39619;
path = G__39620;
continue;
} else {
...
return (function (accum,p__39621){
var vec__39622 = p__39621;
var bit = cljs.core.nth.call(null,vec__39622,(0),null);
var protocol = cljs.core.nth.call(null,vec__39622,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39625){
var vec__39626 = p__39625;
var ns = cljs.core.nth.call(null,vec__39626,(0),null);
var name = cljs.core.nth.call(null,vec__39626,(1),null);
var selector = cljs.core.nth.call(null,vec__39626,(2),null);
...
return (function (p__39630){
var vec__39631 = p__39630;
var munged_name = cljs.core.nth.call(null,vec__39631,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39631,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39631,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39629_SHARP_){
return (obj[cljs.core.first.call(null,p1__39629_SHARP_)]);
});})(name,sorted_matches,vec__39631,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1610386486298
