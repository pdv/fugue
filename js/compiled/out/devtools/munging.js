...
var o37362 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37362["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37363 = temp__5718__auto____$1;
return (o37363["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36724__auto__ = f;
return (o__36724__auto__["toString"]).call(o__36724__auto__);
} else {
return "";
}
}catch (e37364){var _ = e37364;
return "";
}});
...
try{var o__36724__auto___37366 = t;
(o__36724__auto___37366["cljs$lang$ctorPrWriter"]).call(o__36724__auto___37366,t,writer);
}catch (e37365){var __37367 = e37365;
}
...
var char_code = (function (){var o__36724__auto__ = (new String(char$));
return (o__36724__auto__["charCodeAt"]).call(o__36724__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36724__auto__ = String;
return (o__36724__auto__["fromCharCode"]).call(o__36724__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37368 = num_code;
switch (G__37368) {
case (1):
return (185);
...
var o__36724__auto__ = String;
return (o__36724__auto__["fromCharCode"]).call(o__36724__auto__,superscript_code);
});
/**
...
}catch (e37370){var _e__36731__auto__ = e37370;
return false;
}})())){
...
var vec__37371 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__37371,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o37374 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37374["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37375 = temp__5718__auto____$1;
return (o37375["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37378){
var vec__37379 = p__37378;
var ns_detector = cljs.core.nth.call(null,vec__37379,(0),null);
...
var G__37385 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37386 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37385;
remaining_tokens = G__37386;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37376){
var G__37377 = cljs.core.first.call(null,seq37376);
var seq37376__$1 = cljs.core.next.call(null,seq37376);
...
var vec__37390 = cljs.core.split_with.call(null,(function (p1__37389_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37389_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37390,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37390,(1),null);
...
var vec__37396 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37396,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37396,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37399 = cljs.core.rest.call(null,remaining_tokens);
var G__37400 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37399;
name_tokens = G__37400;
continue;
} else {
...
var vec__37403 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37403,(0),null);
var arity = cljs.core.nth.call(null,vec__37403,(1),null);
var vec__37406 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37406,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37406,(1),null);
var vec__37409 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37409,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37409,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37409,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37409,(3),null);
...
var vec__37415 = result;
var munged_ns = cljs.core.nth.call(null,vec__37415,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37415,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37415,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37415,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37415,(4),null);
var arity = cljs.core.nth.call(null,vec__37415,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__37419 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__37419,(0),null);
var args = cljs.core.nth.call(null,vec__37419,(1),null);
var vec__37422 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37422,(0),null);
var name = cljs.core.nth.call(null,vec__37422,(1),null);
...
var G__37425 = (arity + (1));
var G__37426 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37427){
var vec__37428 = p__37427;
var arity = cljs.core.nth.call(null,vec__37428,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37428,(1),null);
...
return cljs.core.get.call(null,arities,p1__37431_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__37432_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37435){
var vec__37436 = p__37435;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37436,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37433){
var G__37434 = cljs.core.first.call(null,seq37433);
var seq37433__$1 = cljs.core.next.call(null,seq37433);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37434,seq37433__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__37444__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37444__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37444__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37444__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37445 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37445,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37445,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37445,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37445,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37445,(4),null);
var arity = cljs.core.nth.call(null,vec__37445,(5),null);
...
var o__36724__auto__ = f;
return (o__36724__auto__["getBasis"]).call(o__36724__auto__);
});
/**
...
}catch (e37449){var _e__36731__auto__ = e37449;
...
var G__37450 = (obj[cljs.core.first.call(null,path)]);
var G__37451 = cljs.core.rest.call(null,path);
obj = G__37450;
path = G__37451;
continue;
} else {
...
return (function (accum,p__37452){
var vec__37453 = p__37452;
var bit = cljs.core.nth.call(null,vec__37453,(0),null);
var protocol = cljs.core.nth.call(null,vec__37453,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37456){
var vec__37457 = p__37456;
var ns = cljs.core.nth.call(null,vec__37457,(0),null);
var name = cljs.core.nth.call(null,vec__37457,(1),null);
var selector = cljs.core.nth.call(null,vec__37457,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__37462,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37462,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__37462,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37460_SHARP_){
return (obj[cljs.core.first.call(null,p1__37460_SHARP_)]);
});})(name,sorted_matches,vec__37462,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1601313658927
