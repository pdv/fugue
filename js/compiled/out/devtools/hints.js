...
var file = cljs.core.get.call(null,map__40351__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40351__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40351__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5718__auto___40353 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___40353)){
var seen_errors_40354 = temp__5718__auto___40353;
if(cljs.core.truth_(seen_errors_40354.has(self))){
} else {
seen_errors_40354.add(self);

var temp__5720__auto___40355 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___40355)){
var sense_40356 = temp__5720__auto___40355;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40356)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1610128220554
