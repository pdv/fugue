...
var file = cljs.core.get.call(null,map__40250__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40250__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40250__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40249){var _e = e40249;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___40252 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___40252)){
var seen_errors_40253 = temp__5718__auto___40252;
if(cljs.core.truth_(seen_errors_40253.has(self))){
} else {
seen_errors_40253.add(self);

var temp__5720__auto___40254 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___40254)){
var sense_40255 = temp__5720__auto___40254;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40255)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1610051536857
