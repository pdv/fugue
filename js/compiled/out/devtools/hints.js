...
var map__40236 = top_item;
var map__40236__$1 = (((((!((map__40236 == null))))?(((((map__40236.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40236.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40236):map__40236);
var file = cljs.core.get.call(null,map__40236__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40236__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40236__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40235){var _e = e40235;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___40238 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___40238)){
var seen_errors_40239 = temp__5718__auto___40238;
if(cljs.core.truth_(seen_errors_40239.has(self))){
} else {
seen_errors_40239.add(self);

var temp__5720__auto___40240 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___40240)){
var sense_40241 = temp__5720__auto___40240;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40241)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1608403402287
