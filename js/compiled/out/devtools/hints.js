...
var file = cljs.core.get.call(null,map__40160__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40160__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40160__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5718__auto___40162 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___40162)){
var seen_errors_40163 = temp__5718__auto___40162;
if(cljs.core.truth_(seen_errors_40163.has(self))){
} else {
seen_errors_40163.add(self);

var temp__5720__auto___40164 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___40164)){
var sense_40165 = temp__5720__auto___40164;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40165)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1601406070159
