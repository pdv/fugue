...
}catch (e39962){var _e = e39962;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___39965 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___39965)){
var seen_errors_39966 = temp__5718__auto___39965;
if(cljs.core.truth_(seen_errors_39966.has(self))){
} else {
seen_errors_39966.add(self);

var temp__5720__auto___39967 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___39967)){
var sense_39968 = temp__5720__auto___39967;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_39968)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1601341176307
