...
var map__20663__$1 = (((((!((map__20663 == null))))?(((((map__20663.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20663.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20663):map__20663);
var file = cljs.core.get.call(null,map__20663__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20663__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20663__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5718__auto___20665 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___20665)){
var seen_errors_20666 = temp__5718__auto___20665;
if(cljs.core.truth_(seen_errors_20666.has(self))){
} else {
seen_errors_20666.add(self);

var temp__5720__auto___20667 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___20667)){
var sense_20668 = temp__5720__auto___20667;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20668)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1611084587074
