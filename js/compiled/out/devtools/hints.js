...
var map__40103 = top_item;
var map__40103__$1 = (((((!((map__40103 == null))))?(((((map__40103.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40103.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40103):map__40103);
var file = cljs.core.get.call(null,map__40103__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40103__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40103__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40102){var _e = e40102;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___40105 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___40105)){
var seen_errors_40106 = temp__5718__auto___40105;
if(cljs.core.truth_(seen_errors_40106.has(self))){
} else {
seen_errors_40106.add(self);

var temp__5720__auto___40107 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___40107)){
var sense_40108 = temp__5720__auto___40107;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40108)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1601399212787
