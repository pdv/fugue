...
}catch (e40444){var _e = e40444;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___40447 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___40447)){
var seen_errors_40448 = temp__5718__auto___40447;
if(cljs.core.truth_(seen_errors_40448.has(self))){
} else {
seen_errors_40448.add(self);

var temp__5720__auto___40449 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___40449)){
var sense_40450 = temp__5720__auto___40449;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40450)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1610330684663
