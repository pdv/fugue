...
var o__19156__auto___20642 = (function (){var o__19156__auto__ = (function (){var o__19156__auto__ = Promise;
return (o__19156__auto__["resolve"]).call(o__19156__auto__);
})();
return (o__19156__auto__["then"]).call(o__19156__auto__,callback);
})();
(o__19156__auto___20642["catch"]).call(o__19156__auto___20642,devtools.async.rethrow_outside_promise);
...
var G__20643_20644 = Error;
var target__19161__auto___20645 = G__20643_20644;
if(cljs.core.truth_(target__19161__auto___20645)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20643_20644)].join(''),"\n","target__19161__auto__"].join('')));
}

(target__19161__auto___20645["stackTraceLimit"] = Infinity);
...
//# sourceMappingURL=async.js.map?rel=1611084586990
