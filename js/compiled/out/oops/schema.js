...
var G__24537 = cljs.core.first.call(null,element_str);
switch (G__24537) {
case "?":
arr.push((1));
...
var G__24539 = cljs.core.next.call(null,items);
items = G__24539;
continue;
} else {
return null;
...
var G__24540 = cljs.core.next.call(null,items);
items = G__24540;
continue;
} else {
return null;
...
var G__24542 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__24542;
continue;
} else {
return true;
...
switch (G__24545) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__24545){
return (function (p1__24543_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24543_SHARP_,(2));
});})(G__24545))
))){
...
return cljs.core.not_EQ_.call(null,p1__24544_SHARP_,(1));
});})(G__24545))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24545)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1610145014586
