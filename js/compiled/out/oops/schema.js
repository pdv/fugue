...
var G__24525 = cljs.core.first.call(null,element_str);
switch (G__24525) {
case "?":
arr.push((1));
...
var G__24527 = cljs.core.next.call(null,items);
items = G__24527;
continue;
} else {
return null;
...
var G__24528 = cljs.core.next.call(null,items);
items = G__24528;
continue;
} else {
return null;
...
var G__24530 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__24530;
continue;
} else {
return true;
...
switch (G__24533) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__24533){
return (function (p1__24531_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24531_SHARP_,(2));
});})(G__24533))
))){
...
return cljs.core.not_EQ_.call(null,p1__24532_SHARP_,(1));
});})(G__24533))
))){
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24533)].join('')));

}
}
});

//# sourceMappingURL=schema.js.map?rel=1608403382982
