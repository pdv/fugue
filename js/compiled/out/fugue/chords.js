...
var relative = cljs.core.map.call(null,(function (p1__34634_SHARP_){
return cljs.core.mod.call(null,(p1__34634_SHARP_ - root),(12));
}),notes);
return cljs.core.map.call(null,((function (relative){
return (function (p__34635){
var vec__34636 = p__34635;
var name = cljs.core.nth.call(null,vec__34636,(0),null);
...
return (function (p__34639){
var vec__34640 = p__34639;
var _ = cljs.core.nth.call(null,vec__34640,(0),null);
var chord = cljs.core.nth.call(null,vec__34640,(1),null);
...
return cljs.core.every_QMARK_.call(null,(function (p1__34643_SHARP_){
return cljs.core.contains_QMARK_.call(null,chord,p1__34643_SHARP_);
}),relative);
}),notes);
});
fugue.chords.contained_chords = (function fugue$chords$contained_chords(notes){
return fugue.chords.chords_where.call(null,(function (chord,relative){
return cljs.core.every_QMARK_.call(null,(function (p1__34644_SHARP_){
return cljs.core.contains_QMARK_.call(null,cljs.core.set.call(null,relative),p1__34644_SHARP_);
}),chord);
}),notes);
});

//# sourceMappingURL=chords.js.map?rel=1610319293729
