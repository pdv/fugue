...
return cljs.spec.alpha.map_spec_impl.call(null,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[null,null,null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__30764){
return cljs.core.map_QMARK_.call(null,G__30764);
}),(function (G__30764){
return cljs.core.contains_QMARK_.call(null,G__30764,new cljs.core.Keyword("fugue.buffer","buffer-name","fugue.buffer/buffer-name",-1610711486));
})], null),(function (G__30764){
return ((cljs.core.map_QMARK_.call(null,G__30764)) && (cljs.core.contains_QMARK_.call(null,G__30764,new cljs.core.Keyword("fugue.buffer","buffer-name","fugue.buffer/buffer-name",-1610711486))));
...
cljs.core._add_method.call(null,fugue.audio.make_audio_node,new cljs.core.Keyword("fugue.convolver","convolver","fugue.convolver/convolver",1132595263),(function (p__30765,p__30766){
...
var actx = cljs.core.get.call(null,map__30767__$1,new cljs.core.Keyword("fugue.audio","actx","fugue.audio/actx",-1808529001));
var buffer_cache = cljs.core.get.call(null,map__30767__$1,new cljs.core.Keyword("fugue.buffer","buffer-cache","fugue.buffer/buffer-cache",-2046975648));
...
var buffer_name = cljs.core.get.call(null,map__30768__$1,new cljs.core.Keyword("fugue.buffer","buffer-name","fugue.buffer/buffer-name",-1610711486));
var node = actx.createConvolver();
var target_obj_30771_30775 = node;
var _STAR_runtime_state_STAR__orig_val__30773_30776 = oops.state._STAR_runtime_state_STAR_;
var _STAR_runtime_state_STAR__temp_val__30774_30777 = oops.state.prepare_state.call(null,target_obj_30771_30775,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});
oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR__temp_val__30774_30777;

try{var parent_obj_30772_30778 = target_obj_30771_30775;
if(oops.core.validate_object_access_dynamically.call(null,parent_obj_30772_30778,(0),"buffer",true,true,true)){
(parent_obj_30772_30778["buffer"] = cljs.core.get.call(null,buffer_cache,buffer_name));
} else {
}

}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR__orig_val__30773_30776;
}
return node;
}));
...
//# sourceMappingURL=convolver.js.map?rel=1610051741247
