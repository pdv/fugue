...
var to_midi = (function (){var G__10546 = type;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10546__$1)].join('')));

}
})();
var from_midi = (function (){var G__10547 = type;
var G__10547__$1 = (((G__10547 instanceof cljs.core.Keyword))?G__10547.fqn:null);
switch (G__10547__$1) {
case "linear":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10547__$1)].join('')));
...
return cljs.core.reset_BANG_.call(null,value,from_midi.call(null,parseInt(p1__10543_SHARP_.target.value),min,max));
});})(to_midi,from_midi))
], null)], null);
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"type","type",1174270348),"range",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"block"], null),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,value),new cljs.core.Keyword(null,"min","min",444991522),min,new cljs.core.Keyword(null,"max","max",61366548),max,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__10551_SHARP_){
return cljs.core.reset_BANG_.call(null,value,parseInt(p1__10551_SHARP_.target.value));
})], null)], null);
});
fugue.components.picker = (function fugue$components$picker(value,options){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"select","select",1147833503),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__10552_SHARP_){
return cljs.core.reset_BANG_.call(null,value,p1__10552_SHARP_.target.value);
}),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref.call(null,value)], null),(function (){var iter__4523__auto__ = (function fugue$components$picker_$_iter__10553(s__10554){
return (new cljs.core.LazySeq(null,(function (){
var s__10554__$1 = s__10554;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__10554__$1);
if(temp__5720__auto__){
var s__10554__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__10554__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__10554__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__10556 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__10555 = (0);
while(true){
if((i__10555 < size__4522__auto__)){
var option = cljs.core._nth.call(null,c__4521__auto__,i__10555);
cljs.core.chunk_append.call(null,b__10556,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),option], null),option], null));

var G__10557 = (i__10555 + (1));
i__10555 = G__10557;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10556),fugue$components$picker_$_iter__10553.call(null,cljs.core.chunk_rest.call(null,s__10554__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__10556),null);
}
} else {
var option = cljs.core.first.call(null,s__10554__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"value","value",305978217),option], null),option], null),fugue$components$picker_$_iter__10553.call(null,cljs.core.rest.call(null,s__10554__$2)));
}
} else {
return null;
}
...
//# sourceMappingURL=components.js.map?rel=1611088683169
