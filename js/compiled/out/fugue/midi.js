...
return cljs.spec.alpha.map_spec_impl.call(null,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"req-un","req-un",1074571008),new cljs.core.Keyword(null,"opt-un","opt-un",883442496),new cljs.core.Keyword(null,"gfn","gfn",791517474),new cljs.core.Keyword(null,"pred-exprs","pred-exprs",1792271395),new cljs.core.Keyword(null,"keys-pred","keys-pred",858984739),new cljs.core.Keyword(null,"opt-keys","opt-keys",1262688261),new cljs.core.Keyword(null,"req-specs","req-specs",553962313),new cljs.core.Keyword(null,"req","req",-326448303),new cljs.core.Keyword(null,"req-keys","req-keys",514319221),new cljs.core.Keyword(null,"opt-specs","opt-specs",-384905450),new cljs.core.Keyword(null,"pred-forms","pred-forms",172611832),new cljs.core.Keyword(null,"opt","opt",-794706369)],[null,null,null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (G__34694){
return cljs.core.map_QMARK_.call(null,G__34694);
}),(function (G__34694){
return cljs.core.contains_QMARK_.call(null,G__34694,new cljs.core.Keyword("fugue.midi","input-name","fugue.midi/input-name",1387993924));
})], null),(function (G__34694){
return ((cljs.core.map_QMARK_.call(null,G__34694)) && (cljs.core.contains_QMARK_.call(null,G__34694,new cljs.core.Keyword("fugue.midi","input-name","fugue.midi/input-name",1387993924))));
...
cljs.core._add_method.call(null,fugue.chan.make_chan_node,new cljs.core.Keyword("fugue.midi","midi-in","fugue.midi/midi-in",-1281528989),(function (p__34695,p__34696){
...
var ins = cljs.core.get.call(null,map__34697__$1,new cljs.core.Keyword("fugue.midi","ins","fugue.midi/ins",-1182466185));
...
var input_name = cljs.core.get.call(null,map__34698__$1,new cljs.core.Keyword("fugue.midi","input-name","fugue.midi/input-name",1387993924));
...
var op = ((note_on)?cljs.core.conj:((function (map__34703,map__34703__$1,note,velocity,note_on,v_down){
return (function (p1__34702_SHARP_,p2__34701_SHARP_){
return cljs.core.remove.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([p2__34701_SHARP_]),p1__34702_SHARP_);
});})(map__34703,map__34703__$1,note,velocity,note_on,v_down))
);
...
var G__34708__1 = (function (result){
return rf.call(null,result);
});
var G__34708__2 = (function (result,midi){
var map__34706 = midi;
var map__34706__$1 = (((((!((map__34706 == null))))?(((((map__34706.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__34706.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__34706):map__34706);
var type = cljs.core.get.call(null,map__34706__$1,new cljs.core.Keyword("fugue.midi","type","fugue.midi/type",2122361827));
var velocity = cljs.core.get.call(null,map__34706__$1,new cljs.core.Keyword("fugue.midi","velocity","fugue.midi/velocity",382164680));
...
G__34708 = function(result,midi){
switch(arguments.length){
case 0:
return G__34708__0.call(this);
case 1:
return G__34708__1.call(this,result);
case 2:
return G__34708__2.call(this,result,midi);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
 ...
 */
fugue.midi.midi_x_gate = cljs.core.comp.call(null,fugue.midi.midi_x_velo.call(null,true),cljs.core.map.call(null,(function (p1__34709_SHARP_){
return (p1__34709_SHARP_ / (128));
})));
...
return cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__34710_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword("fugue.midi","note","fugue.midi/note",343363945).cljs$core$IFn$_invoke$arity$1(p1__34710_SHARP_),new cljs.core.Keyword("fugue.midi","note","fugue.midi/note",343363945).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("fugue.chan","input","fugue.chan/input",-525931471).cljs$core$IFn$_invoke$arity$1(p1__34710_SHARP_)));
})),cljs.core.map.call(null,(function (p1__34711_SHARP_){
return fugue.midi.map_to_range.call(null,new cljs.core.Keyword("fugue.midi","velocity","fugue.midi/velocity",382164680).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("fugue.chan","input","fugue.chan/input",-525931471).cljs$core$IFn$_invoke$arity$1(p1__34711_SHARP_)),(0),(127),new cljs.core.Keyword("fugue.midi","min","fugue.midi/min",-629752999).cljs$core$IFn$_invoke$arity$1(p1__34711_SHARP_),new cljs.core.Keyword("fugue.midi","max","fugue.midi/max",-1023959717).cljs$core$IFn$_invoke$arity$1(p1__34711_SHARP_));
})));
}));
...
var vec__34712 = cljs.core.js__GT_clj.call(null,js_arr);
var status = cljs.core.nth.call(null,vec__34712,(0),null);
var note = cljs.core.nth.call(null,vec__34712,(1),null);
var velocity = cljs.core.nth.call(null,vec__34712,(2),null);
...
fugue.midi.event_x_msg = cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__34715_SHARP_){
return cljs.core._EQ_.call(null,(3),p1__34715_SHARP_.data.length);
})),cljs.core.map.call(null,fugue.midi.event__GT_msg));
/**
 * This is probably wrong
 */
fugue.midi.msg__GT_event = (function fugue$midi$msg__GT_event(p__34716){
...
var type = cljs.core.get.call(null,map__34717__$1,new cljs.core.Keyword("fugue.midi","type","fugue.midi/type",2122361827));
var note = cljs.core.get.call(null,map__34717__$1,new cljs.core.Keyword("fugue.midi","note","fugue.midi/note",343363945));
var velocity = cljs.core.get.call(null,map__34717__$1,new cljs.core.Keyword("fugue.midi","velocity","fugue.midi/velocity",382164680));
...
var c__32685__auto___34736 = cljs.core.async.chan.call(null,(1));
cljs.core.async.impl.dispatch.run.call(null,((function (c__32685__auto___34736,c){
return (function (){
var f__32686__auto__ = (function (){var switch__32590__auto__ = ((function (c__32685__auto___34736,c){
return (function (state_34727){
var state_val_34728 = (state_34727[(1)]);
if((state_val_34728 === (1))){
var state_34727__$1 = state_34727;
var statearr_34729_34737 = state_34727__$1;
(statearr_34729_34737[(2)] = null);

(statearr_34729_34737[(1)] = (2));
...
var state_34727__$1 = state_34727;
return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_34727__$1,(4),c);
} else {
...
var inst_34722 = midi_out.send(inst_34721);
var state_34727__$1 = (function (){var statearr_34730 = state_34727;
(statearr_34730[(7)] = inst_34722);

return statearr_34730;
})();
var statearr_34731_34738 = state_34727__$1;
(statearr_34731_34738[(2)] = null);

(statearr_34731_34738[(1)] = (2));
...
});})(c__32685__auto___34736,c))
;
return ((function (switch__32590__auto__,c__32685__auto___34736,c){
return (function() {
...
(statearr_34732[(0)] = fugue$midi$midi_out_chan_$_state_machine__32591__auto__);

(statearr_34732[(1)] = (1));

return statearr_34732;
});
var fugue$midi$midi_out_chan_$_state_machine__32591__auto____1 = (function (state_34727){
while(true){
var ret_value__32592__auto__ = (function (){try{while(true){
var result__32593__auto__ = switch__32590__auto__.call(null,state_34727);
...
var ex__32594__auto__ = e34733;
var statearr_34734_34739 = state_34727;
(statearr_34734_34739[(5)] = ex__32594__auto__);
...
var G__34740 = state_34727;
state_34727 = G__34740;
continue;
} else {
...
fugue$midi$midi_out_chan_$_state_machine__32591__auto__ = function(state_34727){
switch(arguments.length){
case 0:
return fugue$midi$midi_out_chan_$_state_machine__32591__auto____0.call(this);
case 1:
return fugue$midi$midi_out_chan_$_state_machine__32591__auto____1.call(this,state_34727);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
;})(switch__32590__auto__,c__32685__auto___34736,c))
})();
var state__32687__auto__ = (function (){var statearr_34735 = f__32686__auto__.call(null);
(statearr_34735[(6)] = c__32685__auto___34736);
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,(function (p1__34741_SHARP_){
return p1__34741_SHARP_.name;
...
//# sourceMappingURL=midi.js.map?rel=1610304476624
