...
return cljs.core.contains_QMARK_.call(null,G__34698,new cljs.core.Keyword("fugue.midi","input-name","fugue.midi/input-name",1387993924));
})], null),(function (G__34698){
return ((cljs.core.map_QMARK_.call(null,G__34698)) && (cljs.core.contains_QMARK_.call(null,G__34698,new cljs.core.Keyword("fugue.midi","input-name","fugue.midi/input-name",1387993924))));
...
cljs.core._add_method.call(null,fugue.chan.make_chan_node,new cljs.core.Keyword("fugue.midi","midi-in","fugue.midi/midi-in",-1281528989),(function (p__34699,p__34700){
...
var ins = cljs.core.get.call(null,map__34701__$1,new cljs.core.Keyword("fugue.midi","ins","fugue.midi/ins",-1182466185));
...
var input_name = cljs.core.get.call(null,map__34702__$1,new cljs.core.Keyword("fugue.midi","input-name","fugue.midi/input-name",1387993924));
...
var G__34705 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(midi_msg);
...
return (function() {
var G__34711 = null;
var G__34711__0 = (function (){
return rf.call(null);
});
var G__34711__1 = (function (result){
return rf.call(null,result);
});
var G__34711__2 = (function (result,midi){
var map__34709 = midi;
...
var note = cljs.core.get.call(null,map__34709__$1,new cljs.core.Keyword(null,"note","note",1426297904));
var velocity = cljs.core.get.call(null,map__34709__$1,new cljs.core.Keyword(null,"velocity","velocity",-581524355));
var note_on = (velocity > (0));
var op = ((note_on)?cljs.core.conj:((function (map__34709,map__34709__$1,note,velocity,note_on,v_down){
return (function (p1__34708_SHARP_,p2__34707_SHARP_){
return cljs.core.remove.call(null,cljs.core.PersistentHashSet.createAsIfByAssoc([p2__34707_SHARP_]),p1__34708_SHARP_);
});})(map__34709,map__34709__$1,note,velocity,note_on,v_down))
);
...
G__34711 = function(result,midi){
switch(arguments.length){
case 0:
return G__34711__0.call(this);
case 1:
return G__34711__1.call(this,result);
case 2:
return G__34711__2.call(this,result,midi);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__34711.cljs$core$IFn$_invoke$arity$0 = G__34711__0;
G__34711.cljs$core$IFn$_invoke$arity$1 = G__34711__1;
G__34711.cljs$core$IFn$_invoke$arity$2 = G__34711__2;
return G__34711;
})()
;})(v_down))
});
...
var G__34714__1 = (function (result){
return rf.call(null,result);
});
var G__34714__2 = (function (result,midi){
var map__34712 = midi;
...
var type = cljs.core.get.call(null,map__34712__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var velocity = cljs.core.get.call(null,map__34712__$1,new cljs.core.Keyword(null,"velocity","velocity",-581524355));
...
G__34714 = function(result,midi){
switch(arguments.length){
case 0:
return G__34714__0.call(this);
case 1:
return G__34714__1.call(this,result);
case 2:
return G__34714__2.call(this,result,midi);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
 ...
 */
fugue.midi.midi_x_gate = cljs.core.comp.call(null,fugue.midi.midi_x_velo.call(null,true),cljs.core.map.call(null,(function (p1__34715_SHARP_){
return (p1__34715_SHARP_ / (128));
})));
...
return cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__34716_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"note","note",1426297904).cljs$core$IFn$_invoke$arity$1(p1__34716_SHARP_),new cljs.core.Keyword("fugue.midi","note","fugue.midi/note",343363945).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("fugue.chan","input","fugue.chan/input",-525931471).cljs$core$IFn$_invoke$arity$1(p1__34716_SHARP_)));
})),cljs.core.map.call(null,(function (p1__34717_SHARP_){
return fugue.midi.map_to_range.call(null,new cljs.core.Keyword(null,"velocity","velocity",-581524355).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("fugue.chan","input","fugue.chan/input",-525931471).cljs$core$IFn$_invoke$arity$1(p1__34717_SHARP_)),(0),(127),new cljs.core.Keyword("fugue.midi","min","fugue.midi/min",-629752999).cljs$core$IFn$_invoke$arity$1(p1__34717_SHARP_),new cljs.core.Keyword("fugue.midi","max","fugue.midi/max",-1023959717).cljs$core$IFn$_invoke$arity$1(p1__34717_SHARP_));
})));
}));
...
var vec__34718 = cljs.core.js__GT_clj.call(null,js_arr);
var status = cljs.core.nth.call(null,vec__34718,(0),null);
var note = cljs.core.nth.call(null,vec__34718,(1),null);
var velocity = cljs.core.nth.call(null,vec__34718,(2),null);
...
fugue.midi.event_x_msg = cljs.core.comp.call(null,cljs.core.filter.call(null,(function (p1__34721_SHARP_){
return cljs.core._EQ_.call(null,(3),p1__34721_SHARP_.data.length);
})),cljs.core.map.call(null,fugue.midi.event__GT_msg));
/**
 * This is probably wrong
 */
fugue.midi.msg__GT_event = (function fugue$midi$msg__GT_event(p__34722){
...
var type = cljs.core.get.call(null,map__34723__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var note = cljs.core.get.call(null,map__34723__$1,new cljs.core.Keyword(null,"note","note",1426297904));
var velocity = cljs.core.get.call(null,map__34723__$1,new cljs.core.Keyword(null,"velocity","velocity",-581524355));
...
var c__32707__auto___34742 = cljs.core.async.chan.call(null,(1));
cljs.core.async.impl.dispatch.run.call(null,((function (c__32707__auto___34742,c){
return (function (){
var f__32708__auto__ = (function (){var switch__32612__auto__ = ((function (c__32707__auto___34742,c){
return (function (state_34733){
var state_val_34734 = (state_34733[(1)]);
if((state_val_34734 === (1))){
var state_34733__$1 = state_34733;
var statearr_34735_34743 = state_34733__$1;
(statearr_34735_34743[(2)] = null);

(statearr_34735_34743[(1)] = (2));
...
var state_34733__$1 = state_34733;
return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_34733__$1,(4),c);
} else {
...
var inst_34728 = midi_out.send(inst_34727);
var state_34733__$1 = (function (){var statearr_34736 = state_34733;
(statearr_34736[(7)] = inst_34728);

return statearr_34736;
})();
var statearr_34737_34744 = state_34733__$1;
(statearr_34737_34744[(2)] = null);

(statearr_34737_34744[(1)] = (2));
...
});})(c__32707__auto___34742,c))
;
return ((function (switch__32612__auto__,c__32707__auto___34742,c){
return (function() {
...
var statearr_34738 = [null,null,null,null,null,null,null,null];
(statearr_34738[(0)] = fugue$midi$midi_out_chan_$_state_machine__32613__auto__);

(statearr_34738[(1)] = (1));

return statearr_34738;
});
var fugue$midi$midi_out_chan_$_state_machine__32613__auto____1 = (function (state_34733){
while(true){
var ret_value__32614__auto__ = (function (){try{while(true){
var result__32615__auto__ = switch__32612__auto__.call(null,state_34733);
...
var ex__32616__auto__ = e34739;
var statearr_34740_34745 = state_34733;
(statearr_34740_34745[(5)] = ex__32616__auto__);
...
var G__34746 = state_34733;
state_34733 = G__34746;
continue;
} else {
...
fugue$midi$midi_out_chan_$_state_machine__32613__auto__ = function(state_34733){
switch(arguments.length){
case 0:
return fugue$midi$midi_out_chan_$_state_machine__32613__auto____0.call(this);
case 1:
return fugue$midi$midi_out_chan_$_state_machine__32613__auto____1.call(this,state_34733);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
;})(switch__32612__auto__,c__32707__auto___34742,c))
})();
var state__32709__auto__ = (function (){var statearr_34741 = f__32708__auto__.call(null);
(statearr_34741[(6)] = c__32707__auto___34742);
...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,(function (p1__34747_SHARP_){
return p1__34747_SHARP_.name;
...
//# sourceMappingURL=midi.js.map?rel=1610481569494
