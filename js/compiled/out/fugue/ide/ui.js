...
goog.require('fugue.ide.file_upload');
...
fugue.ide.ui.windows_layout = (function fugue$ide$ui$windows_layout(state,p__19081){
...
var on_box_click = cljs.core.get.call(null,map__19082__$1,new cljs.core.Keyword(null,"on-box-click","on-box-click",177704013));
var on_text_change = cljs.core.get.call(null,map__19082__$1,new cljs.core.Keyword(null,"on-text-change","on-text-change",-1719329456));
var on_shortcut = cljs.core.get.call(null,map__19082__$1,new cljs.core.Keyword(null,"on-shortcut","on-shortcut",-393863730));
return fugue.ide.state.layout.call(null,state,((function (map__19082,map__19082__$1,on_box_click,on_text_change,on_shortcut){
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class-name","class-name",945142584),(cljs.core.truth_(active)?"window focused":"window"),new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),((function (map__19082,map__19082__$1,on_box_click,on_text_change,on_shortcut){
return (function (){
return on_box_click.call(null,id);
});})(map__19082,map__19082__$1,on_box_click,on_text_change,on_shortcut))
], null),((cljs.core.vector_QMARK_.call(null,value))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.output","div.output",1460347316),value], null):((typeof value === 'string')?new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [fugue.ide.editor.editor,value,active,cljs.core.partial.call(null,on_text_change,id),((function (map__19082,map__19082__$1,on_box_click,on_text_change,on_shortcut){
return (function (){
...
})),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["f"], null),"file"),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["f","u"], null),new cljs.core.Keyword(null,"file-upload","file-upload",-1929678130)),new cljs.core.Keyword(null,"file-upload","file-upload",-1929678130),(function (){
cljs.core.print.call(null,"here");

return cljs.core.reset_BANG_.call(null,is_file_upload,true);
}));
});
...
var is_file_upload = reagent.core.atom.call(null,false);
fugue.ide.ui.on_key_down = ((function (eval_state,state,is_file_upload){
...
CodeMirror.Vim.defineAction("space!",((function (eval_state,state,is_file_upload){
return (function (){
...
cljs.core.reset_BANG_.call(null,state,fugue.ide.ui.setup_actions.call(null,state,eval_state,is_file_upload));

return ((function (eval_state,state,is_file_upload){
return (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.ide","div.ide",109632974),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fugue.ide.file_upload.file_upload,cljs.core.deref.call(null,is_file_upload),((function (eval_state,state,is_file_upload){
return (function (name,file){
cljs.core.reset_BANG_.call(null,is_file_upload,false);

return cljs.core.swap_BANG_.call(null,state,fugue.ide.state.on_upload,name,file);
});})(eval_state,state,is_file_upload))
], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [fugue.ide.ui.windows_layout,cljs.core.deref.call(null,state),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"on-box-click","on-box-click",177704013),((function (eval_state,state,is_file_upload){
return (function (p1__19084_SHARP_){
return cljs.core.swap_BANG_.call(null,state,fugue.ide.state.activate,p1__19084_SHARP_);
});})(eval_state,state,is_file_upload))
,new cljs.core.Keyword(null,"on-text-change","on-text-change",-1719329456),cljs.core.partial.call(null,cljs.core.swap_BANG_,state,fugue.ide.state.write_file),new cljs.core.Keyword(null,"on-shortcut","on-shortcut",-393863730),((function (eval_state,state,is_file_upload){
return (function (){
return cljs.core.swap_BANG_.call(null,state,fugue.ide.state.open_popup);
});})(eval_state,state,is_file_upload))
], null)], null),(cljs.core.truth_(fugue.ide.state.in_shortcuts_QMARK_.call(null,cljs.core.deref.call(null,state)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [fugue.ide.popup.shortcuts_popup,fugue.ide.state.popup_menu.call(null,cljs.core.deref.call(null,state))], null):null),(cljs.core.truth_(fugue.ide.state.in_minibuffer_QMARK_.call(null,cljs.core.deref.call(null,state)))?new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [fugue.ide.popup.mini_buffer,fugue.ide.state.action_names.call(null,cljs.core.deref.call(null,state)),((function (eval_state,state,is_file_upload){
return (function (){
