...
fugue.ide.ui.windows_layout = (function fugue$ide$ui$windows_layout(state,p__19117){
...
var on_box_click = cljs.core.get.call(null,map__19118__$1,new cljs.core.Keyword(null,"on-box-click","on-box-click",177704013));
var on_text_change = cljs.core.get.call(null,map__19118__$1,new cljs.core.Keyword(null,"on-text-change","on-text-change",-1719329456));
var on_shortcut = cljs.core.get.call(null,map__19118__$1,new cljs.core.Keyword(null,"on-shortcut","on-shortcut",-393863730));
return fugue.ide.state.layout.call(null,state,((function (map__19118,map__19118__$1,on_box_click,on_text_change,on_shortcut){
return (function (id,name,value,active){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class-name","class-name",945142584),(cljs.core.truth_(active)?"window focused":"window"),new cljs.core.Keyword(null,"on-mouse-down","on-mouse-down",1147755470),((function (map__19118,map__19118__$1,on_box_click,on_text_change,on_shortcut){
return (function (){
return on_box_click.call(null,id);
});})(map__19118,map__19118__$1,on_box_click,on_text_change,on_shortcut))
], null),((cljs.core.vector_QMARK_.call(null,value))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.output","div.output",1460347316),value], null):((typeof value === 'string')?new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [fugue.ide.editor.editor,value,name,active,cljs.core.partial.call(null,on_text_change,name),((function (map__19118,map__19118__$1,on_box_click,on_text_change,on_shortcut){
return (function (){
...
var vec__19120 = cljs.core.juxt.call(null,fugue.ide.state.active_file,fugue.ide.ui.eval_settings).call(null,state);
var source = cljs.core.nth.call(null,vec__19120,(0),null);
var settings = cljs.core.nth.call(null,vec__19120,(1),null);
var on_result = ((function (vec__19120,source,settings){
...
return fugue.ide.state.add_action.call(null,fugue.ide.state.add_shortcut.call(null,fugue.ide.state.add_action.call(null,fugue.ide.state.add_shortcut.call(null,fugue.ide.state.add_interactive_shortcut.call(null,fugue.ide.state.add_action.call(null,fugue.ide.state.add_shortcut_group.call(null,fugue.ide.state.add_action.call(null,fugue.ide.state.add_shortcut.call(null,fugue.ide.state.add_shortcut_group.call(null,fugue.ide.state.add_action.call(null,fugue.ide.state.add_shortcut.call(null,fugue.ide.state.add_shortcut.call(null,fugue.ide.state.add_shortcut.call(null,fugue.ide.state.add_action.call(null,fugue.ide.state.add_shortcut_group.call(null,fugue.ide.state.add_action.call(null,fugue.ide.state.add_shortcut.call(null,fugue.ide.state.add_shortcut.call(null,fugue.ide.state.add_shortcut_group.call(null,fugue.ide.state.add_shortcut.call(null,fugue.ide.state.add_action.call(null,fugue.ide.state.add_interactive_shortcut.call(null,fugue.ide.state.add_action.call(null,fugue.ide.ui.add_jumps.call(null,cljs.core.deref.call(null,state),cljs.core.partial.call(null,cljs.core.swap_BANG_,state)),new cljs.core.Keyword(null,"perform-action","perform-action",1794197862),cljs.core.partial.call(null,fugue.ide.state.perform_action,state)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [" "], null),new cljs.core.Keyword(null,"perform-action","perform-action",1794197862),new cljs.core.Keyword(null,"action","action",-811238024)),new cljs.core.Keyword(null,"go-back","go-back",1642157803),cljs.core.partial.call(null,cljs.core.swap_BANG_,state,fugue.ide.state.go_back)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["Tab"], null),new cljs.core.Keyword(null,"go-back","go-back",1642157803)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["t"], null),"toggle"),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["t","v"], null),new cljs.core.Keyword(null,"flip-toggle","flip-toggle",-1812061635),new cljs.core.Keyword(null,"vim","vim",764723904)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["t","l"], null),new cljs.core.Keyword(null,"flip-toggle","flip-toggle",-1812061635),new cljs.core.Keyword(null,"line-numbers","line-numbers",220179237)),new cljs.core.Keyword(null,"flip-toggle","flip-toggle",-1812061635),cljs.core.partial.call(null,cljs.core.swap_BANG_,state,fugue.ide.state.flip_toggle)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["w"], null),"window"),new cljs.core.Keyword(null,"split-window","split-window",1750478920),cljs.core.partial.call(null,cljs.core.swap_BANG_,state,fugue.ide.state.split)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["w","/"], null),new cljs.core.Keyword(null,"split-window","split-window",1750478920),new cljs.core.Keyword(null,"right","right",-452581833)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["w","-"], null),new cljs.core.Keyword(null,"split-window","split-window",1750478920),new cljs.core.Keyword(null,"below","below",-926774883)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["w","x"], null),new cljs.core.Keyword(null,"kill-active-window","kill-active-window",485043525)),new cljs.core.Keyword(null,"kill-active-window","kill-active-window",485043525),cljs.core.partial.call(null,cljs.core.swap_BANG_,state,fugue.ide.state.kill_active_window)),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["e"], null),"eval"),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["e","w"], null),new cljs.core.Keyword(null,"eval-active-window","eval-active-window",906142507)),new cljs.core.Keyword(null,"eval-active-window","eval-active-window",906142507),(function (){
...
})),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["f"], null),"file"),new cljs.core.Keyword(null,"open-file","open-file",-895422430),cljs.core.partial.call(null,cljs.core.swap_BANG_,state,fugue.ide.state.open_file_in_active_window)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["f","o"], null),new cljs.core.Keyword(null,"open-file","open-file",-895422430),new cljs.core.Keyword(null,"file","file",-1269645878)),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["f","d"], null),new cljs.core.Keyword(null,"file-download","file-download",-218211756)),new cljs.core.Keyword(null,"file-download","file-download",-218211756),(function (){
...
return cljs.core.swap_BANG_.call(null,state,fugue.ide.state.activate,p1__19123_SHARP_);
});})(eval_state,state))
...
], null)], null),(cljs.core.truth_(fugue.ide.state.in_shortcuts_QMARK_.call(null,cljs.core.deref.call(null,state)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [fugue.ide.popup.shortcuts_popup,fugue.ide.state.popup_menu.call(null,cljs.core.deref.call(null,state))], null):null),(cljs.core.truth_(fugue.ide.state.in_minibuffer_QMARK_.call(null,cljs.core.deref.call(null,state)))?new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [fugue.ide.popup.mini_buffer,fugue.ide.state.minibuffer_options.call(null,cljs.core.deref.call(null,state)),((function (eval_state,state){
return (function (){
return cljs.core.swap_BANG_.call(null,state,fugue.ide.state.close_popup);
});})(eval_state,state))
,cljs.core.partial.call(null,fugue.ide.state.on_minibuffer_submit,cljs.core.deref.call(null,state))], null):null)], null);
});
;})(eval_state,state))
});
