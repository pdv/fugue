...
return (bias + (scale * new cljs.core.Keyword("fugue.envelope","target","fugue.envelope/target",-1091406589).cljs$core$IFn$_invoke$arity$1(p1__35476_SHARP_)));
});})(durations,times))
,stages);
var shapes = cljs.core.map.call(null,((function (durations,times,levels){
return (function (p1__35477_SHARP_){
return cljs.core.get.call(null,p1__35477_SHARP_,new cljs.core.Keyword("fugue.ramp","shape","fugue.ramp/shape",111917230),new cljs.core.Keyword("fugue.ramp","exponential","fugue.ramp/exponential",1652981676));
...
return (function() {
var G__35481 = null;
var G__35481__0 = (function (){
return rf.call(null);
});
var G__35481__1 = (function (result){
return rf.call(null,result);
});
var G__35481__2 = (function (result,p__35478){
...
var env = cljs.core.get.call(null,map__35479__$1,new cljs.core.Keyword("fugue.envelope","env","fugue.envelope/env",1112422551));
var gate = cljs.core.get.call(null,map__35479__$1,new cljs.core.Keyword("fugue.envelope","gate","fugue.envelope/gate",1600847179));
var scale = cljs.core.get.call(null,map__35479__$1,new cljs.core.Keyword("fugue.envelope","scale","fugue.envelope/scale",-1562195919));
var bias = cljs.core.get.call(null,map__35479__$1,new cljs.core.Keyword("fugue.envelope","bias","fugue.envelope/bias",1014735024));
...
G__35481 = function(result,p__35478){
switch(arguments.length){
case 0:
return G__35481__0.call(this);
case 1:
return G__35481__1.call(this,result);
case 2:
return G__35481__2.call(this,result,p__35478);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__35481.cljs$core$IFn$_invoke$arity$0 = G__35481__0;
...
var s = cljs.core.get.call(null,map__35483__$1,new cljs.core.Keyword("fugue.envelope","s","fugue.envelope/s",-708464424));
var r = cljs.core.get.call(null,map__35483__$1,new cljs.core.Keyword("fugue.envelope","r","fugue.envelope/r",-1841532240));
...
var a = cljs.core.get.call(null,map__35486__$1,new cljs.core.Keyword("fugue.envelope","a","fugue.envelope/a",-236705240));
var d = cljs.core.get.call(null,map__35486__$1,new cljs.core.Keyword("fugue.envelope","d","fugue.envelope/d",-989442482));
...
return cljs.core.map.call(null,(function (p__35491){
...
var duration = cljs.core.get.call(null,map__35492__$1,new cljs.core.Keyword("fugue.envelope","duration","fugue.envelope/duration",-1569089346));
...
cljs.core._add_method.call(null,fugue.chan.make_transducer,new cljs.core.Keyword("fugue.envelope","env-gen","fugue.envelope/env-gen",-963204886),(function (p__35494,_){
...
var actx = cljs.core.get.call(null,map__35495__$1,new cljs.core.Keyword("fugue.audio","actx","fugue.audio/actx",-1808529001));
return fugue.envelope.stages_x_ramp.call(null,((function (map__35495,map__35495__$1,actx){
return (function (){
var target_obj_35497 = actx;
var _STAR_runtime_state_STAR__orig_val__35499 = oops.state._STAR_runtime_state_STAR_;
var _STAR_runtime_state_STAR__temp_val__35500 = oops.state.prepare_state.call(null,target_obj_35497,(new Error()),function(){arguments[0].apply(console,Array.prototype.slice.call(arguments,1))});
oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR__temp_val__35500;

try{var next_obj_35498 = ((oops.core.validate_object_access_dynamically.call(null,target_obj_35497,(0),"currentTime",true,true,false))?(target_obj_35497["currentTime"]):null);
return next_obj_35498;
}finally {oops.state._STAR_runtime_state_STAR_ = _STAR_runtime_state_STAR__orig_val__35499;
}});})(map__35495,map__35495__$1,actx))
);
}));
...
//# sourceMappingURL=envelope.js.map?rel=1610339734924
