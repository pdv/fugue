...
var relative_notes = cljs.core.map.call(null,(function (p1__36989_SHARP_){
return cljs.core.mod.call(null,(p1__36989_SHARP_ - root),(12));
}),notes);
return cljs.core.map.call(null,((function (relative_notes){
return (function (p__36990){
var vec__36991 = p__36990;
var name = cljs.core.nth.call(null,vec__36991,(0),null);
var _ = cljs.core.nth.call(null,vec__36991,(1),null);
...
var _ = cljs.core.nth.call(null,vec__36995,(0),null);
var chord = cljs.core.nth.call(null,vec__36995,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.mapcat.call(null,(function (p1__36998_SHARP_){
return fugue.demo.midi_monitor.chords_from.call(null,predicate,p1__36998_SHARP_,notes);
}),notes));
});
...
return cljs.core.every_QMARK_.call(null,(function (p1__36999_SHARP_){
return cljs.core.contains_QMARK_.call(null,chord,p1__36999_SHARP_);
}),relative_notes);
});
...
return cljs.core.every_QMARK_.call(null,(function (p1__37000_SHARP_){
return cljs.core.contains_QMARK_.call(null,cljs.core.set.call(null,relative_notes),p1__37000_SHARP_);
}),chord);
});
fugue.demo.midi_monitor.component = (function fugue$demo$midi_monitor$component(){
var midi_in_chan = cljs.core.async.chan.call(null);
var held_notes = fugue.api.ratom.call(null,cljs.core.PersistentHashSet.EMPTY);
fugue.api.monitor_chan.call(null,midi_in_chan,((function (midi_in_chan,held_notes){
return (function (msg){
cljs.core.print.call(null,msg);

if(cljs.core.truth_(fugue.api.note_on_QMARK_.call(null,msg))){
...
if(cljs.core.truth_(fugue.api.note_off_QMARK_.call(null,msg))){
...
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [fugue.api.midi_input,midi_in_chan], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.deref.call(null,held_notes)], null),(function (){var iter__4523__auto__ = ((function (midi_in_chan,held_notes){
return (function fugue$demo$midi_monitor$component_$_iter__37001(s__37002){
return (new cljs.core.LazySeq(null,((function (midi_in_chan,held_notes){
return (function (){
var s__37002__$1 = s__37002;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__37002__$1);
if(temp__5720__auto__){
var s__37002__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__37002__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__37002__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__37004 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__37003 = (0);
while(true){
if((i__37003 < size__4522__auto__)){
var chord = cljs.core._nth.call(null,c__4521__auto__,i__37003);
cljs.core.chunk_append.call(null,b__37004,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.str.cljs$core$IFn$_invoke$arity$1(chord)], null));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__37004),fugue$demo$midi_monitor$component_$_iter__37001.call(null,cljs.core.chunk_rest.call(null,s__37002__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__37004),null);
}
} else {
var chord = cljs.core.first.call(null,s__37002__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.str.cljs$core$IFn$_invoke$arity$1(chord)], null),fugue$demo$midi_monitor$component_$_iter__37001.call(null,cljs.core.rest.call(null,s__37002__$2)));
}
} else {
return null;
}
...
//# sourceMappingURL=midi_monitor.js.map?rel=1610405471414
