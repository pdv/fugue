...
var relative_notes = cljs.core.map.call(null,(function (p1__18535_SHARP_){
return cljs.core.mod.call(null,(p1__18535_SHARP_ - root),(12));
}),notes);
return cljs.core.map.call(null,((function (relative_notes){
return (function (p__18536){
var vec__18537 = p__18536;
var name = cljs.core.nth.call(null,vec__18537,(0),null);
var _ = cljs.core.nth.call(null,vec__18537,(1),null);
...
var _ = cljs.core.nth.call(null,vec__18541,(0),null);
var chord = cljs.core.nth.call(null,vec__18541,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.mapcat.call(null,(function (p1__18544_SHARP_){
return fugue.demo.midi_monitor.chords_from.call(null,predicate,p1__18544_SHARP_,notes);
}),notes));
});
...
return cljs.core.every_QMARK_.call(null,(function (p1__18545_SHARP_){
return cljs.core.contains_QMARK_.call(null,chord,p1__18545_SHARP_);
}),relative_notes);
});
...
return cljs.core.every_QMARK_.call(null,(function (p1__18546_SHARP_){
return cljs.core.contains_QMARK_.call(null,cljs.core.set.call(null,relative_notes),p1__18546_SHARP_);
}),chord);
});
...
return (function fugue$demo$midi_monitor$component_$_iter__18547(s__18548){
return (new cljs.core.LazySeq(null,((function (midi_in_chan,held_notes){
return (function (){
var s__18548__$1 = s__18548;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__18548__$1);
if(temp__5720__auto__){
var s__18548__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__18548__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__18548__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__18550 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__18549 = (0);
while(true){
if((i__18549 < size__4522__auto__)){
var chord = cljs.core._nth.call(null,c__4521__auto__,i__18549);
cljs.core.chunk_append.call(null,b__18550,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.str.cljs$core$IFn$_invoke$arity$1(chord)], null));

var G__18551 = (i__18549 + (1));
i__18549 = G__18551;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__18550),fugue$demo$midi_monitor$component_$_iter__18547.call(null,cljs.core.chunk_rest.call(null,s__18548__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__18550),null);
}
} else {
var chord = cljs.core.first.call(null,s__18548__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.str.cljs$core$IFn$_invoke$arity$1(chord)], null),fugue$demo$midi_monitor$component_$_iter__18547.call(null,cljs.core.rest.call(null,s__18548__$2)));
}
} else {
return null;
}
...
//# sourceMappingURL=midi_monitor.js.map?rel=1611084582954
