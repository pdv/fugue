...
var relative_notes = cljs.core.map.call(null,(function (p1__36991_SHARP_){
return cljs.core.mod.call(null,(p1__36991_SHARP_ - root),(12));
}),notes);
return cljs.core.map.call(null,((function (relative_notes){
return (function (p__36992){
var vec__36993 = p__36992;
var name = cljs.core.nth.call(null,vec__36993,(0),null);
var _ = cljs.core.nth.call(null,vec__36993,(1),null);
...
return (function (p__36996){
var vec__36997 = p__36996;
var _ = cljs.core.nth.call(null,vec__36997,(0),null);
var chord = cljs.core.nth.call(null,vec__36997,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.mapcat.call(null,(function (p1__37000_SHARP_){
return fugue.demo.midi_monitor.chords_from.call(null,predicate,p1__37000_SHARP_,notes);
}),notes));
});
...
return cljs.core.every_QMARK_.call(null,(function (p1__37001_SHARP_){
return cljs.core.contains_QMARK_.call(null,chord,p1__37001_SHARP_);
}),relative_notes);
});
...
return cljs.core.every_QMARK_.call(null,(function (p1__37002_SHARP_){
return cljs.core.contains_QMARK_.call(null,cljs.core.set.call(null,relative_notes),p1__37002_SHARP_);
}),chord);
});
...
return (function fugue$demo$midi_monitor$component_$_iter__37003(s__37004){
return (new cljs.core.LazySeq(null,((function (midi_in_chan,held_notes){
return (function (){
var s__37004__$1 = s__37004;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__37004__$1);
if(temp__5720__auto__){
var s__37004__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__37004__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__37004__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__37006 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__37005 = (0);
while(true){
if((i__37005 < size__4522__auto__)){
var chord = cljs.core._nth.call(null,c__4521__auto__,i__37005);
cljs.core.chunk_append.call(null,b__37006,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.str.cljs$core$IFn$_invoke$arity$1(chord)], null));

var G__37007 = (i__37005 + (1));
i__37005 = G__37007;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__37006),fugue$demo$midi_monitor$component_$_iter__37003.call(null,cljs.core.chunk_rest.call(null,s__37004__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__37006),null);
}
} else {
var chord = cljs.core.first.call(null,s__37004__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.str.cljs$core$IFn$_invoke$arity$1(chord)], null),fugue$demo$midi_monitor$component_$_iter__37003.call(null,cljs.core.rest.call(null,s__37004__$2)));
}
} else {
return null;
}
...
//# sourceMappingURL=midi_monitor.js.map?rel=1610481571963
