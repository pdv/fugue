...
var relative_notes = cljs.core.map.call(null,(function (p1__17170_SHARP_){
return cljs.core.mod.call(null,(p1__17170_SHARP_ - root),(12));
}),notes);
return cljs.core.map.call(null,((function (relative_notes){
return (function (p__17171){
var vec__17172 = p__17171;
var name = cljs.core.nth.call(null,vec__17172,(0),null);
var _ = cljs.core.nth.call(null,vec__17172,(1),null);
...
var chord = cljs.core.nth.call(null,vec__17176,(1),null);
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.mapcat.call(null,(function (p1__17179_SHARP_){
return fugue.demo.midi_monitor.chords_from.call(null,predicate,p1__17179_SHARP_,notes);
}),notes));
});
...
return cljs.core.every_QMARK_.call(null,(function (p1__17180_SHARP_){
return cljs.core.contains_QMARK_.call(null,chord,p1__17180_SHARP_);
}),relative_notes);
});
...
return cljs.core.every_QMARK_.call(null,(function (p1__17181_SHARP_){
return cljs.core.contains_QMARK_.call(null,cljs.core.set.call(null,relative_notes),p1__17181_SHARP_);
}),chord);
});
...
return (function fugue$demo$midi_monitor$component_$_iter__17182(s__17183){
return (new cljs.core.LazySeq(null,((function (midi_in_chan,held_notes){
return (function (){
var s__17183__$1 = s__17183;
while(true){
var temp__5720__auto__ = cljs.core.seq.call(null,s__17183__$1);
if(temp__5720__auto__){
var s__17183__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__17183__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__17183__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__17185 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__17184 = (0);
while(true){
if((i__17184 < size__4522__auto__)){
var chord = cljs.core._nth.call(null,c__4521__auto__,i__17184);
cljs.core.chunk_append.call(null,b__17185,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.str.cljs$core$IFn$_invoke$arity$1(chord)], null));

var G__17186 = (i__17184 + (1));
i__17184 = G__17186;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17185),fugue$demo$midi_monitor$component_$_iter__17182.call(null,cljs.core.chunk_rest.call(null,s__17183__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__17185),null);
}
} else {
var chord = cljs.core.first.call(null,s__17183__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),cljs.core.str.cljs$core$IFn$_invoke$arity$1(chord)], null),fugue$demo$midi_monitor$component_$_iter__17182.call(null,cljs.core.rest.call(null,s__17183__$2)));
}
} else {
return null;
}
...
//# sourceMappingURL=midi_monitor.js.map?rel=1610838683230
