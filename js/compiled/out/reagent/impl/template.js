...
var G__3588 = o;
goog.object.set(G__3588,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__3590__i < G__3590__a.length) {G__3590__a[G__3590__i] = arguments[G__3590__i + 0]; ++G__3590__i;}
  args = new cljs.core.IndexedSeq(G__3590__a,0,null);
} 
...
var G__3592 = o;
goog.object.set(G__3592,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__3594__i < G__3594__a.length) {G__3594__a[G__3594__i] = arguments[G__3594__i + 0]; ++G__3594__i;}
  args = new cljs.core.IndexedSeq(G__3594__a,0,null);
} 
...
var G__3596 = props;
var G__3596__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__3596,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__3596);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__3596__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__3596__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__3597 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__3597,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__3597;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__3598){
var map__3599 = p__3598;
...
var on_write = cljs.core.get.call(null,map__3599__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__3599,map__3599__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__3599,map__3599__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__3601_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__3604 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__3604,(0),null);
var id = cljs.core.nth.call(null,vec__3604,(1),null);
var className = cljs.core.nth.call(null,vec__3604,(2),null);
...
var temp__5724__auto___3608 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___3608 == null)){
} else {
var key_3609 = temp__5724__auto___3608;
jsprops.key = key_3609;
}
...
var temp__5724__auto___3610 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___3610 == null)){
} else {
var key_3611 = temp__5724__auto___3610;
jsprops.key = key_3611;
}
...
var temp__5724__auto___3612 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___3612 == null)){
} else {
var key_3613 = temp__5724__auto___3612;
jsprops.key = key_3613;
}
...
var G__3615 = n;
if(cljs.core._EQ_.call(null,"",G__3615)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__3615)){
return x;
} else {
...
var len__4730__auto___3618 = arguments.length;
var i__4731__auto___3619 = (0);
while(true){
if((i__4731__auto___3619 < len__4730__auto___3618)){
args__4736__auto__.push((arguments[i__4731__auto___3619]));

var G__3620 = (i__4731__auto___3619 + (1));
i__4731__auto___3619 = G__3620;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq3616){
var G__3617 = cljs.core.first.call(null,seq3616);
var seq3616__$1 = cljs.core.next.call(null,seq3616);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3617,seq3616__$1);
});
...
break;
default:
var G__3623 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__3623;
continue;
...
var ctx = ({});
var vec__3625 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__3625,(0),null);
var derefed = cljs.core.nth.call(null,vec__3625,(1),null);
...
var G__3628 = (cljs.core.count.call(null,argv) - first_child);
switch (G__3628) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__3628){
...
//# sourceMappingURL=template.js.map?rel=1611075055562
