...
var G__31081 = o;
goog.object.set(G__31081,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__31085 = o;
goog.object.set(G__31085,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__31086__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__31087__i < G__31087__a.length) {G__31087__a[G__31087__i] = arguments[G__31087__i + 0]; ++G__31087__i;}
  args = new cljs.core.IndexedSeq(G__31087__a,0,null);
} 
...
var args = cljs.core.seq(arglist__31088);
...
var G__31089 = props;
var G__31089__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__31089,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31089);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__31089__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__31089__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__31090 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__31090,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__31090;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__31091){
...
var on_write = cljs.core.get.call(null,map__31092__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__31092,map__31092__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__31092,map__31092__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__31094_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__31097 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__31097,(0),null);
var id = cljs.core.nth.call(null,vec__31097,(1),null);
var className = cljs.core.nth.call(null,vec__31097,(2),null);
...
var temp__5724__auto___31101 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___31101 == null)){
} else {
var key_31102 = temp__5724__auto___31101;
jsprops.key = key_31102;
}
...
var temp__5724__auto___31103 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___31103 == null)){
} else {
var key_31104 = temp__5724__auto___31103;
jsprops.key = key_31104;
}
...
var temp__5724__auto___31105 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___31105 == null)){
} else {
var key_31106 = temp__5724__auto___31105;
jsprops.key = key_31106;
}
...
var G__31108 = n;
if(cljs.core._EQ_.call(null,"",G__31108)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__31108)){
return x;
} else {
...
var len__4730__auto___31111 = arguments.length;
var i__4731__auto___31112 = (0);
while(true){
if((i__4731__auto___31112 < len__4730__auto___31111)){
args__4736__auto__.push((arguments[i__4731__auto___31112]));

var G__31113 = (i__4731__auto___31112 + (1));
i__4731__auto___31112 = G__31113;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq31109){
var G__31110 = cljs.core.first.call(null,seq31109);
var seq31109__$1 = cljs.core.next.call(null,seq31109);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31110,seq31109__$1);
});
...
break;
default:
var G__31116 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__31116;
continue;
...
var ctx = ({});
var vec__31118 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__31118,(0),null);
var derefed = cljs.core.nth.call(null,vec__31118,(1),null);
...
var G__31121 = (cljs.core.count.call(null,argv) - first_child);
switch (G__31121) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__31121){
...
//# sourceMappingURL=template.js.map?rel=1608403390548
