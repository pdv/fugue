...
var G__31099 = o;
goog.object.set(G__31099,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__31101__i < G__31101__a.length) {G__31101__a[G__31101__i] = arguments[G__31101__i + 0]; ++G__31101__i;}
  args = new cljs.core.IndexedSeq(G__31101__a,0,null);
} 
...
var G__31103 = o;
goog.object.set(G__31103,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__31107 = props;
var G__31107__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__31107,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31107);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__31107__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__31107__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__31108 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__31108,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__31108;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__31109){
...
var on_write = cljs.core.get.call(null,map__31110__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__31110,map__31110__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__31110,map__31110__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__31112_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__31115 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__31115,(0),null);
var id = cljs.core.nth.call(null,vec__31115,(1),null);
var className = cljs.core.nth.call(null,vec__31115,(2),null);
...
var temp__5724__auto___31119 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___31119 == null)){
} else {
var key_31120 = temp__5724__auto___31119;
jsprops.key = key_31120;
}
...
var temp__5724__auto___31121 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___31121 == null)){
} else {
var key_31122 = temp__5724__auto___31121;
jsprops.key = key_31122;
}
...
var temp__5724__auto___31123 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___31123 == null)){
} else {
var key_31124 = temp__5724__auto___31123;
jsprops.key = key_31124;
}
...
var G__31126 = n;
if(cljs.core._EQ_.call(null,"",G__31126)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__31126)){
return x;
} else {
...
var len__4730__auto___31129 = arguments.length;
var i__4731__auto___31130 = (0);
while(true){
if((i__4731__auto___31130 < len__4730__auto___31129)){
args__4736__auto__.push((arguments[i__4731__auto___31130]));

var G__31131 = (i__4731__auto___31130 + (1));
i__4731__auto___31130 = G__31131;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq31127){
...
break;
default:
var G__31134 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__31134;
continue;
...
var ctx = ({});
var vec__31136 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__31136,(0),null);
var derefed = cljs.core.nth.call(null,vec__31136,(1),null);
...
var G__31139 = (cljs.core.count.call(null,argv) - first_child);
switch (G__31139) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__31139){
...
//# sourceMappingURL=template.js.map?rel=1610334747826
