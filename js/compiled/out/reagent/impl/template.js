...
var G__10889 = o;
goog.object.set(G__10889,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__10891__i < G__10891__a.length) {G__10891__a[G__10891__i] = arguments[G__10891__i + 0]; ++G__10891__i;}
  args = new cljs.core.IndexedSeq(G__10891__a,0,null);
} 
...
var G__10893 = o;
goog.object.set(G__10893,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__10894__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__10895__i < G__10895__a.length) {G__10895__a[G__10895__i] = arguments[G__10895__i + 0]; ++G__10895__i;}
  args = new cljs.core.IndexedSeq(G__10895__a,0,null);
} 
...
var G__10897 = props;
var G__10897__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__10897,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10897);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10897__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__10897__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__10898 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__10898,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__10898;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10899){
...
var on_write = cljs.core.get.call(null,map__10900__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__10900,map__10900__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__10900,map__10900__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10902_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__10905 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10905,(0),null);
var id = cljs.core.nth.call(null,vec__10905,(1),null);
var className = cljs.core.nth.call(null,vec__10905,(2),null);
...
var temp__5724__auto___10909 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___10909 == null)){
} else {
var key_10910 = temp__5724__auto___10909;
jsprops.key = key_10910;
}
...
var temp__5724__auto___10911 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___10911 == null)){
} else {
var key_10912 = temp__5724__auto___10911;
jsprops.key = key_10912;
}
...
var temp__5724__auto___10913 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___10913 == null)){
} else {
var key_10914 = temp__5724__auto___10913;
jsprops.key = key_10914;
}
...
var G__10916 = n;
if(cljs.core._EQ_.call(null,"",G__10916)){
return x;
} else {
...
var len__4730__auto___10919 = arguments.length;
var i__4731__auto___10920 = (0);
while(true){
if((i__4731__auto___10920 < len__4730__auto___10919)){
args__4736__auto__.push((arguments[i__4731__auto___10920]));

var G__10921 = (i__4731__auto___10920 + (1));
i__4731__auto___10920 = G__10921;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10917){
...
break;
default:
var G__10924 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__10924;
continue;
...
var ctx = ({});
var vec__10926 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10926,(0),null);
var derefed = cljs.core.nth.call(null,vec__10926,(1),null);
...
var G__10929 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10929) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__10929){
...
//# sourceMappingURL=template.js.map?rel=1611099812933
