...
var G__3228 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__3228;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__3229 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__3229,ch);
...
if(("\\" === ch__$1)){
var ch_3230__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_3230__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_3230__$2);
} else {
}

var G__3231 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__3231;
continue;
}
}
...
var vec__3239 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3239,(0),null);
var start_column = cljs.core.nth.call(null,vec__3239,(1),null);
...
var G__3242 = cljs.core.conj_BANG_.call(null,a,form);
a = G__3242;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__3243 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__3244 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__3244;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__3243;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__3245 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3245,(0),null);
var start_column = cljs.core.nth.call(null,vec__3245,(1),null);
...
var vec__3248 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3248,(0),null);
var end_column = cljs.core.nth.call(null,vec__3248,(1),null);
...
var vec__3251 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3251,(0),null);
var start_column = cljs.core.nth.call(null,vec__3251,(1),null);
...
var vec__3254 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3254,(0),null);
var end_column = cljs.core.nth.call(null,vec__3254,(1),null);
...
var vec__3257 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3257,(0),null);
var start_column = cljs.core.nth.call(null,vec__3257,(1),null);
...
var vec__3260 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3260,(0),null);
var end_column = cljs.core.nth.call(null,vec__3260,(1),null);
...
var sb = (function (){var G__3263 = (new goog.string.StringBuffer());
G__3263.append(initch);
...
var G__3265 = (function (){var G__3264 = sb;
G__3264.append(ch);

return G__3264;
})();
var G__3266 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__3265;
ch = G__3266;
continue;
}
...
switch (G__3269) {
case "\\":
var G__3273 = (function (){var G__3270 = sb;
G__3270.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__3270;
})();
var G__3274 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__3273;
ch = G__3274;
continue;
...
break;
default:
var G__3275 = (function (){var G__3271 = sb;
G__3271.append(ch);

return G__3271;
})();
var G__3276 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__3275;
ch = G__3276;
continue;
...
var vec__3277 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3277,(0),null);
var end_column = cljs.core.nth.call(null,vec__3277,(1),null);
...
var vec__3280 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__3280,(0),null);
var column = cljs.core.nth.call(null,vec__3280,(1),null);
...
var vec__3285 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__3285,(0),null);
var column = cljs.core.nth.call(null,vec__3285,(1),null);
...
var vec__3290 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__3290,(0),null);
var column = cljs.core.nth.call(null,vec__3290,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__3295 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3295,(0),null);
var start_column = cljs.core.nth.call(null,vec__3295,(1),null);
...
var vec__3298 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3298,(0),null);
var end_column = cljs.core.nth.call(null,vec__3298,(1),null);
...
var G__3301 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__3301,true,null,opts,pending_forms);
...
var G__3302 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__3302)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__3302)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__3302)){
...
var _STAR_suppress_read_STAR__orig_val__3303 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__3304 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__3304;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__3303;
}});
...
var G__3305 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__3305,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__3305,rdr,first_line);
...
var G__3309 = matched;
var G__3310 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__3309;
finished = G__3310;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__3311 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__3312 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__3312;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__3311;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__3313 = cljs.tools.reader.arg_env;
var arg_env_temp_val__3314 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__3314;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__3315 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__3315,"(");
...
var G__3316 = (i + (1));
var G__3317 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__3313;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__3318 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__3318);
...
var G__3321 = cljs.core.next.call(null,s);
var G__3322 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__3321;
key_vals = G__3322;
continue;
} else {
...
var gensym_env_orig_val__3326 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__3327 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__3327;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__3326;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__3328 = token;
var G__3328__$1 = (((G__3328 == null))?null:cljs.core.subs.call(null,G__3328,(1)));
var G__3328__$2 = (((G__3328__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__3328__$1));
var G__3328__$3 = (((G__3328__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__3328__$2));
var G__3328__$4 = (((G__3328__$3 == null))?null:cljs.core.symbol.call(null,G__3328__$3));
if((G__3328__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__3328__$4);
}
})():(function (){var G__3329 = token;
var G__3329__$1 = (((G__3329 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__3329));
if((G__3329__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__3329__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e3336){if((e3336 instanceof Error)){
var e = e3336;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__3340,reader){
...
var opts = map__3341__$1;
var eof = cljs.core.get.call(null,map__3341__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq3347){
var G__3348 = cljs.core.first.call(null,seq3347);
var seq3347__$1 = cljs.core.next.call(null,seq3347);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3348,seq3347__$1);
});


//# sourceMappingURL=reader.js.map?rel=1610745445778
